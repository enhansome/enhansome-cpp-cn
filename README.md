...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,896 | 🐛 311 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,093 | 🐛 232 | 🌐 C++ | 📅 2026-08-22: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,507 | 🐛 462 | 🌐 C++ | 📅 2026-08-22: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,805 | 🐛 473 | 🌐 C++ | 📅 2026-08-21: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,104 | 🐛 62 | 🌐 C++ | 📅 2026-08-23: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,375 | 🐛 2,947 | 🌐 C++ | 📅 2026-08-23: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,562 | 🐛 17,303 | 🌐 Python | 📅 2026-08-24: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,869 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
- [tiny-dnn](https://github.com/tiny-dnn/tiny-dnn) ⭐ 6,029 | 🐛 297 | 🌐 C++ | 📅 2022-04-17: C++11中的无依赖项的深度学习框架，只有头文件。
- [Genann](https://github.com/codeplea/genann) ⭐ 2,281 | 🐛 0 | 🌐 C | 📅 2026-08-08: 简单的神经网络C库。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,170 | 🐛 986 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,536 | 🐛 41 | 🌐 C | 📅 2026-08-21: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,431 | 🐛 59 | 🌐 C++ | 📅 2026-08-23: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,171 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,156 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
...
- [libsndfile](https://github.com/erikd/libsndfile/) ⭐ 1,710 | 🐛 221 | 🌐 C | 📅 2026-08-01: C++封装的C库，用于通过标准库接口读写包含采样声音的文件。
- [Maximilian](https://github.com/micknoise/Maximilian) ⭐ 1,699 | 🐛 32 | 🌐 C++ | 📅 2025-01-04: C++音频和音乐数字信号处理库。
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 912 | 🐛 177 | 🌐 C++ | 📅 2026-08-20: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,036 | 🐛 248 | 🌐 C++ | 📅 2026-08-24(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 999 | 🐛 57 | 🌐 C++ | 📅 2026-08-19 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,025 | 🐛 97 | 🌐 C++ | 📅 2026-08-23: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 953 | 🐛 0 | 🌐 C++ | 📅 2026-08-20: 传递消息的并行分子动力学实现。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,419 | 🐛 73 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [Taywee / args](https://github.com/taywee/args) ⭐ 1,633 | 🐛 15 | 🌐 C++ | 📅 2026-08-03: 简单的只有头文件的C++参数解析库。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,849 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-18: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 851 | 🐛 42 | 🌐 C++ | 📅 2026-08-20: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,604 | 🐛 343 | 🌐 C | 📅 2026-08-23: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,599 | 🐛 604 | 🌐 C | 📅 2026-08-23: 多格式的存档和压缩库。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,459 | 🐛 76 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,123 | 🐛 33 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,023 | 🐛 412 | 🌐 C++ | 📅 2026-08-23: 用于集体多GPU通信的优化基元。
- [readerwriterqueue](https://github.com/cameron314/readerwriterqueue) ⭐ 4,612 | 🐛 22 | 🌐 C++ | 📅 2026-08-23: C++的快速单生产者、单消费者的无锁队列。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 142 | 🌐 C++ | 📅 2026-08-23: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,647 | 🐛 546 | 🌐 C++ | 📅 2026-08-21: 用于并行运行和内存抽象的便携式编程模型。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 211 | 🌐 C++ | 📅 2026-08-21: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [inih](https://github.com/benhoyt/inih) ⭐ 3,032 | 🐛 5 | 🌐 C++ | 📅 2026-01-30: C语言的简单.INI文件解析器，很适合嵌入式系统。

* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,130 | 🐛 28 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。

* [simpleini](https://github.com/brofield/simpleini) ⭐ 1,323 | 🐛 1 | 🌐 C++ | 📅 2026-06-19: 跨平台的C++库，提供用于读写INI配置文件的简单API。
...
* [inih](https://github.com/jtilly/inih) ⭐ 451 | 🐛 0 | 🌐 C++ | 📅 2024-09-18: [inih](https://github.com/benhoyt/inih) ⭐ 3,032 | 🐛 5 | 🌐 C++ | 📅 2026-01-30的C++版本，只有头文件。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,896 | 🐛 311 | 📅 2026-08-22: 可移植和快速的加密库。
...
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,902 | 🐛 1,724 | 🌐 C | 📅 2026-08-20: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,351 | 🐛 402 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,003 | 🐛 1,616 | 🌐 C++ | 📅 2026-08-22: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,677 | 🐛 73 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,776 | 🐛 93 | 🌐 C | 📅 2026-07-24: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,072 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组DBMS。
...
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 5 | 🌐 C | 📅 2026-08-21: C的MongoDB客户端库。
...
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 385 | 🐛 16 | 🌐 C++ | 📅 2026-08-24: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,954 | 🐛 493 | 🌐 C++ | 📅 2026-08-21: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,954 | 🐛 493 | 🌐 C++ | 📅 2026-08-21: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,436 | 🐛 438 | 🌐 C++ | 📅 2026-08-23: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,436 | 🐛 438 | 🌐 C++ | 📅 2026-08-23: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,366 | 🐛 176 | 🌐 C++ | 📅 2026-08-18: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,849 | 🐛 140 | 🌐 C++ | 📅 2026-08-18: 功能最轻便的单个C++头文件的测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,047 | 🐛 18,765 | 🌐 C++ | 📅 2026-08-21: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,443 | 🐛 25 | 🌐 C | 📅 2026-08-23: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,042 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: 游戏与现代C++的碰撞。
...
* [Spring](https://github.com/spring/spring) ⭐ 3,974 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,855 | 🐛 47 | 🌐 C | 📅 2026-08-22: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,546 | 🐛 293 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [nCine](https://github.com/nCine/nCine) ⭐ 1,327 | 🐛 1 | 🌐 C++ | 📅 2026-08-11: 注重性能的跨平台2D游戏引擎，用C++11编写，还可以选择使用Lua编写脚本。
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-08-23: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,833 | 🐛 1,234 | 🌐 C++ | 📅 2026-08-23: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,338 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
...
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,369 | 🐛 57 | 🌐 C++ | 📅 2026-08-22: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,812 | 🐛 93 | 🌐 C++ | 📅 2026-08-22: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,427 | 🐛 284 | 🌐 C++ | 📅 2026-08-23: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,272 | 🐛 760 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,157 | 🐛 542 | 🌐 C++ | 📅 2026-08-22: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,898 | 🐛 50 | 🌐 C++ | 📅 2026-08-23 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,697 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
...
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,619 | 🐛 9 | 🌐 C++ | 📅 2026-08-21: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,977 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,921 | 🐛 2 | 🌐 C++ | 📅 2026-08-23: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,481 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,397 | 🐛 16 | 🌐 C | 📅 2026-08-19: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,349 | 🐛 185 | 🌐 C++ | 📅 2026-08-23: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,265 | 🐛 28 | 🌐 C++ | 📅 2026-08-21: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,977 | 🐛 10 | 🌐 C++ | 📅 2026-08-22: C和C++的单个头文件的utf8字符串函数。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,247 | 🐛 1,381 | 🌐 C++ | 📅 2026-08-23: 高性能、开源、通用的RPC框架。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,444 | 🐛 101 | 🌐 C++ | 📅 2026-08-21: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,175 | 🐛 137 | 🌐 C++ | 📅 2026-08-23: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,117 | 🐛 791 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,939 | 🐛 355 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,884 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,172 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,358 | 🐛 127 | 🌐 C | 📅 2026-07-09: 进行编解码和处理Json数据的C语言库。
...
* [json.h](https://github.com/sheredom/json.h) ⭐ 839 | 🐛 4 | 🌐 C | 📅 2026-08-23: 在C和C++中解析JSON的简单的单头文件/单源文件的解决方案。
...
* [plog](https://github.com/SergiusTheBest/plog) ⭐ 2,575 | 🐛 58 | 🌐 C++ | 📅 2026-08-07: C++可移植且简单的日志，少于1000行代码。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,561 | 🐛 2,757 | 🌐 C++ | 📅 2026-08-22: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,561 | 🐛 1,542 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,690 | 🐛 422 | 🌐 C++ | 📅 2026-08-23: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,242 | 🐛 80 | 🌐 C++ | 📅 2026-08-23: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,174 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,557 | 🐛 114 | 🌐 C | 📅 2026-08-22: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,539 | 🐛 49 | 🌐 C++ | 📅 2026-08-20v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,020 | 🐛 678 | 🌐 C++ | 📅 2026-08-22: 高效，可靠的几何算法集合。
...
* [TinyExpr](https://github.com/codeplea/tinyexpr) ⭐ 1,917 | 🐛 0 | 🌐 C | 📅 2026-08-06: 用于解析和评估字符串中的数学表达式的C库。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 499 | 🐛 14 | 🌐 C++ | 📅 2026-08-24: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,325 | 🐛 312 | 🌐 C | 📅 2026-08-22: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,054 | 🐛 365 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,527 | 🐛 188 | 🌐 C | 📅 2026-08-23: C和C++的保守的垃圾回收器。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,445 | 🐛 39 | 🌐 C++ | 📅 2026-08-21: 用于读取和编辑几种流行音频格式的元数据的库。
...
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 786 | 🐛 361 | 🌐 C++ | 📅 2026-06-21: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,765 | 🐛 4 | 🌐 C++ | 📅 2026-08-20: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,229 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,006 | 🐛 2 | 🌐 C | 📅 2026-08-23<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,537 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,374 | 🐛 39 | 🌐 C++ | 📅 2026-08-23: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,411 | 🐛 87 | 🌐 C++ | 📅 2026-07-26: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,318 | 🐛 232 | 🌐 C | 📅 2026-08-23: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,043 | 🐛 46 | 🌐 C++ | 📅 2026-08-23: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,819 | 🐛 106 | 🌐 C++ | 📅 2026-08-12: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,391 | 🐛 24 | 🌐 C | 📅 2026-08-21: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,162 | 🐛 179 | 🌐 C | 📅 2026-08-21: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,131 | 🐛 60 | 🌐 C++ | 📅 2026-08-23: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-23: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,961 | 🐛 46 | 🌐 C | 📅 2026-08-20: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,955 | 🐛 82 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,182 | 🐛 62 | 🌐 C | 📅 2026-08-01: 用于异步DNS请求的C库。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,038 | 🐛 596 | 🌐 C | 📅 2026-08-21: 用于C和C++的Apache Kafka客户端库。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,689 | 🐛 423 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,989 | 🐛 19 | 🌐 C++ | 📅 2026-08-18: 开源的多物理场仿真引擎。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,249 | 🐛 449 | 🌐 C++ | 📅 2026-08-18: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
* [Newton Dynamics](https://github.com/MADEAPPS/newton-dynamics) ⭐ 1,023 | 🐛 0 | 🌐 HTML | 📅 2026-01-17: 用于物理环境实时仿真的集成解决方案。
...
* [RE2](https://github.com/google/re2) ⭐ 9,786 | 🐛 62 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,097 | 🐛 585 | 🌐 C++ | 📅 2026-08-18: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,072 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组的DBMS。
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,418 | 🐛 328 | 🌐 C++ | 📅 2026-08-23: 高性能的PDE解算器。
* [AMGCL](https://github.com/ddemidov/amgcl) ⭐ 874 | 🐛 60 | 🌐 C++ | 📅 2026-08-03: 只包含头文件的C++库，用于解决具有代数多重网格的大型稀疏线性系统。
* [FFTW](http://www.fftw.org/): 用一维或者多维计算DFT的C语言库。
* [GSL](http://www.gnu.org/software/gsl/): GNU科学库。

### 脚本

* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,002 | 🐛 713 | 🌐 C++ | 📅 2026-08-23: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,830 | 🐛 1,504 | 🌐 Cython | 📅 2026-08-23: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [ChaiScript](https://github.com/ChaiScript/ChaiScript/) ⭐ 3,123 | 🐛 73 | 🌐 C++ | 📅 2026-05-02: 用于C++的易于使用的嵌入式脚本语言。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,402 | 🐛 266 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,534 | 🐛 79 | 🌐 C | 📅 2026-07-24: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,702 | 🐛 343 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,492 | 🐛 39 | 🌐 Java | 📅 2026-08-22: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,342 | 🐛 104 | 📅 2026-06-09: C/C++的高效二进制序列化库，例如 JSON。
* [protobuf-c](https://github.com/protobuf-c/protobuf-c) ⭐ 2,986 | 🐛 48 | 🌐 C++ | 📅 2026-08-22: C语言的协议缓冲实现。
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,136 | 🐛 305 | 🌐 C++ | 📅 2026-08-10: 开源H.364 编解码器。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,010 | 🐛 1,539 | 🌐 C | 📅 2026-08-18: 旨在实现单片机上Python3.x的实现。
* [TinyVM](https://github.com/jakogut/tinyvm) ⭐ 3,324 | 🐛 6 | 🌐 C | 📅 2019-03-23: 用纯粹的ANSI C编写的小型，快速，轻量级的虚拟机。
* [CarpVM](https://github.com/tekknolagi/carp) ⚠️ Archived: C中有趣的VM，让我们一起来看看这个。

### Web应用框架

* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,204 | 🐛 429 | 🌐 C++ | 📅 2026-08-20: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,034 | 🐛 49 | 🌐 C | 📅 2026-08-23: 实验性、可扩展的高性能HTTP服务器。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,790 | 🐛 122 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,481 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,075 | 🐛 2 | 🌐 Java | 📅 2026-08-21: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,757 | 🐛 12 | 🌐 C++ | 📅 2026-08-23: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,757 | 🐛 12 | 🌐 C++ | 📅 2026-08-23: C++的小型，安全和快速格式化库。
...
* [Kangaru](https://github.com/gracicot/kangaru) ⭐ 553 | 🐛 9 | 🌐 C++ | 📅 2026-08-20: 用于C++ 11和C++ 14的依赖注入容器。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,386 | 🐛 1,176 | 🌐 CMake | 📅 2026-08-22: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,446 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,686 | 🐛 297 | 🌐 OCaml | 📅 2026-08-21: 用于Java、C和Objective-C的静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,064 | 🐛 388 | 🌐 C++ | 📅 2026-08-23: 代码美化器。
