...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,788 | 🐛 312 | 📅 2026-08-04 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,082 | 🐛 229 | 🌐 C++ | 📅 2026-08-16: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,496 | 🐛 461 | 🌐 C++ | 📅 2026-08-16: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,790 | 🐛 473 | 🌐 C++ | 📅 2026-08-13: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,097 | 🐛 65 | 🌐 C++ | 📅 2026-08-16: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,087 | 🐛 2,868 | 🌐 C++ | 📅 2026-08-16: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,430 | 🐛 17,330 | 🌐 Python | 📅 2026-08-17: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,459 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,861 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,431 | 🐛 57 | 🌐 C++ | 📅 2026-08-12: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,136 | 🐛 5 | 🌐 C | 📅 2026-08-03: 单文件音频回放和录制的库。
...
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 912 | 🐛 192 | 🌐 C++ | 📅 2026-08-02: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,026 | 🐛 248 | 🌐 C++ | 📅 2026-08-16(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 998 | 🐛 55 | 🌐 C++ | 📅 2026-08-16 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,019 | 🐛 94 | 🌐 C++ | 📅 2026-08-17: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,412 | 🐛 72 | 🌐 C++ | 📅 2026-08-14: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,839 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-14: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 849 | 🐛 41 | 🌐 C++ | 📅 2026-08-15: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,562 | 🐛 340 | 🌐 C | 📅 2026-08-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,595 | 🐛 600 | 🌐 C | 📅 2026-08-16: 多格式的存档和压缩库。
...
- [smaz](https://github.com/antirez/smaz) ⭐ 1,220 | 🐛 13 | 🌐 C | 📅 2019-10-25: 小型字符压缩库。
...
* [ArrayFire](https://github.com/arrayfire/arrayfire) ⭐ 4,901 | 🐛 318 | 🌐 C++ | 📅 2026-03-07: 通用GPU库。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,442 | 🐛 76 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,116 | 🐛 33 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,001 | 🐛 398 | 🌐 C++ | 📅 2026-08-14: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 137 | 🌐 C++ | 📅 2026-08-16: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,643 | 🐛 603 | 🌐 C++ | 📅 2026-08-14: 用于并行运行和内存抽象的便携式编程模型。
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,124 | 🐛 26 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。
...
* [libconfuse](https://github.com/martinh/libconfuse) ⭐ 516 | 🐛 7 | 🌐 C | 📅 2026-08-16: C的小型配置文件解析库。
...
* [Colony](https://github.com/mattreecebentley/plf_colony) ⭐ 503 | 🐛 0 | 🌐 C++ | 📅 2026-07-31: 无序的”bag“型容器，在高度修改的情况下，其性能优于标准容器。同时，无论插入还是擦除，其都能始终保持指向未擦除元素的永久指针。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,788 | 🐛 312 | 📅 2026-08-04: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,895 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,873 | 🐛 1,729 | 🌐 C | 📅 2026-08-14: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,996 | 🐛 33 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,751 | 🐛 304 | 🌐 C | 📅 2026-08-17: TLS/SSL协议的实现。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,327 | 🐛 400 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 31,964 | 🐛 1,616 | 🌐 C++ | 📅 2026-08-14: 来自Facebook的嵌入键值的快速存储。
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,692 | 🐛 15 | 🌐 C++ | 📅 2026-08-15: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,935 | 🐛 491 | 🌐 C++ | 📅 2026-08-16: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,935 | 🐛 491 | 🌐 C++ | 📅 2026-08-16: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,433 | 🐛 442 | 🌐 C++ | 📅 2026-08-10: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,433 | 🐛 442 | 🌐 C++ | 📅 2026-08-10: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,353 | 🐛 175 | 🌐 C++ | 📅 2026-08-12: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,846 | 🐛 139 | 🌐 C++ | 📅 2026-07-12: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,347 | 🐛 89 | 🌐 C | 📅 2026-07-21: C的简单单元测试。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 115,754 | 🐛 18,699 | 🌐 C++ | 📅 2026-08-16: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,351 | 🐛 32 | 🌐 C | 📅 2026-08-13: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,021 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,205 | 🐛 367 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,893 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
* [PixelGameEngine](https://github.com/OneLoneCoder/olcPixelGameEngine) ⭐ 4,224 | 🐛 141 | 🌐 C++ | 📅 2025-09-26: olcPixelGameEngine的官方发行版，该工具用于javidx9的YouTube视频和项目。
* [Spring](https://github.com/spring/spring) ⭐ 3,965 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,853 | 🐛 47 | 🌐 C | 📅 2026-08-13: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,542 | 🐛 292 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,682 | 🐛 1,232 | 🌐 C++ | 📅 2026-08-07: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,322 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,894 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,190 | 🐛 129 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,352 | 🐛 59 | 🌐 C++ | 📅 2026-08-16: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,810 | 🐛 93 | 🌐 C++ | 📅 2026-07-29: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,405 | 🐛 289 | 🌐 C | 📅 2026-08-17: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,257 | 🐛 759 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,135 | 🐛 525 | 🌐 C++ | 📅 2026-08-16: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,881 | 🐛 51 | 🌐 C++ | 📅 2026-08-16 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,690 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,187 | 🐛 77 | 🌐 C++ | 📅 2026-08-16: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
...
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,396 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
* [OpenSubdiv](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,070 | 🐛 62 | 🌐 C++ | 📅 2026-07-17: Pixar的库，用于评估和渲染CPU和GPU上的细分曲面。
...
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,617 | 🐛 11 | 🌐 C++ | 📅 2026-08-16: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,971 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,919 | 🐛 2 | 🌐 C++ | 📅 2026-08-16: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,414 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,779 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: 用于图像中人脸检测的开源库，其人脸检测的速度能达到1500FPS。
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,387 | 🐛 17 | 🌐 C | 📅 2026-08-15: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,347 | 🐛 182 | 🌐 C++ | 📅 2026-08-16: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,286 | 🐛 1,376 | 🌐 C++ | 📅 2026-08-16: 高性能、开源、通用的RPC框架。
...
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,190 | 🐛 167 | 🌐 C++ | 📅 2026-08-15: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,382 | 🐛 100 | 🌐 C++ | 📅 2026-08-13: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,155 | 🐛 136 | 🌐 C++ | 📅 2026-08-15: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,110 | 🐛 789 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,923 | 🐛 353 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
...
* [json-c](https://github.com/json-c/json-c) ⭐ 3,287 | 🐛 21 | 🌐 C | 📅 2026-08-15: C中的JSON实现。
...
* [LIBUCL](https://github.com/vstakhov/libucl) ⭐ 1,742 | 🐛 115 | 🌐 C | 📅 2026-08-16: 通用配置库解析器。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,485 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,458 | 🐛 2,753 | 🌐 C++ | 📅 2026-08-15: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,562 | 🐛 1,565 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,660 | 🐛 419 | 🌐 C++ | 📅 2026-08-15: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
* [darknet](https://github.com/pjreddie/darknet) ⭐ 26,489 | 🐛 1,975 | 🌐 C | 📅 2024-05-03: 用C和CUDA编写的开源神经网络框架。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++ 11的机器学习、计算机视觉、数值优化和深度学习的工具包。
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,240 | 🐛 80 | 🌐 C++ | 📅 2026-08-16: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,160 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,555 | 🐛 112 | 🌐 C | 📅 2026-08-16: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,518 | 🐛 50 | 🌐 C++ | 📅 2026-08-14v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,011 | 🐛 684 | 🌐 C++ | 📅 2026-08-12: 高效，可靠的几何算法集合。
* [xtensor](https://github.com/QuantStack/xtensor) ⭐ 3,762 | 🐛 428 | 🌐 C++ | 📅 2026-07-15: 受NumPy语法启发的C++ 14库，用于使用多维数组表达式进行数值分析。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 500 | 🐛 22 | 🌐 C++ | 📅 2026-08-16: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,296 | 🐛 322 | 🌐 C | 📅 2026-08-16: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,045 | 🐛 362 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,522 | 🐛 190 | 🌐 C | 📅 2026-07-23: C和C++的保守的垃圾回收器。
* [memory-allocators](https://github.com/mtrebi/memory-allocators) ⭐ 1,990 | 🐛 17 | 🌐 C++ | 📅 2026-04-12: 自定义内存分配器，可提高动态内存分配的性能。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,444 | 🐛 39 | 🌐 C++ | 📅 2026-08-16: 用于读取和编辑几种流行音频格式的元数据的库。
* [libass](https://github.com/libass/libass) ⭐ 1,160 | 🐛 165 | 🌐 C | 📅 2026-08-10: ASS / SSA字幕格式的便携式字幕渲染器。
* [libass](https://github.com/libass/libass) ⭐ 1,160 | 🐛 165 | 🌐 C | 📅 2026-08-10: 处理多媒体内容（例如音频、视频、字幕和相关元数据）的库和工具的集合。
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 785 | 🐛 357 | 🌐 C++ | 📅 2026-06-21: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,954 | 🐛 48 | 🌐 C++ | 📅 2026-08-16: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,873 | 🐛 195 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,744 | 🐛 1 | 🌐 C++ | 📅 2026-08-15: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,223 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 12,994 | 🐛 4 | 🌐 C | 📅 2026-08-15<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,531 | 🐛 730 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,374 | 🐛 39 | 🌐 C++ | 📅 2026-08-16: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,314 | 🐛 231 | 🌐 C | 📅 2026-08-16: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,038 | 🐛 46 | 🌐 C++ | 📅 2026-08-15: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,819 | 🐛 106 | 🌐 C++ | 📅 2026-08-12: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,371 | 🐛 24 | 🌐 C | 📅 2026-08-16: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,156 | 🐛 177 | 🌐 C | 📅 2026-08-15: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,129 | 🐛 54 | 🌐 C++ | 📅 2026-08-14: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-16: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,961 | 🐛 45 | 🌐 C | 📅 2026-07-23: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,957 | 🐛 81 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,178 | 🐛 62 | 🌐 C | 📅 2026-08-01: 用于异步DNS请求的C库。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,679 | 🐛 423 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,981 | 🐛 19 | 🌐 C++ | 📅 2026-08-16: 开源的多物理场仿真引擎。
...
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,459 | 🐛 201 | 🌐 C++ | 📅 2026-08-13: Hyperscan是Intel的高性能、多种正则表达式匹配库，提供大量正则表达式（多达数万个）的同时匹配，通常在DPI库堆栈中使用。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,092 | 🐛 585 | 🌐 C++ | 📅 2026-08-14: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,416 | 🐛 322 | 🌐 C++ | 📅 2026-08-16: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 17,994 | 🐛 711 | 🌐 C++ | 📅 2026-08-16: C++ 11和Python之间的无缝可操作性。
...
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,125 | 🐛 308 | 🌐 C++ | 📅 2025-03-07: 具有高级功能和一流性能的C++ <-> Lua API封装器。
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,705 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,352 | 🐛 193 | 🌐 C | 📅 2026-08-09: 可移植的外部功能接口库。
...
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,521 | 🐛 79 | 🌐 C | 📅 2026-07-24: ANSI C中的小型代码大小的协议缓冲区实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 21,991 | 🐛 1,537 | 🌐 C | 📅 2026-08-16: 旨在实现单片机上Python3.x的实现。
...
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,036 | 🐛 49 | 🌐 C | 📅 2026-08-16: 实验性、可扩展的高性能HTTP服务器。
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,434 | 🐛 234 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,787 | 🐛 122 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,414 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,068 | 🐛 0 | 🌐 Java | 📅 2026-07-28: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,743 | 🐛 10 | 🌐 C++ | 📅 2026-08-16: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,743 | 🐛 10 | 🌐 C++ | 📅 2026-08-16: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,536 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
...
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,149 | 🐛 8 | 🌐 C++ | 📅 2026-08-12: 解析表达语法模板库。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,367 | 🐛 1,159 | 🌐 CMake | 📅 2026-08-15: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,438 | 🐛 0 | 🌐 Rust | 📅 2026-08-16: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,677 | 🐛 298 | 🌐 OCaml | 📅 2026-08-12: 用于Java、C和Objective-C的静态分析器。
