...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,936 | 🐛 311 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,100 | 🐛 237 | 🌐 C++ | 📅 2026-08-25: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,507 | 🐛 463 | 🌐 C++ | 📅 2026-08-25: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,813 | 🐛 473 | 🌐 C++ | 📅 2026-08-21: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,107 | 🐛 63 | 🌐 C++ | 📅 2026-08-25: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,633 | 🐛 2,940 | 🌐 C++ | 📅 2026-08-26: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,593 | 🐛 17,364 | 🌐 Python | 📅 2026-08-26: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,873 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,171 | 🐛 987 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,539 | 🐛 41 | 🌐 C | 📅 2026-08-24: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,431 | 🐛 58 | 🌐 C++ | 📅 2026-08-25: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,178 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,165 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,040 | 🐛 250 | 🌐 C++ | 📅 2026-08-25(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 999 | 🐛 55 | 🌐 C++ | 📅 2026-08-24 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,027 | 🐛 90 | 🌐 C++ | 📅 2026-08-26: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 954 | 🐛 0 | 🌐 C++ | 📅 2026-08-24: 传递消息的并行分子动力学实现。
...
* [jarro2783/cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,800 | 🐛 70 | 🌐 C++ | 📅 2026-07-13: 轻量级的C++命令行选项解析器。
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,423 | 🐛 74 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,852 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-18: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 851 | 🐛 42 | 🌐 C++ | 📅 2026-08-20: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,621 | 🐛 344 | 🌐 C | 📅 2026-08-23: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,599 | 🐛 599 | 🌐 C | 📅 2026-08-26: 多格式的存档和压缩库。
- [LZFSE](https://github.com/lzfse/lzfse) ⭐ 1,822 | 🐛 29 | 🌐 C | 📅 2022-09-05: LZFSE压缩库和命令行工具。
- [FiniteStateEntropy](https://github.com/Cyan4973/FiniteStateEntropy) ⭐ 1,496 | 🐛 22 | 🌐 C | 📅 2024-03-21: 新一代熵编解码器: 有限状态熵和Huff()。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,466 | 🐛 76 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,125 | 🐛 34 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,024 | 🐛 414 | 🌐 C++ | 📅 2026-08-25: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 142 | 🌐 C++ | 📅 2026-08-25: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,646 | 🐛 547 | 🌐 C++ | 📅 2026-08-25: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,600 | 🐛 118 | 🌐 C | 📅 2026-08-25: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 212 | 🌐 C++ | 📅 2026-08-25: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
- [SObjectizer](https://github.com/Stiffstream/sobjectizer) ⭐ 622 | 🐛 13 | 🌐 C++ | 📅 2026-08-15: 实现Actor、Publish-Subscribe和CSP模式的相当小的C++框架。
...
* [inih](https://github.com/benhoyt/inih) ⭐ 3,036 | 🐛 6 | 🌐 C++ | 📅 2026-01-30: C语言的简单.INI文件解析器，很适合嵌入式系统。
...
* [iniparser](https://github.com/ndevilla/iniparser) ⭐ 1,071 | 🐛 6 | 🌐 C | 📅 2026-07-19: INI文件解析器。

* [libconfuse](https://github.com/martinh/libconfuse) ⭐ 518 | 🐛 7 | 🌐 C | 📅 2026-08-21: C的小型配置文件解析库。

* [inih](https://github.com/jtilly/inih) ⭐ 451 | 🐛 0 | 🌐 C++ | 📅 2024-09-18: [inih](https://github.com/benhoyt/inih) ⭐ 3,036 | 🐛 6 | 🌐 C++ | 📅 2026-01-30的C++版本，只有头文件。
...
* [Colony](https://github.com/mattreecebentley/plf_colony) ⭐ 504 | 🐛 0 | 🌐 C++ | 📅 2026-08-23: 无序的”bag“型容器，在高度修改的情况下，其性能优于标准容器。同时，无论插入还是擦除，其都能始终保持指向未擦除元素的永久指针。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,936 | 🐛 311 | 📅 2026-08-22: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,914 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,913 | 🐛 1,726 | 🌐 C | 📅 2026-08-20: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,999 | 🐛 33 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,755 | 🐛 319 | 🌐 C | 📅 2026-08-26: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,973 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,788 | 🐛 51 | 🌐 C | 📅 2026-08-08: 相当全面、模块化和可移植的加密工具包。
* [sha1collisiondetection](https://github.com/cr-marcstevens/sha1collisiondetection) ⭐ 1,413 | 🐛 17 | 🌐 C | 📅 2025-10-30: 用于检测文件中SHA-1冲突的库和命令行工具。
...
* [Vince's CSV Parser](https://github.com/vincentlaucsb/csv-parser) ⭐ 1,122 | 🐛 3 | 🌐 C++ | 📅 2026-08-23: 快速、独立、流式的C++17 CSV解析器，具有可选的类型转换和统计信息。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,360 | 🐛 402 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,011 | 🐛 1,623 | 🌐 C++ | 📅 2026-08-25: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,678 | 🐛 73 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,777 | 🐛 93 | 🌐 C | 📅 2026-08-25: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,690 | 🐛 17 | 🌐 C++ | 📅 2026-08-25: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,618 | 🐛 138 | 🌐 C++ | 📅 2026-08-21: C++的数据库抽象层。
* [MongoDB C++ Driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,105 | 🐛 1 | 🌐 C++ | 📅 2026-08-25: MongDB的C++驱动程序。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,957 | 🐛 491 | 🌐 C++ | 📅 2026-08-25: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,957 | 🐛 491 | 🌐 C++ | 📅 2026-08-25: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,441 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,441 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,368 | 🐛 178 | 🌐 C++ | 📅 2026-08-25: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,852 | 🐛 140 | 🌐 C++ | 📅 2026-08-18: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,354 | 🐛 85 | 🌐 C | 📅 2026-08-25: C的简单单元测试。
...
* [CppUTest](https://github.com/cpputest/cpputest) ⭐ 1,480 | 🐛 190 | 🌐 C++ | 📅 2026-07-30: C/C++的单元测试和模拟框架。
...
* [utest.h](https://github.com/sheredom/utest.h) ⭐ 990 | 🐛 7 | 🌐 C++ | 📅 2026-08-23: C和C++的单个头文件测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,144 | 🐛 18,745 | 🌐 C++ | 📅 2026-08-25: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,470 | 🐛 18 | 🌐 C | 📅 2026-08-25: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,050 | 🐛 11 | 🌐 C++ | 📅 2026-08-25: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,212 | 🐛 368 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
...
* [Spring](https://github.com/spring/spring) ⭐ 3,976 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,855 | 🐛 47 | 🌐 C | 📅 2026-08-25: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
...
* [toy engine](https://github.com/hugoam/toy) ⭐ 1,594 | 🐛 13 | 🌐 C++ | 📅 2021-04-25: toy是一个轻量的模块化的 C++ 游戏引擎，并提供简单的、有表现力的C++惯用法来快速迭代设计功能齐全的2D和3D游戏。
* [nCine](https://github.com/nCine/nCine) ⭐ 1,327 | 🐛 1 | 🌐 C++ | 📅 2026-08-24: 注重性能的跨平台2D游戏引擎，用C++11编写，还可以选择使用Lua编写脚本。
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-08-25: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,862 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-23: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,345 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,896 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,202 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,383 | 🐛 56 | 🌐 C++ | 📅 2026-08-24: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,682 | 🐛 9 | 🌐 C++ | 📅 2026-08-25: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,814 | 🐛 92 | 🌐 C++ | 📅 2026-08-25: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,432 | 🐛 284 | 🌐 C++ | 📅 2026-08-25: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,284 | 🐛 760 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,164 | 🐛 543 | 🌐 C++ | 📅 2026-08-25: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,904 | 🐛 50 | 🌐 C++ | 📅 2026-08-26 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,701 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,194 | 🐛 76 | 🌐 C++ | 📅 2026-08-23: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,076 | 🐛 157 | 🌐 C++ | 📅 2026-08-25: 简单的C++几何处理库。
* [urho3d](https://github.com/urho3d/Urho3D) ⚠️ Archived 跨平台的渲染和游戏引擎。
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,414 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
...
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,849 | 🐛 33 | 🌐 C++ | 📅 2026-08-20: 用于在C++中编写DirectX 11.x代码的帮助类的集合。
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,620 | 🐛 8 | 🌐 C++ | 📅 2026-08-26: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,980 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,922 | 🐛 2 | 🌐 C++ | 📅 2026-08-24: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,501 | 🐛 417 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,430 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,784 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: 用于图像中人脸检测的开源库，其人脸检测的速度能达到1500FPS。
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,400 | 🐛 16 | 🌐 C | 📅 2026-08-19: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,349 | 🐛 188 | 🌐 C++ | 📅 2026-08-25: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,265 | 🐛 26 | 🌐 C++ | 📅 2026-08-25: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
...
* [TinyEXIF](https://github.com/cdcseacave/TinyEXIF) ⭐ 146 | 🐛 0 | 🌐 C++ | 📅 2026-08-23: 用于JPEG的微型ISO兼容的C++ EXIF和XMP解析库。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,978 | 🐛 9 | 🌐 C++ | 📅 2026-08-25: C和C++的单个头文件的utf8字符串函数。
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,292 | 🐛 32 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,260 | 🐛 1,380 | 🌐 C++ | 📅 2026-08-25: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,168 | 🐛 327 | 🌐 C++ | 📅 2026-08-25: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,290 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,657 | 🐛 62 | 🌐 C | 📅 2026-08-22: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,191 | 🐛 156 | 🌐 C++ | 📅 2026-08-24: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,467 | 🐛 107 | 🌐 C++ | 📅 2026-08-25: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,194 | 🐛 133 | 🌐 C++ | 📅 2026-08-25: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,118 | 🐛 790 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,950 | 🐛 356 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,884 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,174 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,358 | 🐛 128 | 🌐 C | 📅 2026-07-09: 进行编解码和处理Json数据的C语言库。
* [json-c](https://github.com/json-c/json-c) ⭐ 3,287 | 🐛 22 | 🌐 C | 📅 2026-08-21: C中的JSON实现。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,521 | 🐛 50 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,005 | 🐛 10 | 🌐 C++ | 📅 2026-08-25: 异步、跨平台、低时延的日志库。
...
* [G3log](https://github.com/KjellKod/g3log) ⭐ 960 | 🐛 0 | 🌐 C++ | 📅 2026-08-10: 具有动态接收模块的异步记录器。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,598 | 🐛 2,758 | 🌐 C++ | 📅 2026-08-25: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,556 | 🐛 1,595 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,691 | 🐛 420 | 🌐 C++ | 📅 2026-08-25: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
* [darknet](https://github.com/pjreddie/darknet) ⭐ 26,493 | 🐛 1,976 | 🌐 C | 📅 2024-05-03: 用C和CUDA编写的开源神经网络框架。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,430 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++ 11的机器学习、计算机视觉、数值优化和深度学习的工具包。
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,242 | 🐛 80 | 🌐 C++ | 📅 2026-08-24: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,430 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,180 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,561 | 🐛 119 | 🌐 C | 📅 2026-08-22: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,545 | 🐛 51 | 🌐 C++ | 📅 2026-08-20v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,021 | 🐛 677 | 🌐 C++ | 📅 2026-08-24: 高效，可靠的几何算法集合。
...
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,402 | 🐛 258 | 🌐 C++ | 📅 2026-08-20: 快速符号处理库，用C++重写了SymPy的核心。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 499 | 🐛 18 | 🌐 C++ | 📅 2026-08-25: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,330 | 🐛 312 | 🌐 C | 📅 2026-08-22: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,061 | 🐛 368 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,447 | 🐛 40 | 🌐 C++ | 📅 2026-08-21: 用于读取和编辑几种流行音频格式的元数据的库。
...
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 787 | 🐛 362 | 🌐 C++ | 📅 2026-08-25: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,965 | 🐛 48 | 🌐 C++ | 📅 2026-08-18: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,882 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,776 | 🐛 3 | 🌐 C++ | 📅 2026-08-25: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,225 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,009 | 🐛 2 | 🌐 C | 📅 2026-08-25<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,539 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-25: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
* [C++ REST SDK](https://github.com/Microsoft/cpprestsdk) ⚠️ Archived: C++ REST SDK（以前称为Casablanca）。
* [WebSocket++](https://github.com/zaphoyd/websocketpp) ⭐ 7,714 | 🐛 483 | 🌐 C++ | 📅 2026-05-04: 基于C++/Boost Aiso的websocket 客户端/服务器库。
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,416 | 🐛 87 | 🌐 C++ | 📅 2026-07-26: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,318 | 🐛 231 | 🌐 C | 📅 2026-08-24: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,045 | 🐛 46 | 🌐 C++ | 📅 2026-08-24: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,819 | 🐛 106 | 🌐 C++ | 📅 2026-08-25: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,395 | 🐛 24 | 🌐 C | 📅 2026-08-25: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,132 | 🐛 59 | 🌐 C++ | 📅 2026-08-25: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,094 | 🐛 48 | 🌐 C++ | 📅 2026-08-25: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,964 | 🐛 45 | 🌐 C | 📅 2026-08-25: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,955 | 🐛 82 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,182 | 🐛 66 | 🌐 C | 📅 2026-08-24: 用于异步DNS请求的C库。
* [mTCP](https://github.com/mtcp-stack/mtcp) ⭐ 2,138 | 🐛 97 | 🌐 C | 📅 2024-07-04: 用于多核系统的高度可扩展的用户级TCP堆栈。
* [PicoHTTPParser](https://github.com/h2o/picohttpparser) ⭐ 2,102 | 🐛 22 | 🌐 C | 📅 2026-04-06: 微小、原始、快速的HTTP请求/响应解析器。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,038 | 🐛 597 | 🌐 C | 📅 2026-08-25: 用于C和C++的Apache Kafka客户端库。
...
* [libharu](https://github.com/libharu/libharu) ⭐ 1,993 | 🐛 114 | 🌐 C | 📅 2026-03-26: 免费、跨平台、开源的软件库，用于生成PDF。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,697 | 🐛 424 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,991 | 🐛 19 | 🌐 C++ | 📅 2026-08-24: 开源的多物理场仿真引擎。
* [Simbody](https://github.com/simbody/simbody) ⭐ 2,545 | 🐛 158 | 🌐 C++ | 📅 2026-08-25: 高性能C++多体动力学/物理库，模拟关节生物力学和机械系统，像车辆，机器人和人体骨骼。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,251 | 🐛 457 | 🌐 C++ | 📅 2026-08-18: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [RE2](https://github.com/google/re2) ⭐ 9,787 | 🐛 62 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,475 | 🐛 200 | 🌐 C++ | 📅 2026-08-17: Hyperscan是Intel的高性能、多种正则表达式匹配库，提供大量正则表达式（多达数万个）的同时匹配，通常在DPI库堆栈中使用。
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions) ⭐ 3,838 | 🐛 104 | 🌐 C++ | 📅 2026-07-11: 编译时PCRE（几乎）兼容的正则表达式匹配器。
...
* [SLRE](https://github.com/cesanta/slre) ⭐ 560 | 🐛 19 | 🌐 C | 📅 2020-10-26: 适用于C / C++的超轻正则表达式引擎。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,097 | 🐛 586 | 🌐 C++ | 📅 2026-08-18: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Torch](https://github.com/torch/torch7) ⭐ 9,142 | 🐛 298 | 🌐 C | 📅 2025-03-31: 科学的计算框架，广泛支持将GPU放在首位的机器学习算法。
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,073 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组的DBMS。
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,418 | 🐛 327 | 🌐 C++ | 📅 2026-08-25: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,005 | 🐛 713 | 🌐 C++ | 📅 2026-08-25: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,832 | 🐛 1,511 | 🌐 Cython | 📅 2026-08-25: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [libffi](https://github.com/libffi/libffi) ⭐ 4,360 | 🐛 194 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
...
* [LuaBridge](https://github.com/vinniefalco/LuaBridge) ⭐ 1,778 | 🐛 48 | 🌐 C | 📅 2025-10-13: 轻量级、无依赖的库，用于将Lua绑定到C++。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,409 | 🐛 267 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,537 | 🐛 79 | 🌐 C | 📅 2026-08-25: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,703 | 🐛 343 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
...
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,343 | 🐛 103 | 📅 2026-08-25: C/C++的高效二进制序列化库，例如 JSON。
* [protobuf-c](https://github.com/protobuf-c/protobuf-c) ⭐ 2,987 | 🐛 48 | 🌐 C++ | 📅 2026-08-22: C语言的协议缓冲实现。
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,138 | 🐛 306 | 🌐 C++ | 📅 2026-08-25: 开源H.364 编解码器。
* [libde265](https://github.com/strukturag/libde265) ⭐ 1,909 | 🐛 35 | 🌐 C++ | 📅 2026-07-24: 开放的h.265视频编解码器的实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,009 | 🐛 1,533 | 🌐 C | 📅 2026-08-25: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,207 | 🐛 426 | 🌐 C++ | 📅 2026-08-25: 基于C++ 14/17的高性能HTTP应用程序框架。
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,643 | 🐛 348 | 🌐 C++ | 📅 2025-11-12: 轻量、零依赖的框架，可创建高性能的Web服务。
...
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,034 | 🐛 49 | 🌐 C | 📅 2026-08-25: 实验性、可扩展的高性能HTTP服务器。
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,442 | 🐛 237 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,791 | 🐛 122 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,501 | 🐛 417 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,076 | 🐛 0 | 🌐 Java | 📅 2026-08-24: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,761 | 🐛 16 | 🌐 C++ | 📅 2026-08-23: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,761 | 🐛 16 | 🌐 C++ | 📅 2026-08-23: C++的小型，安全和快速格式化库。
...
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,433 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: C++语言编写的跨平台，串口库。
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,433 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: 跨平台，用C++编写的串行端口库。
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,152 | 🐛 5 | 🌐 C++ | 📅 2026-08-17: 解析表达语法模板库。
...
* [Kangaru](https://github.com/gracicot/kangaru) ⭐ 553 | 🐛 9 | 🌐 C++ | 📅 2026-08-24: 用于C++ 11和C++ 14的依赖注入容器。
* [libcpuid](https://github.com/anrieff/libcpuid) ⭐ 537 | 🐛 7 | 🌐 C | 📅 2026-08-22: 用于x86 CPU检测盒特征提取的小型C库。
...
* [8cc](https://github.com/rui314/8cc) ⭐ 6,411 | 🐛 46 | 🌐 C | 📅 2024-05-02: 小型C编译器。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,395 | 🐛 1,176 | 🌐 CMake | 📅 2026-08-25: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,450 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
* [clib](https://github.com/clibs/clib) ⭐ 5,141 | 🐛 26 | 🌐 C | 📅 2026-07-18: C语言的软件包管理器。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,689 | 🐛 293 | 🌐 OCaml | 📅 2026-08-25: 用于Java、C和Objective-C的静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,066 | 🐛 392 | 🌐 C++ | 📅 2026-08-23: 代码美化器。
