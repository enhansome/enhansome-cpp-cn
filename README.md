...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,908 | 🐛 311 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
- [Folly](https://github.com/facebook/folly) ⭐ 30,508 | 🐛 462 | 🌐 C++ | 📅 2026-08-24: 由Facebook开发和使用的开源C++库。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,105 | 🐛 60 | 🌐 C++ | 📅 2026-08-24: 嵌入式模板库。
- [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus) ⭐ 2,295 | 🐛 0 | 🌐 C++ | 📅 2026-07-15: C++ 的函数式编程库，编写简洁易读的C++代码。
- [BDE](https://github.com/bloomberg/bde) ⭐ 1,838 | 🐛 15 | 🌐 C++ | 📅 2026-08-21: 来自于彭博资讯实验室的开发环境。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,383 | 🐛 2,933 | 🌐 C++ | 📅 2026-08-24: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,573 | 🐛 17,305 | 🌐 Python | 📅 2026-08-24: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,170 | 🐛 987 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,537 | 🐛 41 | 🌐 C | 📅 2026-08-24: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,431 | 🐛 59 | 🌐 C++ | 📅 2026-08-24: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,175 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 912 | 🐛 177 | 🌐 C++ | 📅 2026-08-24: 快速、轻量级的音乐符号雕刻库。
...
* [Vcflib](https://github.com/ekg/vcflib) ⭐ 684 | 🐛 22 | 🌐 C++ | 📅 2026-03-20: 用于解析和处理VCF文件的C++库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,037 | 🐛 249 | 🌐 C++ | 📅 2026-08-24(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 999 | 🐛 54 | 🌐 C++ | 📅 2026-08-24 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,026 | 🐛 98 | 🌐 C++ | 📅 2026-08-23: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 953 | 🐛 0 | 🌐 C++ | 📅 2026-08-24: 传递消息的并行分子动力学实现。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,420 | 🐛 74 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [tabulate](https://github.com/p-ranav/tabulate) ⭐ 2,172 | 🐛 44 | 🌐 C++ | 📅 2025-05-14: 现代C++的表格制作工具。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,851 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-18: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 851 | 🐛 42 | 🌐 C++ | 📅 2026-08-20: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,609 | 🐛 343 | 🌐 C | 📅 2026-08-23: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,599 | 🐛 603 | 🌐 C | 📅 2026-08-24: 多格式的存档和压缩库。
...
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,023 | 🐛 413 | 🌐 C++ | 📅 2026-08-23: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,886 | 🐛 143 | 🌐 C++ | 📅 2026-08-24: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,647 | 🐛 545 | 🌐 C++ | 📅 2026-08-21: 用于并行运行和内存抽象的便携式编程模型。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 211 | 🌐 C++ | 📅 2026-08-24: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [inih](https://github.com/benhoyt/inih) ⭐ 3,034 | 🐛 5 | 🌐 C++ | 📅 2026-01-30: C语言的简单.INI文件解析器，很适合嵌入式系统。
...
* [inih](https://github.com/jtilly/inih) ⭐ 451 | 🐛 0 | 🌐 C++ | 📅 2024-09-18: [inih](https://github.com/benhoyt/inih) ⭐ 3,034 | 🐛 5 | 🌐 C++ | 📅 2026-01-30的C++版本，只有头文件。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,908 | 🐛 311 | 📅 2026-08-22: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,911 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,903 | 🐛 1,724 | 🌐 C | 📅 2026-08-20: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,999 | 🐛 33 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,755 | 🐛 321 | 🌐 C | 📅 2026-08-24: TLS/SSL协议的实现。
...
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,005 | 🐛 1,618 | 🌐 C++ | 📅 2026-08-22: 来自Facebook的嵌入键值的快速存储。
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,690 | 🐛 15 | 🌐 C++ | 📅 2026-08-15: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [MongoDB C++ Driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,105 | 🐛 3 | 🌐 C++ | 📅 2026-08-20: MongDB的C++驱动程序。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,957 | 🐛 493 | 🌐 C++ | 📅 2026-08-21: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,957 | 🐛 493 | 🌐 C++ | 📅 2026-08-21: Google的C++测试框架。
...
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,351 | 🐛 90 | 🌐 C | 📅 2026-07-21: C的简单单元测试。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,078 | 🐛 18,771 | 🌐 C++ | 📅 2026-08-21: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,453 | 🐛 22 | 🌐 C | 📅 2026-08-24: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,045 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,211 | 🐛 368 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,899 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
* [PixelGameEngine](https://github.com/OneLoneCoder/olcPixelGameEngine) ⭐ 4,229 | 🐛 141 | 🌐 C++ | 📅 2025-09-26: olcPixelGameEngine的官方发行版，该工具用于javidx9的YouTube视频和项目。
* [Spring](https://github.com/spring/spring) ⭐ 3,975 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,842 | 🐛 1,234 | 🌐 C++ | 📅 2026-08-23: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,340 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
...
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,374 | 🐛 57 | 🌐 C++ | 📅 2026-08-22: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,812 | 🐛 93 | 🌐 C++ | 📅 2026-08-24: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,429 | 🐛 284 | 🌐 C++ | 📅 2026-08-23: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,274 | 🐛 760 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,160 | 🐛 541 | 🌐 C++ | 📅 2026-08-24: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,901 | 🐛 50 | 🌐 C++ | 📅 2026-08-24 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,698 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,194 | 🐛 76 | 🌐 C++ | 📅 2026-08-23: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,074 | 🐛 156 | 🌐 C++ | 📅 2026-08-22: 简单的C++几何处理库。
* [urho3d](https://github.com/urho3d/Urho3D) ⚠️ Archived 跨平台的渲染和游戏引擎。
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,410 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
* [OpenSubdiv](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,071 | 🐛 58 | 🌐 C++ | 📅 2026-08-19: Pixar的库，用于评估和渲染CPU和GPU上的细分曲面。
* [Yocto/GL](https://github.com/xelatihy/yocto-gl) ⭐ 2,922 | 🐛 14 | 🌐 C++ | 📅 2024-02-21: 用于数据驱动的基于物理图形的微型C++库。
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,849 | 🐛 33 | 🌐 C++ | 📅 2026-08-20: 用于在C++中编写DirectX 11.x代码的帮助类的集合。
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,619 | 🐛 9 | 🌐 C++ | 📅 2026-08-24: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,977 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,921 | 🐛 2 | 🌐 C++ | 📅 2026-08-24: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,492 | 🐛 417 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,349 | 🐛 185 | 🌐 C++ | 📅 2026-08-23: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
...
* [GD](https://github.com/libgd/libgd) ⭐ 981 | 🐛 106 | 🌐 C | 📅 2026-08-20: GD图形库，有名的用于PHP中图形加载/操作和缩略图生成。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,978 | 🐛 10 | 🌐 C++ | 📅 2026-08-22: C和C++的单个头文件的utf8字符串函数。
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,292 | 🐛 31 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,251 | 🐛 1,383 | 🌐 C++ | 📅 2026-08-24: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,163 | 🐛 325 | 🌐 C++ | 📅 2026-08-21: 快速的数据交换格式和基于功能的RPC系统。
...
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,190 | 🐛 159 | 🌐 C++ | 📅 2026-08-21: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,453 | 🐛 101 | 🌐 C++ | 📅 2026-08-21: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,181 | 🐛 137 | 🌐 C++ | 📅 2026-08-23: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
...
* [LIBUCL](https://github.com/vstakhov/libucl) ⭐ 1,743 | 🐛 116 | 🌐 C | 📅 2026-08-16: 通用配置库解析器。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,520 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,004 | 🐛 10 | 🌐 C++ | 📅 2026-08-24: 异步、跨平台、低时延的日志库。
* [plog](https://github.com/SergiusTheBest/plog) ⭐ 2,576 | 🐛 58 | 🌐 C++ | 📅 2026-08-07: C++可移植且简单的日志，少于1000行代码。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,577 | 🐛 2,754 | 🌐 C++ | 📅 2026-08-24: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,559 | 🐛 1,543 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,690 | 🐛 422 | 🌐 C++ | 📅 2026-08-24: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [SHOGUN](https://github.com/shogun-toolbox/shogun) ⭐ 3,080 | 🐛 426 | 🌐 C++ | 📅 2023-12-19: Shogun 机器学习工具。
...
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,558 | 🐛 115 | 🌐 C | 📅 2026-08-22: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
...
* [TinyExpr](https://github.com/codeplea/tinyexpr) ⭐ 1,918 | 🐛 0 | 🌐 C | 📅 2026-08-06: 用于解析和评估字符串中的数学表达式的C库。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 499 | 🐛 16 | 🌐 C++ | 📅 2026-08-24: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,326 | 🐛 312 | 🌐 C | 📅 2026-08-22: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,059 | 🐛 365 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,528 | 🐛 188 | 🌐 C | 📅 2026-08-23: C和C++的保守的垃圾回收器。
* [memory-allocators](https://github.com/mtrebi/memory-allocators) ⭐ 1,993 | 🐛 16 | 🌐 C++ | 📅 2026-08-20: 自定义内存分配器，可提高动态内存分配的性能。
...
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,879 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,766 | 🐛 3 | 🌐 C++ | 📅 2026-08-24: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,230 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,007 | 🐛 1 | 🌐 C | 📅 2026-08-24<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,537 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-23: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,413 | 🐛 87 | 🌐 C++ | 📅 2026-07-26: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
...
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,043 | 🐛 46 | 🌐 C++ | 📅 2026-08-24: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,819 | 🐛 106 | 🌐 C++ | 📅 2026-08-12: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
...
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,131 | 🐛 60 | 🌐 C++ | 📅 2026-08-23: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,096 | 🐛 48 | 🌐 C++ | 📅 2026-08-24: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,961 | 🐛 45 | 🌐 C | 📅 2026-08-24: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,955 | 🐛 82 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,182 | 🐛 65 | 🌐 C | 📅 2026-08-24: 用于异步DNS请求的C库。
* [mTCP](https://github.com/mtcp-stack/mtcp) ⭐ 2,138 | 🐛 97 | 🌐 C | 📅 2024-07-04: 用于多核系统的高度可扩展的用户级TCP堆栈。
* [PicoHTTPParser](https://github.com/h2o/picohttpparser) ⭐ 2,101 | 🐛 22 | 🌐 C | 📅 2026-04-06: 微小、原始、快速的HTTP请求/响应解析器。
...
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,990 | 🐛 19 | 🌐 C++ | 📅 2026-08-18: 开源的多物理场仿真引擎。
* [Simbody](https://github.com/simbody/simbody) ⭐ 2,545 | 🐛 160 | 🌐 C++ | 📅 2026-08-23: 高性能C++多体动力学/物理库，模拟关节生物力学和机械系统，像车辆，机器人和人体骨骼。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,249 | 🐛 450 | 🌐 C++ | 📅 2026-08-18: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,096 | 🐛 586 | 🌐 C++ | 📅 2026-08-18: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,418 | 🐛 328 | 🌐 C++ | 📅 2026-08-23: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,003 | 🐛 713 | 🌐 C++ | 📅 2026-08-23: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,830 | 🐛 1,508 | 🌐 Cython | 📅 2026-08-24: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,406 | 🐛 266 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,535 | 🐛 79 | 🌐 C | 📅 2026-08-24: ANSI C中的小型代码大小的协议缓冲区实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,009 | 🐛 1,539 | 🌐 C | 📅 2026-08-24: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,204 | 🐛 429 | 🌐 C++ | 📅 2026-08-24: 基于C++ 14/17的高性能HTTP应用程序框架。
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,642 | 🐛 347 | 🌐 C++ | 📅 2025-11-12: 轻量、零依赖的框架，可创建高性能的Web服务。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,492 | 🐛 417 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,077 | 🐛 1 | 🌐 Java | 📅 2026-08-24: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,757 | 🐛 13 | 🌐 C++ | 📅 2026-08-23: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,757 | 🐛 13 | 🌐 C++ | 📅 2026-08-23: C++的小型，安全和快速格式化库。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,390 | 🐛 1,194 | 🌐 CMake | 📅 2026-08-24: Windows，Linux和MacOS的C++库管理器。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,686 | 🐛 298 | 🌐 OCaml | 📅 2026-08-21: 用于Java、C和Objective-C的静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,065 | 🐛 388 | 🌐 C++ | 📅 2026-08-23: 代码美化器。
