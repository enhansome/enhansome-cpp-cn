...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,778 | 🐛 312 | 📅 2026-08-04 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,080 | 🐛 229 | 🌐 C++ | 📅 2026-08-15: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,493 | 🐛 461 | 🌐 C++ | 📅 2026-08-15: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,785 | 🐛 472 | 🌐 C++ | 📅 2026-08-13: 包罗万象的C++类库，用于开发跨平台软件。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,048 | 🐛 2,860 | 🌐 C++ | 📅 2026-08-16: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,395 | 🐛 17,327 | 🌐 Python | 📅 2026-08-16: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,458 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,859 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,138 | 🐛 5 | 🌐 C | 📅 2026-08-03: 单文件音频回放和录制的库。
...
- [minimp3](https://github.com/lieff/minimp3) ⭐ 1,939 | 🐛 54 | 🌐 C | 📅 2026-07-27: 公共域，无尘室实现的MP3解码器，只有头文件。
- [libsndfile](https://github.com/erikd/libsndfile/) ⭐ 1,710 | 🐛 219 | 🌐 C | 📅 2026-08-01: C++封装的C库，用于通过标准库接口读写包含采样声音的文件。
- [Maximilian](https://github.com/micknoise/Maximilian) ⭐ 1,700 | 🐛 32 | 🌐 C++ | 📅 2025-01-04: C++音频和音乐数字信号处理库。
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 912 | 🐛 191 | 🌐 C++ | 📅 2026-08-02: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,023 | 🐛 247 | 🌐 C++ | 📅 2026-08-15(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,018 | 🐛 89 | 🌐 C++ | 📅 2026-08-15: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
...
* [d-SEAMS](https://github.com/d-SEAMS/seams-core) ⭐ 42 | 🐛 17 | 🌐 C++ | 📅 2026-08-16: 具有Nix的C++和Lua实现的分子动力学轨道分析引擎，它是分子模拟的递延结构分析的首字母缩写。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,840 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-14: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 849 | 🐛 41 | 🌐 C++ | 📅 2026-08-15: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,558 | 🐛 338 | 🌐 C | 📅 2026-08-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,595 | 🐛 601 | 🌐 C | 📅 2026-08-14: 多格式的存档和压缩库。
...
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,113 | 🐛 33 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 4,999 | 🐛 395 | 🌐 C++ | 📅 2026-08-14: 用于集体多GPU通信的优化基元。
- [readerwriterqueue](https://github.com/cameron314/readerwriterqueue) ⭐ 4,608 | 🐛 23 | 🌐 C++ | 📅 2026-03-28: C++的快速单生产者、单消费者的无锁队列。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,886 | 🐛 137 | 🌐 C++ | 📅 2026-08-15: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,642 | 🐛 606 | 🌐 C++ | 📅 2026-08-14: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,599 | 🐛 116 | 🌐 C | 📅 2026-08-15: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
* [simpleini](https://github.com/brofield/simpleini) ⭐ 1,320 | 🐛 1 | 🌐 C++ | 📅 2026-06-19: 跨平台的C++库，提供用于读写INI配置文件的简单API。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,778 | 🐛 312 | 📅 2026-08-04: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,892 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,871 | 🐛 1,729 | 🌐 C | 📅 2026-08-14: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,996 | 🐛 34 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,751 | 🐛 305 | 🌐 C | 📅 2026-08-14: TLS/SSL协议的实现。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,324 | 🐛 400 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 31,976 | 🐛 1,615 | 🌐 C++ | 📅 2026-08-14: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,679 | 🐛 75 | 🌐 C | 📅 2026-08-14: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,769 | 🐛 93 | 🌐 C | 📅 2026-07-24: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
...
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,616 | 🐛 139 | 🌐 C++ | 📅 2026-08-15: C++的数据库抽象层。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,930 | 🐛 490 | 🌐 C++ | 📅 2026-08-13: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,930 | 🐛 490 | 🌐 C++ | 📅 2026-08-13: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,429 | 🐛 443 | 🌐 C++ | 📅 2026-08-10: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,429 | 🐛 443 | 🌐 C++ | 📅 2026-08-10: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,352 | 🐛 175 | 🌐 C++ | 📅 2026-08-12: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,845 | 🐛 139 | 🌐 C++ | 📅 2026-07-12: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,345 | 🐛 89 | 🌐 C | 📅 2026-07-21: C的简单单元测试。
...
* [utest.h](https://github.com/sheredom/utest.h) ⭐ 989 | 🐛 14 | 🌐 C++ | 📅 2026-07-21: C和C++的单个头文件测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 115,719 | 🐛 18,671 | 🌐 C++ | 📅 2026-08-14: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,335 | 🐛 31 | 🌐 C | 📅 2026-08-13: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,018 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,205 | 🐛 366 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,892 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
...
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,540 | 🐛 292 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,017 | 🐛 21 | 🌐 C++ | 📅 2023-09-21: 高速的C++17 Vulkan游戏引擎。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,666 | 🐛 1,232 | 🌐 C++ | 📅 2026-08-07: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,323 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,894 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,189 | 🐛 129 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,351 | 🐛 59 | 🌐 C++ | 📅 2026-08-15: 进化的HTML/CSS用户界面库，libRocket的分支。
* [Elements](https://github.com/cycfi/elements) ⭐ 3,717 | 🐛 41 | 🌐 C++ | 📅 2026-06-13: 轻量级、细粒度、分辨率无关的模块化GUI库。
...
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,256 | 🐛 759 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,133 | 🐛 526 | 🌐 C++ | 📅 2026-08-13: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,879 | 🐛 51 | 🌐 C++ | 📅 2026-08-15 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,690 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
...
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,394 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-12: 现代、跨平台、低阶的3D图形库。
...
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,616 | 🐛 12 | 🌐 C++ | 📅 2026-08-13: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,970 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,919 | 🐛 2 | 🌐 C++ | 📅 2026-08-15: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,409 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,778 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: 用于图像中人脸检测的开源库，其人脸检测的速度能达到1500FPS。
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,386 | 🐛 16 | 🌐 C | 📅 2026-08-15: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,347 | 🐛 182 | 🌐 C++ | 📅 2026-08-15: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,264 | 🐛 27 | 🌐 C++ | 📅 2026-08-14: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,070 | 🐛 69 | 🌐 C | 📅 2026-08-04: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,283 | 🐛 1,376 | 🌐 C++ | 📅 2026-08-15: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,157 | 🐛 330 | 🌐 C++ | 📅 2026-08-14: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,292 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,654 | 🐛 65 | 🌐 C | 📅 2026-08-02: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,188 | 🐛 166 | 🌐 C++ | 📅 2026-08-15: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,375 | 🐛 100 | 🌐 C++ | 📅 2026-08-13: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,153 | 🐛 136 | 🌐 C++ | 📅 2026-08-15: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,111 | 🐛 789 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,921 | 🐛 353 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
...
* [json-c](https://github.com/json-c/json-c) ⭐ 3,286 | 🐛 20 | 🌐 C | 📅 2026-08-15: C中的JSON实现。
...
* [jsoncons](https://github.com/danielaparker/jsoncons) ⭐ 851 | 🐛 17 | 🌐 C++ | 📅 2026-08-15: 使用JSONPointer、JSONPatch、JSONPath和JMESPath的JSON和类似JSON二进制格式的C++库，只有头文件。
* [json.h](https://github.com/sheredom/json.h) ⭐ 836 | 🐛 4 | 🌐 C | 📅 2026-07-20: 在C和C++中解析JSON的简单的单头文件/单源文件的解决方案。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,483 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,001 | 🐛 7 | 🌐 C++ | 📅 2026-08-11: 异步、跨平台、低时延的日志库。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,453 | 🐛 2,753 | 🌐 C++ | 📅 2026-08-15: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,575 | 🐛 1,565 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,656 | 🐛 418 | 🌐 C++ | 📅 2026-08-15: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,240 | 🐛 80 | 🌐 C++ | 📅 2026-08-14: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,158 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,554 | 🐛 116 | 🌐 C | 📅 2026-08-15: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,513 | 🐛 45 | 🌐 C++ | 📅 2026-08-14v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,011 | 🐛 684 | 🌐 C++ | 📅 2026-08-12: 高效，可靠的几何算法集合。
...
* [TinyExpr](https://github.com/codeplea/tinyexpr) ⭐ 1,915 | 🐛 0 | 🌐 C | 📅 2026-08-06: 用于解析和评估字符串中的数学表达式的C库。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 500 | 🐛 27 | 🌐 C++ | 📅 2026-08-15: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,294 | 🐛 322 | 🌐 C | 📅 2026-08-16: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,044 | 🐛 362 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,444 | 🐛 42 | 🌐 C++ | 📅 2026-08-15: 用于读取和编辑几种流行音频格式的元数据的库。
...
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 785 | 🐛 356 | 🌐 C++ | 📅 2026-06-21: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,953 | 🐛 48 | 🌐 C++ | 📅 2026-08-16: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,869 | 🐛 195 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,742 | 🐛 2 | 🌐 C++ | 📅 2026-08-15: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,224 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 12,992 | 🐛 4 | 🌐 C | 📅 2026-08-15<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,529 | 🐛 730 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-15: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,314 | 🐛 230 | 🌐 C | 📅 2026-08-15: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,038 | 🐛 47 | 🌐 C++ | 📅 2026-08-15: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,819 | 🐛 106 | 🌐 C++ | 📅 2026-08-12: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,369 | 🐛 24 | 🌐 C | 📅 2026-08-15: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,157 | 🐛 177 | 🌐 C | 📅 2026-08-15: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,129 | 🐛 53 | 🌐 C++ | 📅 2026-08-14: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-15: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,678 | 🐛 423 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,982 | 🐛 24 | 🌐 C++ | 📅 2026-08-15: 开源的多物理场仿真引擎。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,245 | 🐛 447 | 🌐 C++ | 📅 2026-08-11: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,168 | 🐛 16 | 🌐 C++ | 📅 2026-08-11: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
...
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions) ⭐ 3,831 | 🐛 104 | 🌐 C++ | 📅 2026-07-11: 编译时PCRE（几乎）兼容的正则表达式匹配器。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,092 | 🐛 584 | 🌐 C++ | 📅 2026-08-14: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,416 | 🐛 323 | 🌐 C++ | 📅 2026-08-15: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 17,995 | 🐛 712 | 🌐 C++ | 📅 2026-08-15: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,826 | 🐛 1,497 | 🌐 Cython | 📅 2026-08-15: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [libffi](https://github.com/libffi/libffi) ⭐ 4,351 | 🐛 193 | 🌐 C | 📅 2026-08-09: 可移植的外部功能接口库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 21,992 | 🐛 1,535 | 🌐 C | 📅 2026-08-14: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,186 | 🐛 423 | 🌐 C++ | 📅 2026-08-11: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,036 | 🐛 49 | 🌐 C | 📅 2026-08-15: 实验性、可扩展的高性能HTTP服务器。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,785 | 🐛 122 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,409 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,068 | 🐛 0 | 🌐 Java | 📅 2026-07-28: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,742 | 🐛 9 | 🌐 C++ | 📅 2026-08-13: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,742 | 🐛 9 | 🌐 C++ | 📅 2026-08-13: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,535 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
* [Klib](https://github.com/attractivechaos/klib) ⭐ 4,715 | 🐛 94 | 🌐 C | 📅 2025-12-22: 通用算法和数据结构的小型、轻量级实现。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,364 | 🐛 1,159 | 🌐 CMake | 📅 2026-08-15: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,437 | 🐛 0 | 🌐 Rust | 📅 2026-08-13: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,675 | 🐛 298 | 🌐 OCaml | 📅 2026-08-12: 用于Java、C和Objective-C的静态分析器。
* [IKOS](https://github.com/NASA-SW-VnV/ikos) ⭐ 3,160 | 🐛 50 | 🌐 C++ | 📅 2026-05-31: 基于抽象解释理论的C / C++静态分析器。
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,843 | 🐛 82 | 🌐 Python | 📅 2026-08-14: 遵循Google C++样式指南的C++样式检查器。
