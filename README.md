...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,009 | 🐛 311 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,106 | 🐛 235 | 🌐 C++ | 📅 2026-08-29: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,520 | 🐛 464 | 🌐 C++ | 📅 2026-08-29: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,845 | 🐛 477 | 🌐 C++ | 📅 2026-08-28: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,110 | 🐛 62 | 🌐 C++ | 📅 2026-08-28: 嵌入式模板库。
- [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus) ⭐ 2,295 | 🐛 0 | 🌐 C++ | 📅 2026-07-15: C++ 的函数式编程库，编写简洁易读的C++代码。
- [BDE](https://github.com/bloomberg/bde) ⭐ 1,839 | 🐛 15 | 🌐 C++ | 📅 2026-08-27: 来自于彭博资讯实验室的开发环境。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,021 | 🐛 2,965 | 🌐 C++ | 📅 2026-08-30: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,660 | 🐛 17,438 | 🌐 Python | 📅 2026-08-30: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,471 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,176 | 🐛 989 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,541 | 🐛 42 | 🌐 C | 📅 2026-08-24: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,432 | 🐛 58 | 🌐 C++ | 📅 2026-08-29: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,206 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 914 | 🐛 175 | 🌐 C++ | 📅 2026-08-27: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,045 | 🐛 249 | 🌐 C++ | 📅 2026-08-29(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 999 | 🐛 49 | 🌐 C++ | 📅 2026-08-29 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,034 | 🐛 93 | 🌐 C++ | 📅 2026-08-29: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,430 | 🐛 75 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,856 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-27: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 852 | 🐛 42 | 🌐 C++ | 📅 2026-08-20: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,646 | 🐛 347 | 🌐 C | 📅 2026-08-29: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,605 | 🐛 599 | 🌐 C | 📅 2026-08-30: 多格式的存档和压缩库。
...
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,033 | 🐛 417 | 🌐 C++ | 📅 2026-08-29: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,887 | 🐛 134 | 🌐 C++ | 📅 2026-08-30: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,600 | 🐛 117 | 🌐 C | 📅 2026-08-28: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,134 | 🐛 28 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。

* [simpleini](https://github.com/brofield/simpleini) ⭐ 1,326 | 🐛 1 | 🌐 C++ | 📅 2026-06-19: 跨平台的C++库，提供用于读写INI配置文件的简单API。
...
* [Colony](https://github.com/mattreecebentley/plf_colony) ⭐ 504 | 🐛 0 | 🌐 C++ | 📅 2026-08-26: 无序的”bag“型容器，在高度修改的情况下，其性能优于标准容器。同时，无论插入还是擦除，其都能始终保持指向未擦除元素的永久指针。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 73,009 | 🐛 311 | 📅 2026-08-22: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,920 | 🐛 1 | 🌐 C | 📅 2026-08-28: 基于NaCI的加密库，固执己见，容易使用。
...
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 5,002 | 🐛 35 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,757 | 🐛 319 | 🌐 C | 📅 2026-08-28: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,973 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,788 | 🐛 53 | 🌐 C | 📅 2026-08-08: 相当全面、模块化和可移植的加密工具包。
* [sha1collisiondetection](https://github.com/cr-marcstevens/sha1collisiondetection) ⭐ 1,415 | 🐛 17 | 🌐 C | 📅 2025-10-30: 用于检测文件中SHA-1冲突的库和命令行工具。
...
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,027 | 🐛 1,630 | 🌐 C++ | 📅 2026-08-28: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,680 | 🐛 82 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,781 | 🐛 92 | 🌐 C | 📅 2026-08-25: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,693 | 🐛 16 | 🌐 C++ | 📅 2026-08-29: 适用于现代C++的SQLite ORM轻量库，只有头文件。
* [sqlpp11](https://github.com/rbock/sqlpp11) ⭐ 2,624 | 🐛 3 | 🌐 C++ | 📅 2026-04-24: 用于SQL查询和在C++产生结果的类型安全的嵌入式域特定语言。
* [UnQLite](https://github.com/symisc/unqlite) ⭐ 2,314 | 🐛 31 | 🌐 C | 📅 2026-05-01: 独立、无服务器、零配置的事物型NoSQL引擎。
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 117 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组DBMS。
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,619 | 🐛 138 | 🌐 C++ | 📅 2026-08-29: C++的数据库抽象层。
...
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 385 | 🐛 6 | 🌐 C++ | 📅 2026-08-28: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 39,323 | 🐛 494 | 🌐 C++ | 📅 2026-08-27: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 39,323 | 🐛 494 | 🌐 C++ | 📅 2026-08-27: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,450 | 🐛 439 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,450 | 🐛 439 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
...
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,359 | 🐛 85 | 🌐 C | 📅 2026-08-25: C的简单单元测试。
...
* [utest.h](https://github.com/sheredom/utest.h) ⭐ 991 | 🐛 7 | 🌐 C++ | 📅 2026-08-23: C和C++的单个头文件测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,361 | 🐛 18,804 | 🌐 C++ | 📅 2026-08-29: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,509 | 🐛 16 | 🌐 C | 📅 2026-08-29: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,061 | 🐛 11 | 🌐 C++ | 📅 2026-08-28: 游戏与现代C++的碰撞。
...
* [PixelGameEngine](https://github.com/OneLoneCoder/olcPixelGameEngine) ⭐ 4,231 | 🐛 141 | 🌐 C++ | 📅 2025-09-26: olcPixelGameEngine的官方发行版，该工具用于javidx9的YouTube视频和项目。
* [Spring](https://github.com/spring/spring) ⭐ 3,978 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,855 | 🐛 47 | 🌐 C | 📅 2026-08-29: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,549 | 🐛 295 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,019 | 🐛 21 | 🌐 C++ | 📅 2023-09-21: 高速的C++17 Vulkan游戏引擎。
...
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-08-27: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,946 | 🐛 1,240 | 🌐 C++ | 📅 2026-08-28: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,357 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,895 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,207 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,395 | 🐛 55 | 🌐 C++ | 📅 2026-08-29: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,683 | 🐛 9 | 🌐 C++ | 📅 2026-08-29: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,444 | 🐛 285 | 🌐 C++ | 📅 2026-08-29: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,296 | 🐛 762 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,169 | 🐛 544 | 🌐 C++ | 📅 2026-08-29: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,910 | 🐛 50 | 🌐 C++ | 📅 2026-08-29 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,701 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
...
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,418 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
...
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,624 | 🐛 8 | 🌐 C++ | 📅 2026-08-29: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,982 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
...
* [Horde3D](https://github.com/horde3d/Horde3D) ⭐ 1,584 | 🐛 22 | 🌐 C++ | 📅 2026-07-30 一个小型的3D渲染和动画引擎。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,542 | 🐛 417 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,350 | 🐛 183 | 🌐 C++ | 📅 2026-08-29: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
...
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,073 | 🐛 69 | 🌐 C | 📅 2026-08-29: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
...
* [TinyEXIF](https://github.com/cdcseacave/TinyEXIF) ⭐ 147 | 🐛 0 | 🌐 C++ | 📅 2026-08-23: 用于JPEG的微型ISO兼容的C++ EXIF和XMP解析库。
...
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,293 | 🐛 34 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,276 | 🐛 1,358 | 🌐 C++ | 📅 2026-08-29: 高性能、开源、通用的RPC框架。
...
* [nng](https://github.com/nanomsg/nng) ⭐ 4,660 | 🐛 64 | 🌐 C | 📅 2026-08-30: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,191 | 🐛 156 | 🌐 C++ | 📅 2026-08-28: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,487 | 🐛 140 | 🌐 C++ | 📅 2026-08-28: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,214 | 🐛 134 | 🌐 C++ | 📅 2026-08-27: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,119 | 🐛 790 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,959 | 🐛 356 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,886 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,178 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,359 | 🐛 128 | 🌐 C | 📅 2026-07-09: 进行编解码和处理Json数据的C语言库。
* [json-c](https://github.com/json-c/json-c) ⭐ 3,286 | 🐛 22 | 🌐 C | 📅 2026-08-21: C中的JSON实现。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,543 | 🐛 50 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,013 | 🐛 7 | 🌐 C++ | 📅 2026-08-29: 异步、跨平台、低时延的日志库。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,640 | 🐛 2,754 | 🌐 C++ | 📅 2026-08-29: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,555 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,710 | 🐛 428 | 🌐 C++ | 📅 2026-08-27: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [MeTA](https://github.com/meta-toolkit/meta) ⭐ 716 | 🐛 56 | 🌐 C++ | 📅 2023-04-17: 现代C++的数据科学工具包。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,435 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,187 | 🐛 126 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,563 | 🐛 119 | 🌐 C | 📅 2026-08-26: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,552 | 🐛 50 | 🌐 C++ | 📅 2026-08-28v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,027 | 🐛 677 | 🌐 C++ | 📅 2026-08-27: 高效，可靠的几何算法集合。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,334 | 🐛 312 | 🌐 C | 📅 2026-08-29: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,076 | 🐛 369 | 🌐 C | 📅 2026-08-27: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,532 | 🐛 188 | 🌐 C | 📅 2026-08-23: C和C++的保守的垃圾回收器。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,447 | 🐛 41 | 🌐 C++ | 📅 2026-08-29: 用于读取和编辑几种流行音频格式的元数据的库。
...
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 788 | 🐛 346 | 🌐 C++ | 📅 2026-08-28: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,970 | 🐛 48 | 🌐 C++ | 📅 2026-08-29: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,889 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,793 | 🐛 2 | 🌐 C++ | 📅 2026-08-30: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,226 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,014 | 🐛 2 | 🌐 C | 📅 2026-08-28<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,542 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,376 | 🐛 39 | 🌐 C++ | 📅 2026-08-29: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,422 | 🐛 86 | 🌐 C++ | 📅 2026-08-28: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,321 | 🐛 232 | 🌐 C | 📅 2026-08-29: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,046 | 🐛 46 | 🌐 C++ | 📅 2026-08-24: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,822 | 🐛 106 | 🌐 C++ | 📅 2026-08-25: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,397 | 🐛 24 | 🌐 C | 📅 2026-08-28: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,165 | 🐛 181 | 🌐 C | 📅 2026-08-28: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,133 | 🐛 62 | 🌐 C++ | 📅 2026-08-27: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-29: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,965 | 🐛 42 | 🌐 C | 📅 2026-08-29: 高速打包处理框架。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,704 | 🐛 424 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,998 | 🐛 17 | 🌐 C++ | 📅 2026-08-28: 开源的多物理场仿真引擎。
* [Simbody](https://github.com/simbody/simbody) ⭐ 2,547 | 🐛 158 | 🌐 C++ | 📅 2026-08-25: 高性能C++多体动力学/物理库，模拟关节生物力学和机械系统，像车辆，机器人和人体骨骼。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,251 | 🐛 462 | 🌐 C++ | 📅 2026-08-27: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,177 | 🐛 17 | 🌐 C++ | 📅 2026-08-11: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
...
* [RE2](https://github.com/google/re2) ⭐ 9,787 | 🐛 64 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,475 | 🐛 200 | 🌐 C++ | 📅 2026-08-26: Hyperscan是Intel的高性能、多种正则表达式匹配库，提供大量正则表达式（多达数万个）的同时匹配，通常在DPI库堆栈中使用。
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions) ⭐ 3,840 | 🐛 104 | 🌐 C++ | 📅 2026-07-11: 编译时PCRE（几乎）兼容的正则表达式匹配器。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,103 | 🐛 577 | 🌐 C++ | 📅 2026-08-29: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,420 | 🐛 325 | 🌐 C++ | 📅 2026-08-29: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,009 | 🐛 715 | 🌐 C++ | 📅 2026-08-29: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,836 | 🐛 1,519 | 🌐 Cython | 📅 2026-08-28: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,418 | 🐛 271 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,541 | 🐛 80 | 🌐 C | 📅 2026-08-26: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,705 | 🐛 344 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,497 | 🐛 39 | 🌐 Java | 📅 2026-08-22: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,344 | 🐛 103 | 📅 2026-08-25: C/C++的高效二进制序列化库，例如 JSON。
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,141 | 🐛 306 | 🌐 C++ | 📅 2026-08-28: 开源H.364 编解码器。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,021 | 🐛 1,535 | 🌐 C | 📅 2026-08-28: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,222 | 🐛 421 | 🌐 C++ | 📅 2026-08-27: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,443 | 🐛 240 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
* [facil.io](https://github.com/boazsegev/facil.io) ⭐ 2,399 | 🐛 37 | 🌐 C | 📅 2026-04-14: 事件型、高性能的C Web框架，支持HTTP、WebSocket、SSE等。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,542 | 🐛 417 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,079 | 🐛 0 | 🌐 Java | 📅 2026-08-24: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,765 | 🐛 15 | 🌐 C++ | 📅 2026-08-29: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,765 | 🐛 15 | 🌐 C++ | 📅 2026-08-29: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,549 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
...
* [mio](https://github.com/mandreyel/mio) ⭐ 1,952 | 🐛 52 | 🌐 C++ | 📅 2024-02-11: 用于内存映射文件IO的跨平台C++ 11库，只包含头文件。
...
* [stdman](https://github.com/jeaye/stdman) ⭐ 997 | 🐛 10 | 🌐 C++ | 📅 2024-07-06: 格式化的C++ 11/14 stdlib手册页（来自cppreference）。
...
* [8cc](https://github.com/rui314/8cc) ⭐ 6,413 | 🐛 46 | 🌐 C | 📅 2024-05-02: 小型C编译器。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,406 | 🐛 1,217 | 🌐 CMake | 📅 2026-08-29: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,456 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,694 | 🐛 201 | 🌐 OCaml | 📅 2026-08-27: 用于Java、C和Objective-C的静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,065 | 🐛 389 | 🌐 C++ | 📅 2026-08-28: 代码美化器。
