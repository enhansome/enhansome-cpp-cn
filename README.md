...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,960 | 🐛 313 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,105 | 🐛 238 | 🌐 C++ | 📅 2026-08-26: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,509 | 🐛 463 | 🌐 C++ | 📅 2026-08-27: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,827 | 🐛 474 | 🌐 C++ | 📅 2026-08-26: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,107 | 🐛 61 | 🌐 C++ | 📅 2026-08-27: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,719 | 🐛 2,942 | 🌐 C++ | 📅 2026-08-27: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,613 | 🐛 17,373 | 🌐 Python | 📅 2026-08-27: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,188 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,040 | 🐛 250 | 🌐 C++ | 📅 2026-08-27(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 999 | 🐛 50 | 🌐 C++ | 📅 2026-08-27 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,426 | 🐛 74 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
* [linenoise](https://github.com/antirez/linenoise) ⭐ 4,344 | 🐛 155 | 🌐 C | 📅 2026-05-02: readline和libedit的独立小选择。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,855 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-27: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 851 | 🐛 42 | 🌐 C++ | 📅 2026-08-20: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,635 | 🐛 346 | 🌐 C | 📅 2026-08-27: Zstandard-快速实时压缩算法。由Facebook开发。
...
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,484 | 🐛 15 | 🌐 C | 📅 2026-08-23: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
...
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,129 | 🐛 34 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,028 | 🐛 417 | 🌐 C++ | 📅 2026-08-26: 用于集体多GPU通信的优化基元。
- [readerwriterqueue](https://github.com/cameron314/readerwriterqueue) ⭐ 4,616 | 🐛 22 | 🌐 C++ | 📅 2026-08-23: C++的快速单生产者、单消费者的无锁队列。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 138 | 🌐 C++ | 📅 2026-08-26: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,600 | 🐛 117 | 🌐 C | 📅 2026-08-27: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 211 | 🌐 C++ | 📅 2026-08-27: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,960 | 🐛 313 | 📅 2026-08-22: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,917 | 🐛 1 | 🌐 C | 📅 2026-08-27: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,921 | 🐛 1,727 | 🌐 C | 📅 2026-08-20: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
...
* [Vince's CSV Parser](https://github.com/vincentlaucsb/csv-parser) ⭐ 1,122 | 🐛 2 | 🌐 C++ | 📅 2026-08-23: 快速、独立、流式的C++17 CSV解析器，具有可选的类型转换和统计信息。
...
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,014 | 🐛 1,623 | 🌐 C++ | 📅 2026-08-27: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,680 | 🐛 73 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,780 | 🐛 93 | 🌐 C | 📅 2026-08-25: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,691 | 🐛 17 | 🌐 C++ | 📅 2026-08-27: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,964 | 🐛 491 | 🌐 C++ | 📅 2026-08-27: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,964 | 🐛 491 | 🌐 C++ | 📅 2026-08-27: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,443 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,443 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,372 | 🐛 176 | 🌐 C++ | 📅 2026-08-26: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,854 | 🐛 141 | 🌐 C++ | 📅 2026-08-18: 功能最轻便的单个C++头文件的测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,217 | 🐛 18,768 | 🌐 C++ | 📅 2026-08-27: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,484 | 🐛 17 | 🌐 C | 📅 2026-08-26: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,051 | 🐛 11 | 🌐 C++ | 📅 2026-08-27: 游戏与现代C++的碰撞。
...
* [Corange](https://github.com/orangeduck/Corange) ⭐ 1,986 | 🐛 22 | 🌐 C | 📅 2024-06-03: 用纯C、SDL、OpenGL编写的游戏引擎。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,889 | 🐛 1,237 | 🌐 C++ | 📅 2026-08-23: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,352 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,896 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,204 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,389 | 🐛 56 | 🌐 C++ | 📅 2026-08-24: 进化的HTML/CSS用户界面库，libRocket的分支。
* [Elements](https://github.com/cycfi/elements) ⭐ 3,721 | 🐛 41 | 🌐 C++ | 📅 2026-06-13: 轻量级、细粒度、分辨率无关的模块化GUI库。
* [Yue](https://github.com/yue/yue) ⭐ 3,615 | 🐛 13 | 🌐 C++ | 📅 2025-01-24: 创建本机跨平台GUI应用的库。
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,682 | 🐛 9 | 🌐 C++ | 📅 2026-08-27: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
...
* [assimp](https://github.com/assimp/assimp) ⭐ 13,166 | 🐛 543 | 🌐 C++ | 📅 2026-08-27: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
...
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,416 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
...
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,922 | 🐛 2 | 🌐 C++ | 📅 2026-08-27: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,519 | 🐛 417 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,403 | 🐛 16 | 🌐 C | 📅 2026-08-26: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,350 | 🐛 185 | 🌐 C++ | 📅 2026-08-27: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,265 | 🐛 25 | 🌐 C++ | 📅 2026-08-27: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,266 | 🐛 1,367 | 🌐 C++ | 📅 2026-08-27: 高性能、开源、通用的RPC框架。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,472 | 🐛 142 | 🌐 C++ | 📅 2026-08-27: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,201 | 🐛 133 | 🌐 C++ | 📅 2026-08-27: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,121 | 🐛 790 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,957 | 🐛 355 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,885 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,177 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,530 | 🐛 50 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,010 | 🐛 10 | 🌐 C++ | 📅 2026-08-26: 异步、跨平台、低时延的日志库。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,615 | 🐛 2,757 | 🌐 C++ | 📅 2026-08-27: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,556 | 🐛 1,595 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,698 | 🐛 421 | 🌐 C++ | 📅 2026-08-26: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,432 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,184 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,563 | 🐛 116 | 🌐 C | 📅 2026-08-26: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,547 | 🐛 47 | 🌐 C++ | 📅 2026-08-27v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,026 | 🐛 673 | 🌐 C++ | 📅 2026-08-27: 高效，可靠的几何算法集合。
...
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,402 | 🐛 249 | 🌐 C++ | 📅 2026-08-26: 快速符号处理库，用C++重写了SymPy的核心。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,331 | 🐛 313 | 🌐 C | 📅 2026-08-22: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,066 | 🐛 369 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
...
* [libass](https://github.com/libass/libass) ⭐ 1,162 | 🐛 168 | 🌐 C | 📅 2026-08-22: ASS / SSA字幕格式的便携式字幕渲染器。
* [libass](https://github.com/libass/libass) ⭐ 1,162 | 🐛 168 | 🌐 C | 📅 2026-08-22: 处理多媒体内容（例如音频、视频、字幕和相关元数据）的库和工具的集合。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,967 | 🐛 48 | 🌐 C++ | 📅 2026-08-18: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,888 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,782 | 🐛 9 | 🌐 C++ | 📅 2026-08-27: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,227 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,010 | 🐛 2 | 🌐 C | 📅 2026-08-27<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,541 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,376 | 🐛 39 | 🌐 C++ | 📅 2026-08-26: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,419 | 🐛 87 | 🌐 C++ | 📅 2026-07-26: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,319 | 🐛 232 | 🌐 C | 📅 2026-08-26: 提供客户端和服务器库的轻量级纯C WebSocket实现。
...
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,396 | 🐛 24 | 🌐 C | 📅 2026-08-26: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,164 | 🐛 180 | 🌐 C | 📅 2026-08-21: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,132 | 🐛 55 | 🌐 C++ | 📅 2026-08-27: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-26: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,965 | 🐛 42 | 🌐 C | 📅 2026-08-27: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,957 | 🐛 82 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,182 | 🐛 70 | 🌐 C | 📅 2026-08-24: 用于异步DNS请求的C库。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,039 | 🐛 585 | 🌐 C | 📅 2026-08-27: 用于C和C++的Apache Kafka客户端库。
...
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,995 | 🐛 20 | 🌐 C++ | 📅 2026-08-27: 开源的多物理场仿真引擎。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,101 | 🐛 585 | 🌐 C++ | 📅 2026-08-18: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,538 | 🐛 79 | 🌐 C | 📅 2026-08-26: ANSI C中的小型代码大小的协议缓冲区实现。
...
* [protobuf-c](https://github.com/protobuf-c/protobuf-c) ⭐ 2,989 | 🐛 48 | 🌐 C++ | 📅 2026-08-22: C语言的协议缓冲实现。
* [Bond](https://github.com/Microsoft/bond) ⚠️ Archived: 用于处理模式化数据的开源、跨平台框架。
* [mrpt-serialization](https://github.com/mrpt/mrpt/) ⭐ 2,157 | 🐛 28 | 🌐 C++ | 📅 2026-08-21: 已版本控制的二进制或文本格式的序列化。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,012 | 🐛 1,536 | 🌐 C | 📅 2026-08-27: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,219 | 🐛 420 | 🌐 C++ | 📅 2026-08-27: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,519 | 🐛 417 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,077 | 🐛 0 | 🌐 Java | 📅 2026-08-24: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,766 | 🐛 17 | 🌐 C++ | 📅 2026-08-23: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,766 | 🐛 17 | 🌐 C++ | 📅 2026-08-23: C++的小型，安全和快速格式化库。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,403 | 🐛 1,200 | 🌐 CMake | 📅 2026-08-26: Windows，Linux和MacOS的C++库管理器。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,691 | 🐛 194 | 🌐 OCaml | 📅 2026-08-27: 用于Java、C和Objective-C的静态分析器。
