...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,954 | 🐛 311 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,104 | 🐛 238 | 🌐 C++ | 📅 2026-08-26: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,507 | 🐛 463 | 🌐 C++ | 📅 2026-08-27: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,824 | 🐛 473 | 🌐 C++ | 📅 2026-08-26: 包罗万象的C++类库，用于开发跨平台软件。
- [tbox](https://github.com/tboox/tbox) ⭐ 5,121 | 🐛 37 | 🌐 C | 📅 2026-08-04: 类似于glib的多平台C库。
- [CO](https://github.com/idealvin/co) ⭐ 4,211 | 🐛 14 | 🌐 C++ | 📅 2025-05-27 - C++基础库，包含 go-style 协程库，日志库, JSON库, RPC 框架以及其他基本组件。
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,107 | 🐛 62 | 🌐 C++ | 📅 2026-08-26: 嵌入式模板库。
- [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus) ⭐ 2,295 | 🐛 0 | 🌐 C++ | 📅 2026-07-15: C++ 的函数式编程库，编写简洁易读的C++代码。
- [BDE](https://github.com/bloomberg/bde) ⭐ 1,838 | 🐛 15 | 🌐 C++ | 📅 2026-08-25: 来自于彭博资讯实验室的开发环境。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,643 | 🐛 2,945 | 🌐 C++ | 📅 2026-08-27: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,611 | 🐛 17,377 | 🌐 Python | 📅 2026-08-27: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,469 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,876 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
- [tiny-dnn](https://github.com/tiny-dnn/tiny-dnn) ⭐ 6,030 | 🐛 297 | 🌐 C++ | 📅 2022-04-17: C++11中的无依赖项的深度学习框架，只有头文件。
- [Genann](https://github.com/codeplea/genann) ⭐ 2,280 | 🐛 0 | 🌐 C | 📅 2026-08-08: 简单的神经网络C库。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,175 | 🐛 987 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,539 | 🐛 41 | 🌐 C | 📅 2026-08-24: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,432 | 🐛 58 | 🌐 C++ | 📅 2026-08-26: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,186 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
- [Wav2Letter++](https://github.com/facebookresearch/wav2letter/) ⭐ 6,437 | 🐛 107 | 🌐 C++ | 📅 2026-07-14: 公共域，完全用C++编写的快速开放源代码的语音处理库，同时使用ArrayFire张量库和flashlight机器学习库来实现最高的效率。
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,166 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
- [libsoundio](https://github.com/andrewrk/libsoundio) ⭐ 2,099 | 🐛 137 | 🌐 C | 📅 2025-01-13: 用于跨平台实时音频输入输出的C库。
- [minimp3](https://github.com/lieff/minimp3) ⭐ 1,945 | 🐛 54 | 🌐 C | 📅 2026-07-27: 公共域，无尘室实现的MP3解码器，只有头文件。
...
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 914 | 🐛 177 | 🌐 C++ | 📅 2026-08-24: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,040 | 🐛 249 | 🌐 C++ | 📅 2026-08-27(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 999 | 🐛 54 | 🌐 C++ | 📅 2026-08-26 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,029 | 🐛 91 | 🌐 C++ | 📅 2026-08-26: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 955 | 🐛 0 | 🌐 C++ | 📅 2026-08-26: 传递消息的并行分子动力学实现。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,425 | 🐛 74 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
* [linenoise](https://github.com/antirez/linenoise) ⭐ 4,343 | 🐛 155 | 🌐 C | 📅 2026-05-02: readline和libedit的独立小选择。
...
* [PDCurses](https://github.com/wmcbrine/PDCurses) ⭐ 1,243 | 🐛 44 | 🌐 C | 📅 2026-01-10: 具有源代码和预编译库的公共域curses库。
* [docopt.cpp](https://github.com/docopt/docopt.cpp) ⭐ 1,089 | 🐛 68 | 🌐 C++ | 📅 2025-10-03: 从文档字符串生成选项解析的库。
...
* [Lyra](https://github.com/bfgroup/Lyra) ⭐ 599 | 🐛 7 | 🌐 C++ | 📅 2026-07-29: 易于使用的、可组合的命令行解析器，适用于C++11及更高版本。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,854 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-18: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 851 | 🐛 42 | 🌐 C++ | 📅 2026-08-20: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,632 | 🐛 345 | 🌐 C | 📅 2026-08-23: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,602 | 🐛 602 | 🌐 C | 📅 2026-08-26: 多格式的存档和压缩库。
- [LZFSE](https://github.com/lzfse/lzfse) ⭐ 1,822 | 🐛 29 | 🌐 C | 📅 2022-09-05: LZFSE压缩库和命令行工具。
- [FiniteStateEntropy](https://github.com/Cyan4973/FiniteStateEntropy) ⭐ 1,497 | 🐛 22 | 🌐 C | 📅 2024-03-21: 新一代熵编解码器: 有限状态熵和Huff()。
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,483 | 🐛 15 | 🌐 C | 📅 2026-08-23: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,467 | 🐛 77 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,127 | 🐛 34 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,028 | 🐛 416 | 🌐 C++ | 📅 2026-08-26: 用于集体多GPU通信的优化基元。
- [readerwriterqueue](https://github.com/cameron314/readerwriterqueue) ⭐ 4,615 | 🐛 22 | 🌐 C++ | 📅 2026-08-23: C++的快速单生产者、单消费者的无锁队列。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 136 | 🌐 C++ | 📅 2026-08-26: 适用于任何规模的并行分布式应用的通用C++运行时系统。
- [libcds](https://github.com/khizmax/libcds) ⭐ 2,745 | 🐛 55 | 🌐 C++ | 📅 2023-10-17: 并行数据结构的C++库。
- [ck](https://github.com/concurrencykit/ck) ⭐ 2,690 | 🐛 8 | 🌐 C | 📅 2026-08-10: 并发基元，安全内存回收机制和非阻塞数据结构。
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,649 | 🐛 551 | 🌐 C++ | 📅 2026-08-26: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,600 | 🐛 116 | 🌐 C | 📅 2026-08-26: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
- [Boost.Compute](https://github.com/kylelutz/compute) ⭐ 1,661 | 🐛 157 | 🌐 C++ | 📅 2026-08-12: 用于OpenCL的C++GPU计算库。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 212 | 🌐 C++ | 📅 2026-08-26: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
- [SObjectizer](https://github.com/Stiffstream/sobjectizer) ⭐ 623 | 🐛 13 | 🌐 C++ | 📅 2026-08-15: 实现Actor、Publish-Subscribe和CSP模式的相当小的C++框架。
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,132 | 🐛 28 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。

* [simpleini](https://github.com/brofield/simpleini) ⭐ 1,325 | 🐛 1 | 🌐 C++ | 📅 2026-06-19: 跨平台的C++库，提供用于读写INI配置文件的简单API。

* [libconfig](https://github.com/hyperrealm/libconfig) ⭐ 1,223 | 🐛 40 | 🌐 C | 📅 2026-02-09: 用于处理结构化配置文件的C、C++库。

* [iniparser](https://github.com/ndevilla/iniparser) ⭐ 1,072 | 🐛 6 | 🌐 C | 📅 2026-07-19: INI文件解析器。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,954 | 🐛 311 | 📅 2026-08-22: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,916 | 🐛 1 | 🌐 C | 📅 2026-08-26: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,918 | 🐛 1,727 | 🌐 C | 📅 2026-08-20: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 5,000 | 🐛 33 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,756 | 🐛 323 | 🌐 C | 📅 2026-08-27: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,973 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,788 | 🐛 52 | 🌐 C | 📅 2026-08-08: 相当全面、模块化和可移植的加密工具包。
* [sha1collisiondetection](https://github.com/cr-marcstevens/sha1collisiondetection) ⭐ 1,414 | 🐛 17 | 🌐 C | 📅 2025-10-30: 用于检测文件中SHA-1冲突的库和命令行工具。
* [libhydrogen](https://github.com/jedisct1/libhydrogen) ⭐ 779 | 🐛 0 | 🌐 C | 📅 2026-08-26: 轻量级、安全、易于使用的加密库，适用于受限的环境。
...
* [Vince's CSV Parser](https://github.com/vincentlaucsb/csv-parser) ⭐ 1,121 | 🐛 2 | 🌐 C++ | 📅 2026-08-23: 快速、独立、流式的C++17 CSV解析器，具有可选的类型转换和统计信息。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,365 | 🐛 402 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,012 | 🐛 1,623 | 🌐 C++ | 📅 2026-08-27: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,679 | 🐛 73 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,780 | 🐛 93 | 🌐 C | 📅 2026-08-25: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,691 | 🐛 16 | 🌐 C++ | 📅 2026-08-27: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,073 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组DBMS。
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,619 | 🐛 138 | 🌐 C++ | 📅 2026-08-21: C++的数据库抽象层。
* [MongoDB C++ Driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,106 | 🐛 1 | 🌐 C++ | 📅 2026-08-26: MongDB的C++驱动程序。
* [sqlite\_modern\_cpp](https://github.com/SqliteModernCpp/sqlite_modern_cpp) ⭐ 949 | 🐛 43 | 🌐 C++ | 📅 2024-07-23: sqlite库的C++14封装器，只有头文件。
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 6 | 🌐 C | 📅 2026-08-25: C的MongoDB客户端库。
...
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 385 | 🐛 5 | 🌐 C++ | 📅 2026-08-24: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,961 | 🐛 491 | 🌐 C++ | 📅 2026-08-26: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,961 | 🐛 491 | 🌐 C++ | 📅 2026-08-26: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,444 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,444 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,372 | 🐛 176 | 🌐 C++ | 📅 2026-08-26: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,855 | 🐛 141 | 🌐 C++ | 📅 2026-08-18: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,356 | 🐛 85 | 🌐 C | 📅 2026-08-25: C的简单单元测试。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,192 | 🐛 18,757 | 🌐 C++ | 📅 2026-08-27: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,478 | 🐛 16 | 🌐 C | 📅 2026-08-26: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,050 | 🐛 11 | 🌐 C++ | 📅 2026-08-26: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,213 | 🐛 368 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,900 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
...
* [Spring](https://github.com/spring/spring) ⭐ 3,977 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,855 | 🐛 47 | 🌐 C | 📅 2026-08-27: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,547 | 🐛 293 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,884 | 🐛 1,237 | 🌐 C++ | 📅 2026-08-23: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,351 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,896 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,203 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,388 | 🐛 56 | 🌐 C++ | 📅 2026-08-24: 进化的HTML/CSS用户界面库，libRocket的分支。
* [Elements](https://github.com/cycfi/elements) ⭐ 3,721 | 🐛 41 | 🌐 C++ | 📅 2026-06-13: 轻量级、细粒度、分辨率无关的模块化GUI库。
* [Yue](https://github.com/yue/yue) ⭐ 3,614 | 🐛 13 | 🌐 C++ | 📅 2025-01-24: 创建本机跨平台GUI应用的库。
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,682 | 🐛 9 | 🌐 C++ | 📅 2026-08-26: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,814 | 🐛 92 | 🌐 C++ | 📅 2026-08-26: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,433 | 🐛 285 | 🌐 C++ | 📅 2026-08-26: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,287 | 🐛 760 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,166 | 🐛 542 | 🌐 C++ | 📅 2026-08-26: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,906 | 🐛 50 | 🌐 C++ | 📅 2026-08-27 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,701 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,195 | 🐛 76 | 🌐 C++ | 📅 2026-08-23: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
...
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,415 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
...
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,851 | 🐛 33 | 🌐 C++ | 📅 2026-08-20: 用于在C++中编写DirectX 11.x代码的帮助类的集合。
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,622 | 🐛 8 | 🌐 C++ | 📅 2026-08-26: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,981 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,922 | 🐛 2 | 🌐 C++ | 📅 2026-08-26: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,515 | 🐛 417 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,431 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,784 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: 用于图像中人脸检测的开源库，其人脸检测的速度能达到1500FPS。
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,401 | 🐛 16 | 🌐 C | 📅 2026-08-26: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,350 | 🐛 185 | 🌐 C++ | 📅 2026-08-27: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,265 | 🐛 26 | 🌐 C++ | 📅 2026-08-26: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,074 | 🐛 69 | 🌐 C | 📅 2026-08-04: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,979 | 🐛 9 | 🌐 C++ | 📅 2026-08-26: C和C++的单个头文件的utf8字符串函数。
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,293 | 🐛 33 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,265 | 🐛 1,365 | 🌐 C++ | 📅 2026-08-27: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,169 | 🐛 328 | 🌐 C++ | 📅 2026-08-26: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,291 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,660 | 🐛 62 | 🌐 C | 📅 2026-08-27: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,191 | 🐛 155 | 🌐 C++ | 📅 2026-08-26: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,472 | 🐛 143 | 🌐 C++ | 📅 2026-08-25: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,198 | 🐛 132 | 🌐 C++ | 📅 2026-08-27: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,121 | 🐛 790 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,956 | 🐛 355 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,885 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,176 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,529 | 🐛 50 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,008 | 🐛 9 | 🌐 C++ | 📅 2026-08-26: 异步、跨平台、低时延的日志库。
* [plog](https://github.com/SergiusTheBest/plog) ⭐ 2,577 | 🐛 58 | 🌐 C++ | 📅 2026-08-07: C++可移植且简单的日志，少于1000行代码。
* [loguru](https://github.com/emilk/loguru) ⭐ 1,907 | 🐛 92 | 🌐 C++ | 📅 2026-07-31: 轻量级的C++日志库。
* [log4cplus](https://github.com/log4cplus/log4cplus) ⭐ 1,728 | 🐛 61 | 🌐 C++ | 📅 2026-07-11: 易于使用的C++日志API，可提供对日志管理和配置的线程安全、灵活且任意粒度的控制。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,613 | 🐛 2,758 | 🌐 C++ | 📅 2026-08-26: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,556 | 🐛 1,595 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,697 | 🐛 419 | 🌐 C++ | 📅 2026-08-26: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
* [darknet](https://github.com/pjreddie/darknet) ⭐ 26,493 | 🐛 1,976 | 🌐 C | 📅 2024-05-03: 用C和CUDA编写的开源神经网络框架。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,431 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++ 11的机器学习、计算机视觉、数值优化和深度学习的工具包。
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,243 | 🐛 80 | 🌐 C++ | 📅 2026-08-26: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
* [flashlight](https://github.com/facebookresearch/flashlight) ⭐ 5,466 | 🐛 126 | 🌐 C++ | 📅 2026-06-22: 来自Facebook AI研究中心的快速、灵活的机器学习库，其完全用C++编写，基于ArrayFire张量库。
* [libsvm](https://github.com/cjlin1/libsvm) ⭐ 4,708 | 🐛 112 | 🌐 Java | 📅 2025-12-29: 支持向量机的简单、易用、高效的库。
* [SHOGUN](https://github.com/shogun-toolbox/shogun) ⭐ 3,079 | 🐛 423 | 🌐 C++ | 📅 2023-12-19: Shogun 机器学习工具。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,431 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,182 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,563 | 🐛 116 | 🌐 C | 📅 2026-08-26: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,547 | 🐛 50 | 🌐 C++ | 📅 2026-08-26v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,025 | 🐛 670 | 🌐 C++ | 📅 2026-08-26: 高效，可靠的几何算法集合。
* [xtensor](https://github.com/QuantStack/xtensor) ⭐ 3,762 | 🐛 429 | 🌐 C++ | 📅 2026-07-15: 受NumPy语法启发的C++ 14库，用于使用多维数组表达式进行数值分析。
* [autodiff](https://github.com/autodiff/autodiff) ⭐ 1,952 | 🐛 109 | 🌐 C++ | 📅 2025-01-27: 用于自动微分的现代、快速且富有表现力的C++库。
* [TinyExpr](https://github.com/codeplea/tinyexpr) ⭐ 1,919 | 🐛 0 | 🌐 C | 📅 2026-08-06: 用于解析和评估字符串中的数学表达式的C库。
* [Vc](https://github.com/VcDevel/Vc) ⭐ 1,542 | 🐛 88 | 🌐 C++ | 📅 2026-07-07: C++的SIMD矢量类。
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,402 | 🐛 250 | 🌐 C++ | 📅 2026-08-26: 快速符号处理库，用C++重写了SymPy的核心。
* [linmath.h](https://github.com/datenwolf/linmath.h) ⭐ 1,059 | 🐛 20 | 🌐 C | 📅 2023-05-31: 精益线性数学库，主要用于图形编程。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 500 | 🐛 22 | 🌐 C++ | 📅 2026-08-27: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,332 | 🐛 312 | 🌐 C | 📅 2026-08-22: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,065 | 🐛 369 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,529 | 🐛 188 | 🌐 C | 📅 2026-08-23: C和C++的保守的垃圾回收器。
* [memory-allocators](https://github.com/mtrebi/memory-allocators) ⭐ 1,992 | 🐛 16 | 🌐 C++ | 📅 2026-08-20: 自定义内存分配器，可提高动态内存分配的性能。
...
* [Hoard](https://github.com/emeryberger/Hoard) ⭐ 1,249 | 🐛 1 | 🌐 C++ | 📅 2026-07-19: 快速、可扩展和节约内存的Malloc，支持Linux、Windows和Mac。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,447 | 🐛 41 | 🌐 C++ | 📅 2026-08-21: 用于读取和编辑几种流行音频格式的元数据的库。
* [libass](https://github.com/libass/libass) ⭐ 1,161 | 🐛 168 | 🌐 C | 📅 2026-08-22: ASS / SSA字幕格式的便携式字幕渲染器。
* [libass](https://github.com/libass/libass) ⭐ 1,161 | 🐛 168 | 🌐 C | 📅 2026-08-22: 处理多媒体内容（例如音频、视频、字幕和相关元数据）的库和工具的集合。
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 787 | 🐛 350 | 🌐 C++ | 📅 2026-08-26: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,966 | 🐛 48 | 🌐 C++ | 📅 2026-08-18: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,887 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,781 | 🐛 9 | 🌐 C++ | 📅 2026-08-27: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,227 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,009 | 🐛 2 | 🌐 C | 📅 2026-08-26<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,540 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-26: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
* [C++ REST SDK](https://github.com/Microsoft/cpprestsdk) ⚠️ Archived: C++ REST SDK（以前称为Casablanca）。
* [WebSocket++](https://github.com/zaphoyd/websocketpp) ⭐ 7,716 | 🐛 483 | 🌐 C++ | 📅 2026-05-04: 基于C++/Boost Aiso的websocket 客户端/服务器库。
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,417 | 🐛 87 | 🌐 C++ | 📅 2026-07-26: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,320 | 🐛 232 | 🌐 C | 📅 2026-08-26: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,046 | 🐛 46 | 🌐 C++ | 📅 2026-08-24: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,820 | 🐛 106 | 🌐 C++ | 📅 2026-08-25: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,395 | 🐛 24 | 🌐 C | 📅 2026-08-26: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,163 | 🐛 180 | 🌐 C | 📅 2026-08-21: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,131 | 🐛 57 | 🌐 C++ | 📅 2026-08-26: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,094 | 🐛 48 | 🌐 C++ | 📅 2026-08-26: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,965 | 🐛 42 | 🌐 C | 📅 2026-08-26: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,956 | 🐛 82 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,182 | 🐛 67 | 🌐 C | 📅 2026-08-24: 用于异步DNS请求的C库。
* [mTCP](https://github.com/mtcp-stack/mtcp) ⭐ 2,138 | 🐛 97 | 🌐 C | 📅 2024-07-04: 用于多核系统的高度可扩展的用户级TCP堆栈。
* [PicoHTTPParser](https://github.com/h2o/picohttpparser) ⭐ 2,103 | 🐛 22 | 🌐 C | 📅 2026-04-06: 微小、原始、快速的HTTP请求/响应解析器。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,039 | 🐛 589 | 🌐 C | 📅 2026-08-27: 用于C和C++的Apache Kafka客户端库。
* [libhttpserver](https://github.com/etr/libhttpserver) ⭐ 950 | 🐛 9 | 🌐 C++ | 📅 2026-07-23: 用于创建嵌入式Rest HTTP服务器（以及更多）的C++库。
...
* [uriparser](https://github.com/uriparser/uriparser) ⭐ 417 | 🐛 12 | 🌐 C | 📅 2026-08-10: 严格符合RFC 3986的URI解析和处理库。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,699 | 🐛 424 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,993 | 🐛 19 | 🌐 C++ | 📅 2026-08-24: 开源的多物理场仿真引擎。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,251 | 🐛 456 | 🌐 C++ | 📅 2026-08-27: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,175 | 🐛 16 | 🌐 C++ | 📅 2026-08-11: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
* [RTTR](https://github.com/rttrorg/rttr) ⭐ 3,484 | 🐛 150 | 🌐 C++ | 📅 2024-04-25: C++11的映射库。
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,357 | 🐛 0 | 🌐 C++ | 📅 2026-08-05: 只包含头文件的的C++ 17库，提供名称宏和函数以获取变量、类型、函数、宏和枚举的简单名称。
...
* [RE2](https://github.com/google/re2) ⭐ 9,785 | 🐛 62 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
...
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions) ⭐ 3,839 | 🐛 104 | 🌐 C++ | 📅 2026-07-11: 编译时PCRE（几乎）兼容的正则表达式匹配器。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,101 | 🐛 586 | 🌐 C++ | 📅 2026-08-18: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,073 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组的DBMS。
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,419 | 🐛 326 | 🌐 C++ | 📅 2026-08-27: 高性能的PDE解算器。
* [AMGCL](https://github.com/ddemidov/amgcl) ⭐ 875 | 🐛 60 | 🌐 C++ | 📅 2026-08-03: 只包含头文件的C++库，用于解决具有代数多重网格的大型稀疏线性系统。
* [FFTW](http://www.fftw.org/): 用一维或者多维计算DFT的C语言库。
* [GSL](http://www.gnu.org/software/gsl/): GNU科学库。

### 脚本

* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,008 | 🐛 714 | 🌐 C++ | 📅 2026-08-25: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,833 | 🐛 1,515 | 🌐 Cython | 📅 2026-08-27: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,132 | 🐛 308 | 🌐 C++ | 📅 2025-03-07: 具有高级功能和一流性能的C++ <-> Lua API封装器。
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,705 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,361 | 🐛 194 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,411 | 🐛 269 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,537 | 🐛 79 | 🌐 C | 📅 2026-08-26: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,703 | 🐛 344 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,495 | 🐛 39 | 🌐 Java | 📅 2026-08-22: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,344 | 🐛 103 | 📅 2026-08-25: C/C++的高效二进制序列化库，例如 JSON。
* [protobuf-c](https://github.com/protobuf-c/protobuf-c) ⭐ 2,988 | 🐛 48 | 🌐 C++ | 📅 2026-08-22: C语言的协议缓冲实现。
* [Bond](https://github.com/Microsoft/bond) ⚠️ Archived: 用于处理模式化数据的开源、跨平台框架。
* [mrpt-serialization](https://github.com/mrpt/mrpt/) ⭐ 2,157 | 🐛 29 | 🌐 C++ | 📅 2026-08-21: 已版本控制的二进制或文本格式的序列化。
* [upb](https://github.com/protocolbuffers/upb) ⚠️ Archived: C中的小型静态库实现。
* [Bitsery](https://github.com/fraillt/bitsery) ⭐ 1,261 | 🐛 12 | 🌐 C++ | 📅 2025-10-09: 只包含头文件的C++二进制序列化库。
...
* [pdqsort](https://github.com/orlp/pdqsort) ⭐ 2,504 | 🐛 5 | 🌐 C++ | 📅 2023-12-06: 破坏模式的快速排序。
* [Timsort](https://github.com/gfx/cpp-TimSort) ⭐ 317 | 🐛 2 | 🌐 C++ | 📅 2024-12-03: 模板化的稳定排序功能，其性能优于基于快速排序的算法（包括std: : sort），用于反向或半排序数据。

### 视频

* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,138 | 🐛 306 | 🌐 C++ | 📅 2026-08-27: 开源H.364 编解码器。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,010 | 🐛 1,534 | 🌐 C | 📅 2026-08-26: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,218 | 🐛 420 | 🌐 C++ | 📅 2026-08-27: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,443 | 🐛 237 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
* [facil.io](https://github.com/boazsegev/facil.io) ⭐ 2,400 | 🐛 37 | 🌐 C | 📅 2026-04-14: 事件型、高性能的C Web框架，支持HTTP、WebSocket、SSE等。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,515 | 🐛 417 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,077 | 🐛 0 | 🌐 Java | 📅 2026-08-24: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,765 | 🐛 17 | 🌐 C++ | 📅 2026-08-23: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,765 | 🐛 17 | 🌐 C++ | 📅 2026-08-23: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,546 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
...
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,153 | 🐛 5 | 🌐 C++ | 📅 2026-08-17: 解析表达语法模板库。
...
* [Kangaru](https://github.com/gracicot/kangaru) ⭐ 553 | 🐛 9 | 🌐 C++ | 📅 2026-08-27: 用于C++ 11和C++ 14的依赖注入容器。
* [libcpuid](https://github.com/anrieff/libcpuid) ⭐ 537 | 🐛 7 | 🌐 C | 📅 2026-08-26: 用于x86 CPU检测盒特征提取的小型C库。
* [Stage](https://github.com/rtv/Stage) ⭐ 423 | 🐛 29 | 🌐 C++ | 📅 2021-03-24: 移动机器人模拟器。
...
* [8cc](https://github.com/rui314/8cc) ⭐ 6,412 | 🐛 46 | 🌐 C | 📅 2024-05-02: 小型C编译器。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,401 | 🐛 1,199 | 🌐 CMake | 📅 2026-08-26: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,452 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,690 | 🐛 297 | 🌐 OCaml | 📅 2026-08-25: 用于Java、C和Objective-C的静态分析器。
* [IKOS](https://github.com/NASA-SW-VnV/ikos) ⭐ 3,160 | 🐛 50 | 🌐 C++ | 📅 2026-05-31: 基于抽象解释理论的C / C++静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,066 | 🐛 393 | 🌐 C++ | 📅 2026-08-23: 代码美化器。
