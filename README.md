...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,851 | 🐛 312 | 📅 2026-08-19 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,087 | 🐛 231 | 🌐 C++ | 📅 2026-08-20: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,503 | 🐛 461 | 🌐 C++ | 📅 2026-08-20: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,798 | 🐛 471 | 🌐 C++ | 📅 2026-08-20: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,102 | 🐛 66 | 🌐 C++ | 📅 2026-08-20: 嵌入式模板库。
- [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus) ⭐ 2,295 | 🐛 0 | 🌐 C++ | 📅 2026-07-15: C++ 的函数式编程库，编写简洁易读的C++代码。
- [BDE](https://github.com/bloomberg/bde) ⭐ 1,837 | 🐛 15 | 🌐 C++ | 📅 2026-08-20: 来自于彭博资讯实验室的开发环境。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,108 | 🐛 3,133 | 🌐 C++ | 📅 2026-08-21: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,504 | 🐛 17,216 | 🌐 Python | 📅 2026-08-21: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,462 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,863 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,167 | 🐛 986 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,537 | 🐛 41 | 🌐 C | 📅 2026-08-20: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,431 | 🐛 58 | 🌐 C++ | 📅 2026-08-20: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,163 | 🐛 3 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,151 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
- [libsoundio](https://github.com/andrewrk/libsoundio) ⭐ 2,099 | 🐛 137 | 🌐 C | 📅 2025-01-13: 用于跨平台实时音频输入输出的C库。
- [minimp3](https://github.com/lieff/minimp3) ⭐ 1,942 | 🐛 54 | 🌐 C | 📅 2026-07-27: 公共域，无尘室实现的MP3解码器，只有头文件。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,032 | 🐛 248 | 🌐 C++ | 📅 2026-08-20(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 999 | 🐛 56 | 🌐 C++ | 📅 2026-08-19 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,023 | 🐛 95 | 🌐 C++ | 📅 2026-08-19: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 952 | 🐛 0 | 🌐 C++ | 📅 2026-08-20: 传递消息的并行分子动力学实现。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,412 | 🐛 71 | 🌐 C++ | 📅 2026-08-14: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
* [linenoise](https://github.com/antirez/linenoise) ⭐ 4,339 | 🐛 155 | 🌐 C | 📅 2026-05-02: readline和libedit的独立小选择。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,842 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-18: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 851 | 🐛 42 | 🌐 C++ | 📅 2026-08-20: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,590 | 🐛 342 | 🌐 C | 📅 2026-08-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,595 | 🐛 604 | 🌐 C | 📅 2026-08-19: 多格式的存档和压缩库。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,452 | 🐛 76 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,118 | 🐛 33 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,016 | 🐛 410 | 🌐 C++ | 📅 2026-08-20: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 139 | 🌐 C++ | 📅 2026-08-21: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,647 | 🐛 552 | 🌐 C++ | 📅 2026-08-19: 用于并行运行和内存抽象的便携式编程模型。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 216 | 🌐 C++ | 📅 2026-08-20: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,126 | 🐛 28 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。
...
* [libconfuse](https://github.com/martinh/libconfuse) ⭐ 518 | 🐛 8 | 🌐 C | 📅 2026-08-16: C的小型配置文件解析库。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,851 | 🐛 312 | 📅 2026-08-19: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,905 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,889 | 🐛 1,723 | 🌐 C | 📅 2026-08-20: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,998 | 🐛 33 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,753 | 🐛 319 | 🌐 C | 📅 2026-08-21: TLS/SSL协议的实现。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,346 | 🐛 402 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 31,990 | 🐛 1,614 | 🌐 C++ | 📅 2026-08-20: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,676 | 🐛 73 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,773 | 🐛 93 | 🌐 C | 📅 2026-07-24: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
...
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,617 | 🐛 140 | 🌐 C++ | 📅 2026-08-15: C++的数据库抽象层。
...
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 4 | 🌐 C | 📅 2026-08-19: C的MongoDB客户端库。
...
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 385 | 🐛 64 | 🌐 C++ | 📅 2026-08-20: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,941 | 🐛 495 | 🌐 C++ | 📅 2026-08-19: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,941 | 🐛 495 | 🌐 C++ | 📅 2026-08-19: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,428 | 🐛 438 | 🌐 C++ | 📅 2026-08-20: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,428 | 🐛 438 | 🌐 C++ | 📅 2026-08-20: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,356 | 🐛 175 | 🌐 C++ | 📅 2026-08-18: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,848 | 🐛 140 | 🌐 C++ | 📅 2026-08-18: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,345 | 🐛 90 | 🌐 C | 📅 2026-07-21: C的简单单元测试。
...
* [utest.h](https://github.com/sheredom/utest.h) ⭐ 990 | 🐛 12 | 🌐 C++ | 📅 2026-08-19: C和C++的单个头文件测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 115,931 | 🐛 18,730 | 🌐 C++ | 📅 2026-08-20: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,408 | 🐛 20 | 🌐 C | 📅 2026-08-20: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
...
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,896 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
...
* [Spring](https://github.com/spring/spring) ⭐ 3,969 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,854 | 🐛 47 | 🌐 C | 📅 2026-08-20: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,543 | 🐛 294 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-08-20: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,758 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-19: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,334 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,895 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,198 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,362 | 🐛 60 | 🌐 C++ | 📅 2026-08-17: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,682 | 🐛 9 | 🌐 C++ | 📅 2026-08-20: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,415 | 🐛 285 | 🌐 C++ | 📅 2026-08-20: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,261 | 🐛 760 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,148 | 🐛 535 | 🌐 C++ | 📅 2026-08-20: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,891 | 🐛 50 | 🌐 C++ | 📅 2026-08-20 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,695 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,191 | 🐛 76 | 🌐 C++ | 📅 2026-08-18: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,072 | 🐛 157 | 🌐 C++ | 📅 2026-08-20: 简单的C++几何处理库。
* [urho3d](https://github.com/urho3d/Urho3D) ⚠️ Archived 跨平台的渲染和游戏引擎。
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,405 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
...
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,619 | 🐛 9 | 🌐 C++ | 📅 2026-08-17: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,973 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,919 | 🐛 2 | 🌐 C++ | 📅 2026-08-19: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,453 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,348 | 🐛 186 | 🌐 C++ | 📅 2026-08-20: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,265 | 🐛 27 | 🌐 C++ | 📅 2026-08-20: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,071 | 🐛 69 | 🌐 C | 📅 2026-08-04: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
* [GD](https://github.com/libgd/libgd) ⭐ 980 | 🐛 104 | 🌐 C | 📅 2026-08-20: GD图形库，有名的用于PHP中图形加载/操作和缩略图生成。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,975 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: C和C++的单个头文件的utf8字符串函数。
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,290 | 🐛 31 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,231 | 🐛 1,380 | 🌐 C++ | 📅 2026-08-20: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,163 | 🐛 326 | 🌐 C++ | 📅 2026-08-20: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,290 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,657 | 🐛 65 | 🌐 C | 📅 2026-08-02: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,190 | 🐛 160 | 🌐 C++ | 📅 2026-08-20: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,414 | 🐛 98 | 🌐 C++ | 📅 2026-08-20: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,164 | 🐛 134 | 🌐 C++ | 📅 2026-08-20: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,114 | 🐛 790 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,929 | 🐛 354 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,884 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,171 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,357 | 🐛 127 | 🌐 C | 📅 2026-07-09: 进行编解码和处理Json数据的C语言库。
* [json-c](https://github.com/json-c/json-c) ⭐ 3,286 | 🐛 20 | 🌐 C | 📅 2026-08-20: C中的JSON实现。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,506 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,004 | 🐛 8 | 🌐 C++ | 📅 2026-08-11: 异步、跨平台、低时延的日志库。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,525 | 🐛 2,752 | 🌐 C++ | 📅 2026-08-20: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,560 | 🐛 1,567 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,679 | 🐛 426 | 🌐 C++ | 📅 2026-08-20: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
* [darknet](https://github.com/pjreddie/darknet) ⭐ 26,493 | 🐛 1,975 | 🌐 C | 📅 2024-05-03: 用C和CUDA编写的开源神经网络框架。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,432 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++ 11的机器学习、计算机视觉、数值优化和深度学习的工具包。
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,241 | 🐛 80 | 🌐 C++ | 📅 2026-08-20: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,432 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,165 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,559 | 🐛 114 | 🌐 C | 📅 2026-08-20: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,528 | 🐛 46 | 🌐 C++ | 📅 2026-08-20v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,014 | 🐛 676 | 🌐 C++ | 📅 2026-08-19: 高效，可靠的几何算法集合。
...
* [TinyExpr](https://github.com/codeplea/tinyexpr) ⭐ 1,916 | 🐛 0 | 🌐 C | 📅 2026-08-06: 用于解析和评估字符串中的数学表达式的C库。
* [Vc](https://github.com/VcDevel/Vc) ⭐ 1,542 | 🐛 88 | 🌐 C++ | 📅 2026-07-07: C++的SIMD矢量类。
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,401 | 🐛 257 | 🌐 C++ | 📅 2026-08-20: 快速符号处理库，用C++重写了SymPy的核心。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,314 | 🐛 318 | 🌐 C | 📅 2026-08-20: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,051 | 🐛 364 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,445 | 🐛 41 | 🌐 C++ | 📅 2026-08-19: 用于读取和编辑几种流行音频格式的元数据的库。
* [libass](https://github.com/libass/libass) ⭐ 1,161 | 🐛 166 | 🌐 C | 📅 2026-08-10: ASS / SSA字幕格式的便携式字幕渲染器。
* [libass](https://github.com/libass/libass) ⭐ 1,161 | 🐛 166 | 🌐 C | 📅 2026-08-10: 处理多媒体内容（例如音频、视频、字幕和相关元数据）的库和工具的集合。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,959 | 🐛 48 | 🌐 C++ | 📅 2026-08-18: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,875 | 🐛 195 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,757 | 🐛 3 | 🌐 C++ | 📅 2026-08-20: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
...
* [H2O](https://github.com/h2o/h2o) ⭐ 11,534 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,374 | 🐛 39 | 🌐 C++ | 📅 2026-08-20: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,409 | 🐛 87 | 🌐 C++ | 📅 2026-07-26: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,317 | 🐛 232 | 🌐 C | 📅 2026-08-20: 提供客户端和服务器库的轻量级纯C WebSocket实现。
...
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,385 | 🐛 24 | 🌐 C | 📅 2026-08-20: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [ENet](https://github.com/lsalzman/enet) ⭐ 3,257 | 🐛 98 | 🌐 C | 📅 2026-06-23: 可靠的UDP网络库。
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,159 | 🐛 177 | 🌐 C | 📅 2026-08-20: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,131 | 🐛 60 | 🌐 C++ | 📅 2026-08-20: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-20: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,035 | 🐛 593 | 🌐 C | 📅 2026-08-20: 用于C和C++的Apache Kafka客户端库。
...
* [tlse](https://github.com/eduardsui/tlse) ⭐ 684 | 🐛 33 | 🌐 C | 📅 2026-08-07: 单个C文件的TLS 1.2 / 1.3实现，使用tomcrypt作为加密库。
...
* [Simbody](https://github.com/simbody/simbody) ⭐ 2,544 | 🐛 160 | 🌐 C++ | 📅 2026-08-20: 高性能C++多体动力学/物理库，模拟关节生物力学和机械系统，像车辆，机器人和人体骨骼。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,247 | 🐛 448 | 🌐 C++ | 📅 2026-08-18: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [RE2](https://github.com/google/re2) ⭐ 9,783 | 🐛 62 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,466 | 🐛 200 | 🌐 C++ | 📅 2026-08-17: Hyperscan是Intel的高性能、多种正则表达式匹配库，提供大量正则表达式（多达数万个）的同时匹配，通常在DPI库堆栈中使用。
...
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,418 | 🐛 326 | 🌐 C++ | 📅 2026-08-20: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 17,998 | 🐛 712 | 🌐 C++ | 📅 2026-08-19: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,830 | 🐛 1,499 | 🌐 Cython | 📅 2026-08-20: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [libffi](https://github.com/libffi/libffi) ⭐ 4,355 | 🐛 194 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
* [CppSharp](https://github.com/mono/CppSharp) ⭐ 3,402 | 🐛 346 | 🌐 C# | 📅 2026-05-18: 用于将C / C++ API融合到高级语言中的工具和库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,362 | 🐛 266 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,529 | 🐛 79 | 🌐 C | 📅 2026-07-24: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,701 | 🐛 343 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,491 | 🐛 43 | 🌐 Java | 📅 2026-08-20: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
...
* [mrpt-serialization](https://github.com/mrpt/mrpt/) ⭐ 2,155 | 🐛 30 | 🌐 C++ | 📅 2026-08-20: 已版本控制的二进制或文本格式的序列化。
...
* [libde265](https://github.com/strukturag/libde265) ⭐ 1,905 | 🐛 33 | 🌐 C++ | 📅 2026-07-24: 开放的h.265视频编解码器的实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,001 | 🐛 1,537 | 🌐 C | 📅 2026-08-18: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,197 | 🐛 426 | 🌐 C++ | 📅 2026-08-20: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,435 | 🐛 237 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
* [facil.io](https://github.com/boazsegev/facil.io) ⭐ 2,398 | 🐛 37 | 🌐 C | 📅 2026-04-14: 事件型、高性能的C Web框架，支持HTTP、WebSocket、SSE等。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,453 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,071 | 🐛 1 | 🌐 Java | 📅 2026-08-17: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,752 | 🐛 12 | 🌐 C++ | 📅 2026-08-16: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,752 | 🐛 12 | 🌐 C++ | 📅 2026-08-16: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,543 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
* [Klib](https://github.com/attractivechaos/klib) ⭐ 4,717 | 🐛 94 | 🌐 C | 📅 2025-12-22: 通用算法和数据结构的小型、轻量级实现。
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,431 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: C++语言编写的跨平台，串口库。
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,431 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: 跨平台，用C++编写的串行端口库。
...
* [8cc](https://github.com/rui314/8cc) ⭐ 6,410 | 🐛 46 | 🌐 C | 📅 2024-05-02: 小型C编译器。
...
* [rtags](https://github.com/Andersbakken/rtags) ⭐ 1,846 | 🐛 176 | 🌐 C++ | 📅 2026-08-11: C/C++的客户端服务器索引，用于 跟基于clang的emacs的集成。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,379 | 🐛 1,137 | 🌐 CMake | 📅 2026-08-20: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,440 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,683 | 🐛 297 | 🌐 OCaml | 📅 2026-08-19: 用于Java、C和Objective-C的静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,064 | 🐛 386 | 🌐 C++ | 📅 2026-08-09: 代码美化器。
