...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,086 | 🐛 312 | 📅 2026-09-01 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,116 | 🐛 237 | 🌐 C++ | 📅 2026-09-02: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,528 | 🐛 465 | 🌐 C++ | 📅 2026-09-02: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,854 | 🐛 477 | 🌐 C++ | 📅 2026-09-02: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,115 | 🐛 63 | 🌐 C++ | 📅 2026-09-02: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,363 | 🐛 3,021 | 🌐 C++ | 📅 2026-09-03: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,725 | 🐛 17,536 | 🌐 Python | 📅 2026-09-03: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,474 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,890 | 🐛 144 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,187 | 🐛 989 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,543 | 🐛 40 | 🌐 C | 📅 2026-09-01: 跨平台的事件循环库。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,219 | 🐛 6 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,170 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
...
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 917 | 🐛 177 | 🌐 C++ | 📅 2026-09-01: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,049 | 🐛 251 | 🌐 C++ | 📅 2026-09-03(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 1,000 | 🐛 48 | 🌐 C++ | 📅 2026-09-02 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,041 | 🐛 77 | 🌐 C++ | 📅 2026-09-03: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 957 | 🐛 0 | 🌐 C++ | 📅 2026-09-02: 传递消息的并行分子动力学实现。
...
* [jarro2783/cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,806 | 🐛 70 | 🌐 C++ | 📅 2026-07-13: 轻量级的C++命令行选项解析器。
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,435 | 🐛 78 | 🌐 C++ | 📅 2026-09-01: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,863 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-03: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 854 | 🐛 42 | 🌐 C++ | 📅 2026-08-30: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,678 | 🐛 357 | 🌐 C | 📅 2026-09-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,605 | 🐛 601 | 🌐 C | 📅 2026-09-02: 多格式的存档和压缩库。
...
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,490 | 🐛 15 | 🌐 C | 📅 2026-09-02: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,474 | 🐛 77 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,138 | 🐛 34 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,041 | 🐛 419 | 🌐 C++ | 📅 2026-09-02: 用于集体多GPU通信的优化基元。
- [readerwriterqueue](https://github.com/cameron314/readerwriterqueue) ⭐ 4,618 | 🐛 23 | 🌐 C++ | 📅 2026-08-23: C++的快速单生产者、单消费者的无锁队列。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,890 | 🐛 138 | 🌐 C++ | 📅 2026-09-01: 适用于任何规模的并行分布式应用的通用C++运行时系统。
- [libcds](https://github.com/khizmax/libcds) ⭐ 2,744 | 🐛 55 | 🌐 C++ | 📅 2023-10-17: 并行数据结构的C++库。
- [ck](https://github.com/concurrencykit/ck) ⭐ 2,694 | 🐛 8 | 🌐 C | 📅 2026-09-02: 并发基元，安全内存回收机制和非阻塞数据结构。
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,660 | 🐛 546 | 🌐 C++ | 📅 2026-09-02: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,601 | 🐛 115 | 🌐 C | 📅 2026-09-02: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 215 | 🌐 C++ | 📅 2026-09-02: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [inih](https://github.com/benhoyt/inih) ⭐ 3,039 | 🐛 6 | 🌐 C++ | 📅 2026-01-30: C语言的简单.INI文件解析器，很适合嵌入式系统。

* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,138 | 🐛 28 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。
...
* [inih](https://github.com/jtilly/inih) ⭐ 451 | 🐛 0 | 🌐 C++ | 📅 2024-09-18: [inih](https://github.com/benhoyt/inih) ⭐ 3,039 | 🐛 6 | 🌐 C++ | 📅 2026-01-30的C++版本，只有头文件。

### 容器

* [robin-hood-hashing](https://github.com/martinus/robin-hood-hashing) ⚠️ Archived: 用于C++1的快速、节约内存的哈希表，基于robin hood哈希算法。
* [robin-map](https://github.com/Tessil/robin-map) ⭐ 1,503 | 🐛 18 | 🌐 C++ | 📅 2026-06-13: 使用robin hood哈希算法的哈希映射和哈希集。
...
* [Colony](https://github.com/mattreecebentley/plf_colony) ⭐ 505 | 🐛 0 | 🌐 C++ | 📅 2026-08-26: 无序的”bag“型容器，在高度修改的情况下，其性能优于标准容器。同时，无论插入还是擦除，其都能始终保持指向未擦除元素的永久指针。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 73,086 | 🐛 312 | 📅 2026-09-01: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,930 | 🐛 1 | 🌐 C | 📅 2026-08-31: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,933 | 🐛 1,726 | 🌐 C | 📅 2026-09-02: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 5,006 | 🐛 35 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,761 | 🐛 318 | 🌐 C | 📅 2026-09-03: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,974 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,789 | 🐛 50 | 🌐 C | 📅 2026-09-01: 相当全面、模块化和可移植的加密工具包。
...
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,037 | 🐛 1,629 | 🌐 C++ | 📅 2026-09-02: 来自Facebook的嵌入键值的快速存储。
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,694 | 🐛 15 | 🌐 C++ | 📅 2026-09-02: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,619 | 🐛 138 | 🌐 C++ | 📅 2026-09-03: C++的数据库抽象层。
* [MongoDB C++ Driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,106 | 🐛 1 | 🌐 C++ | 📅 2026-09-01: MongDB的C++驱动程序。
* [sqlite\_modern\_cpp](https://github.com/SqliteModernCpp/sqlite_modern_cpp) ⭐ 949 | 🐛 43 | 🌐 C++ | 📅 2024-07-23: sqlite库的C++14封装器，只有头文件。
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 6 | 🌐 C | 📅 2026-09-02: C的MongoDB客户端库。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 39,471 | 🐛 497 | 🌐 C++ | 📅 2026-09-02: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 39,471 | 🐛 497 | 🌐 C++ | 📅 2026-09-02: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,462 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,462 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,382 | 🐛 174 | 🌐 C++ | 📅 2026-08-28: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,857 | 🐛 140 | 🌐 C++ | 📅 2026-08-29: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,364 | 🐛 85 | 🌐 C | 📅 2026-08-25: C的简单单元测试。
...
* [fff](https://github.com/meekrosoft/fff) ⭐ 934 | 🐛 59 | 🌐 C | 📅 2023-11-02: 创建伪C函数的微框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,546 | 🐛 18,823 | 🌐 C++ | 📅 2026-09-02: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,561 | 🐛 16 | 🌐 C | 📅 2026-09-02: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,076 | 🐛 11 | 🌐 C++ | 📅 2026-09-02: 游戏与现代C++的碰撞。
...
* [Spring](https://github.com/spring/spring) ⭐ 3,980 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,854 | 🐛 47 | 🌐 C | 📅 2026-09-03: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,552 | 🐛 295 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 76,020 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-02: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,367 | 🐛 319 | 🌐 C | 📅 2026-09-02: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,895 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,213 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,404 | 🐛 56 | 🌐 C++ | 📅 2026-08-29: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,684 | 🐛 8 | 🌐 C++ | 📅 2026-09-02: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,451 | 🐛 288 | 🌐 C++ | 📅 2026-09-03: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,305 | 🐛 765 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,174 | 🐛 538 | 🌐 C++ | 📅 2026-09-02: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,914 | 🐛 50 | 🌐 C++ | 📅 2026-09-03 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,703 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,202 | 🐛 76 | 🌐 C++ | 📅 2026-08-23: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
...
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,424 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-01: 现代、跨平台、低阶的3D图形库。
...
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,852 | 🐛 33 | 🌐 C++ | 📅 2026-09-01: 用于在C++中编写DirectX 11.x代码的帮助类的集合。
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,629 | 🐛 8 | 🌐 C++ | 📅 2026-09-02: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,983 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,574 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,413 | 🐛 16 | 🌐 C | 📅 2026-08-27: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,353 | 🐛 184 | 🌐 C++ | 📅 2026-09-02: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,266 | 🐛 25 | 🌐 C++ | 📅 2026-09-02: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,078 | 🐛 68 | 🌐 C | 📅 2026-09-02: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
* [GD](https://github.com/libgd/libgd) ⭐ 985 | 🐛 106 | 🌐 C | 📅 2026-08-25: GD图形库，有名的用于PHP中图形加载/操作和缩略图生成。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,285 | 🐛 1,346 | 🌐 C++ | 📅 2026-09-02: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,170 | 🐛 324 | 🌐 C++ | 📅 2026-09-02: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,293 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,660 | 🐛 57 | 🌐 C | 📅 2026-09-02: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,192 | 🐛 152 | 🌐 C++ | 📅 2026-09-02: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,511 | 🐛 144 | 🌐 C++ | 📅 2026-09-02: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,231 | 🐛 132 | 🌐 C++ | 📅 2026-09-01: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,120 | 🐛 791 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,970 | 🐛 357 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,887 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,182 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
...
* [json-parser](https://github.com/udp/json-parser) ⭐ 1,337 | 🐛 41 | 🌐 C | 📅 2026-09-02: 用可移植的ANSI C编写的JSON解析器，占用内存非常少。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,564 | 🐛 50 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [plog](https://github.com/SergiusTheBest/plog) ⭐ 2,580 | 🐛 58 | 🌐 C++ | 📅 2026-08-07: C++可移植且简单的日志，少于1000行代码。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,696 | 🐛 2,766 | 🌐 C++ | 📅 2026-09-02: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,554 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,724 | 🐛 429 | 🌐 C++ | 📅 2026-09-02: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,241 | 🐛 80 | 🌐 C++ | 📅 2026-09-02: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,436 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,195 | 🐛 126 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,574 | 🐛 54 | 🌐 C++ | 📅 2026-09-01v: 用于计量金融的免费/开源库。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,568 | 🐛 115 | 🌐 C | 📅 2026-09-02: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,031 | 🐛 681 | 🌐 C++ | 📅 2026-09-02: 高效，可靠的几何算法集合。
* [xtensor](https://github.com/QuantStack/xtensor) ⭐ 3,762 | 🐛 425 | 🌐 C++ | 📅 2026-08-27: 受NumPy语法启发的C++ 14库，用于使用多维数组表达式进行数值分析。
* [autodiff](https://github.com/autodiff/autodiff) ⭐ 1,954 | 🐛 109 | 🌐 C++ | 📅 2025-01-27: 用于自动微分的现代、快速且富有表现力的C++库。
...
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,406 | 🐛 252 | 🌐 C++ | 📅 2026-09-01: 快速符号处理库，用C++重写了SymPy的核心。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 500 | 🐛 24 | 🌐 C++ | 📅 2026-08-31: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,345 | 🐛 307 | 🌐 C | 📅 2026-09-03: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,090 | 🐛 365 | 🌐 C | 📅 2026-09-02: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,535 | 🐛 188 | 🌐 C | 📅 2026-09-02: C和C++的保守的垃圾回收器。
* [memory-allocators](https://github.com/mtrebi/memory-allocators) ⭐ 1,991 | 🐛 16 | 🌐 C++ | 📅 2026-08-20: 自定义内存分配器，可提高动态内存分配的性能。
* [C Smart Pointers](https://github.com/Snaipe/libcsptr) ⭐ 1,729 | 🐛 13 | 🌐 CMake | 📅 2022-11-02: （GNU）C编程语言的智能指针。
* [memory](https://github.com/foonathan/memory) ⭐ 1,618 | 🐛 10 | 🌐 C++ | 📅 2025-05-29: 兼容STL的C++内存分配器库。
...
* [libass](https://github.com/libass/libass) ⭐ 1,165 | 🐛 168 | 🌐 C | 📅 2026-08-22: ASS / SSA字幕格式的便携式字幕渲染器。
* [libass](https://github.com/libass/libass) ⭐ 1,165 | 🐛 168 | 🌐 C | 📅 2026-08-22: 处理多媒体内容（例如音频、视频、字幕和相关元数据）的库和工具的集合。
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 791 | 🐛 349 | 🌐 C++ | 📅 2026-08-28: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,980 | 🐛 50 | 🌐 C++ | 📅 2026-08-29: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,893 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,810 | 🐛 4 | 🌐 C++ | 📅 2026-09-01: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,230 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,024 | 🐛 0 | 🌐 C | 📅 2026-09-02<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,542 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,374 | 🐛 39 | 🌐 C++ | 📅 2026-09-02: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,424 | 🐛 86 | 🌐 C++ | 📅 2026-08-28: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,322 | 🐛 230 | 🌐 C | 📅 2026-09-02: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,046 | 🐛 46 | 🌐 C++ | 📅 2026-08-24: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,822 | 🐛 105 | 🌐 C++ | 📅 2026-09-01: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,405 | 🐛 24 | 🌐 C | 📅 2026-08-31: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,133 | 🐛 59 | 🌐 C++ | 📅 2026-09-02: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,093 | 🐛 48 | 🌐 C++ | 📅 2026-09-02: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,965 | 🐛 43 | 🌐 C | 📅 2026-08-31: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,956 | 🐛 82 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,187 | 🐛 71 | 🌐 C | 📅 2026-09-01: 用于异步DNS请求的C库。
* [mTCP](https://github.com/mtcp-stack/mtcp) ⭐ 2,138 | 🐛 97 | 🌐 C | 📅 2024-07-04: 用于多核系统的高度可扩展的用户级TCP堆栈。
* [PicoHTTPParser](https://github.com/h2o/picohttpparser) ⭐ 2,105 | 🐛 22 | 🌐 C | 📅 2026-04-06: 微小、原始、快速的HTTP请求/响应解析器。
...
* [Restinio](https://github.com/Stiffstream/restinio) ⭐ 1,302 | 🐛 43 | 🌐 C++ | 📅 2026-09-02: 只有头文件的C++ 14库，为您提供嵌入式HTTP / Websocket服务器。
...
* [tlse](https://github.com/eduardsui/tlse) ⭐ 685 | 🐛 35 | 🌐 C | 📅 2026-08-07: 单个C文件的TLS 1.2 / 1.3实现，使用tomcrypt作为加密库。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,711 | 🐛 424 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 3,008 | 🐛 18 | 🌐 C++ | 📅 2026-09-02: 开源的多物理场仿真引擎。
* [Simbody](https://github.com/simbody/simbody) ⭐ 2,548 | 🐛 160 | 🌐 C++ | 📅 2026-09-02: 高性能C++多体动力学/物理库，模拟关节生物力学和机械系统，像车辆，机器人和人体骨骼。
* [PhysX](https://github.com/NVIDIAGameWorks/PhysX-3.4) ⭐ 2,414 | 🐛 59 | 🌐 C++ | 📅 2022-11-15: Nvidia开发的开源的实时物理引擎中间件SDK，作为Nvidia GameWorks软件套件的一部分。
* [Chipmunk](https://github.com/slembcke/Chipmunk2D) ⭐ 2,403 | 🐛 69 | 🌐 C | 📅 2026-05-05: 快速、轻量级的2D游戏物理库。
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,252 | 🐛 473 | 🌐 C++ | 📅 2026-09-01: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,181 | 🐛 16 | 🌐 C++ | 📅 2026-09-02: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
...
* [RE2](https://github.com/google/re2) ⭐ 9,791 | 🐛 63 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,107 | 🐛 579 | 🌐 C++ | 📅 2026-08-29: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,420 | 🐛 331 | 🌐 C++ | 📅 2026-09-03: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,010 | 🐛 722 | 🌐 C++ | 📅 2026-09-01: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,842 | 🐛 1,519 | 🌐 Cython | 📅 2026-09-01: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
* [ChakraCore](https://github.com/Microsoft/ChakraCore) ⭐ 9,257 | 🐛 615 | 🌐 JavaScript | 📅 2026-02-19: Microsoft的JavaScript引擎，可以嵌入到nodejs中。
* [Duktape](https://github.com/svaarala/duktape) ⭐ 6,209 | 🐛 474 | 🌐 JavaScript | 📅 2024-03-22: 具有紧凑脚本的嵌入式Javascript引擎。
...
* [libffi](https://github.com/libffi/libffi) ⭐ 4,362 | 🐛 197 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,426 | 🐛 278 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,545 | 🐛 79 | 🌐 C | 📅 2026-09-01: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,706 | 🐛 344 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,501 | 🐛 39 | 🌐 Java | 📅 2026-08-31: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,346 | 🐛 103 | 📅 2026-08-25: C/C++的高效二进制序列化库，例如 JSON。
* [protobuf-c](https://github.com/protobuf-c/protobuf-c) ⭐ 2,991 | 🐛 48 | 🌐 C++ | 📅 2026-08-22: C语言的协议缓冲实现。
* [Bond](https://github.com/Microsoft/bond) ⚠️ Archived: 用于处理模式化数据的开源、跨平台框架。
* [mrpt-serialization](https://github.com/mrpt/mrpt/) ⭐ 2,159 | 🐛 28 | 🌐 C++ | 📅 2026-08-31: 已版本控制的二进制或文本格式的序列化。
* [upb](https://github.com/protocolbuffers/upb) ⚠️ Archived: C中的小型静态库实现。
* [Bitsery](https://github.com/fraillt/bitsery) ⭐ 1,262 | 🐛 12 | 🌐 C++ | 📅 2025-10-09: 只包含头文件的C++二进制序列化库。
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,142 | 🐛 305 | 🌐 C++ | 📅 2026-09-01: 开源H.364 编解码器。
* [libde265](https://github.com/strukturag/libde265) ⭐ 1,911 | 🐛 25 | 🌐 C++ | 📅 2026-09-02: 开放的h.265视频编解码器的实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,038 | 🐛 1,533 | 🌐 C | 📅 2026-09-02: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,234 | 🐛 426 | 🌐 C++ | 📅 2026-08-27: 基于C++ 14/17的高性能HTTP应用程序框架。
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,650 | 🐛 348 | 🌐 C++ | 📅 2025-11-12: 轻量、零依赖的框架，可创建高性能的Web服务。
...
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,033 | 🐛 49 | 🌐 C | 📅 2026-08-27: 实验性、可扩展的高性能HTTP服务器。
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,444 | 🐛 242 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
* [facil.io](https://github.com/boazsegev/facil.io) ⭐ 2,401 | 🐛 36 | 🌐 C | 📅 2026-04-14: 事件型、高性能的C Web框架，支持HTTP、WebSocket、SSE等。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,795 | 🐛 122 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,574 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,077 | 🐛 0 | 🌐 Java | 📅 2026-09-01: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 24,277 | 🐛 9 | 🌐 C++ | 📅 2026-09-02: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 24,277 | 🐛 9 | 🌐 C++ | 📅 2026-09-02: C++的小型，安全和快速格式化库。
...
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,434 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: C++语言编写的跨平台，串口库。
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,434 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: 跨平台，用C++编写的串行端口库。
...
* [c](https://github.com/ryanmjacobs/c) ⭐ 2,184 | 🐛 11 | 🌐 Shell | 📅 2025-12-05: 一次编译并执行C“脚本”！
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,427 | 🐛 1,196 | 🌐 CMake | 📅 2026-09-02: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,464 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,700 | 🐛 205 | 🌐 OCaml | 📅 2026-09-02: 用于Java、C和Objective-C的静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,068 | 🐛 394 | 🌐 C++ | 📅 2026-08-28: 代码美化器。
