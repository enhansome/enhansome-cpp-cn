...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,767 | 🐛 312 | 📅 2026-08-04 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
- [Folly](https://github.com/facebook/folly) ⭐ 30,491 | 🐛 459 | 🌐 C++ | 📅 2026-08-14: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,783 | 🐛 472 | 🌐 C++ | 📅 2026-08-13: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,093 | 🐛 67 | 🌐 C++ | 📅 2026-08-14: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,024 | 🐛 2,851 | 🌐 C++ | 📅 2026-08-15: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,377 | 🐛 17,307 | 🌐 Python | 📅 2026-08-15: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,457 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,163 | 🐛 985 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,133 | 🐛 5 | 🌐 C | 📅 2026-08-03: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,148 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
...
- [libsndfile](https://github.com/erikd/libsndfile/) ⭐ 1,710 | 🐛 217 | 🌐 C | 📅 2026-08-01: C++封装的C库，用于通过标准库接口读写包含采样声音的文件。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,020 | 🐛 245 | 🌐 C++ | 📅 2026-08-14(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 998 | 🐛 56 | 🌐 C++ | 📅 2026-08-14 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,017 | 🐛 89 | 🌐 C++ | 📅 2026-08-14: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
...
* [d-SEAMS](https://github.com/d-SEAMS/seams-core) ⭐ 42 | 🐛 18 | 🌐 C++ | 📅 2026-08-15: 具有Nix的C++和Lua实现的分子动力学轨道分析引擎，它是分子模拟的递延结构分析的首字母缩写。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,411 | 🐛 73 | 🌐 C++ | 📅 2026-08-14: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [Taywee / args](https://github.com/taywee/args) ⭐ 1,630 | 🐛 15 | 🌐 C++ | 📅 2026-08-03: 简单的只有头文件的C++参数解析库。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,842 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-14: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 849 | 🐛 41 | 🌐 C++ | 📅 2026-08-09: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,551 | 🐛 338 | 🌐 C | 📅 2026-08-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,594 | 🐛 595 | 🌐 C | 📅 2026-08-14: 多格式的存档和压缩库。
...
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,480 | 🐛 15 | 🌐 C | 📅 2026-08-07: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
...
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,108 | 🐛 33 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 4,996 | 🐛 394 | 🌐 C++ | 📅 2026-08-14: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 142 | 🌐 C++ | 📅 2026-08-14: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,642 | 🐛 607 | 🌐 C++ | 📅 2026-08-14: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,597 | 🐛 116 | 🌐 C | 📅 2026-08-14: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
- [FiberTaskingLib](https://github.com/RichieSams/FiberTaskingLib) ⭐ 983 | 🐛 16 | 🌐 C++ | 📅 2025-03-21: 基于任务的多线程库，支持具有任意依赖关系的任务图表。
- [cuda-api-wrappers](https://github.com/eyalroz/cuda-api-wrappers) ⭐ 902 | 🐛 117 | 🌐 C++ | 📅 2026-07-16: 轻量级的现代C++封装器，用于CUDA GPU的运行时API编程。
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 213 | 🌐 C++ | 📅 2026-08-14: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
- [SObjectizer](https://github.com/Stiffstream/sobjectizer) ⭐ 620 | 🐛 13 | 🌐 C++ | 📅 2026-08-04: 实现Actor、Publish-Subscribe和CSP模式的相当小的C++框架。
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,122 | 🐛 26 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。
...
* [robin-map](https://github.com/Tessil/robin-map) ⭐ 1,500 | 🐛 17 | 🌐 C++ | 📅 2026-06-13: 使用robin hood哈希算法的哈希映射和哈希集。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,767 | 🐛 312 | 📅 2026-08-04: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,887 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,869 | 🐛 1,729 | 🌐 C | 📅 2026-08-14: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,995 | 🐛 34 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,750 | 🐛 305 | 🌐 C | 📅 2026-08-14: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,971 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,785 | 🐛 49 | 🌐 C | 📅 2026-08-08: 相当全面、模块化和可移植的加密工具包。
...
* [Vince's CSV Parser](https://github.com/vincentlaucsb/csv-parser) ⭐ 1,118 | 🐛 3 | 🌐 C++ | 📅 2026-08-06: 快速、独立、流式的C++17 CSV解析器，具有可选的类型转换和统计信息。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,322 | 🐛 400 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 31,973 | 🐛 1,614 | 🌐 C++ | 📅 2026-08-14: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,678 | 🐛 75 | 🌐 C | 📅 2026-08-14: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,767 | 🐛 93 | 🌐 C | 📅 2026-07-24: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,689 | 🐛 19 | 🌐 C++ | 📅 2026-08-14: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 3 | 🌐 C | 📅 2026-08-13: C的MongoDB客户端库。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,927 | 🐛 490 | 🌐 C++ | 📅 2026-08-13: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,927 | 🐛 490 | 🌐 C++ | 📅 2026-08-13: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,426 | 🐛 443 | 🌐 C++ | 📅 2026-08-10: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,426 | 🐛 443 | 🌐 C++ | 📅 2026-08-10: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,351 | 🐛 175 | 🌐 C++ | 📅 2026-08-12: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,844 | 🐛 139 | 🌐 C++ | 📅 2026-07-12: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,345 | 🐛 88 | 🌐 C | 📅 2026-07-21: C的简单单元测试。
...
* [utest.h](https://github.com/sheredom/utest.h) ⭐ 988 | 🐛 14 | 🌐 C++ | 📅 2026-07-21: C和C++的单个头文件测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 115,667 | 🐛 18,653 | 🌐 C++ | 📅 2026-08-14: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,322 | 🐛 32 | 🌐 C | 📅 2026-08-13: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,014 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,205 | 🐛 366 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
...
* [Spring](https://github.com/spring/spring) ⭐ 3,963 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,853 | 🐛 47 | 🌐 C | 📅 2026-08-13: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,539 | 🐛 292 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,650 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-07: 拥有最小依赖关系的即时模式图形用户界面。
...
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,347 | 🐛 62 | 🌐 C++ | 📅 2026-08-07: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,680 | 🐛 9 | 🌐 C++ | 📅 2026-08-09: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,808 | 🐛 93 | 🌐 C++ | 📅 2026-07-29: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,397 | 🐛 288 | 🌐 C | 📅 2026-08-15: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,253 | 🐛 759 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,133 | 🐛 526 | 🌐 C++ | 📅 2026-08-13: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,876 | 🐛 51 | 🌐 C++ | 📅 2026-08-14 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,688 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
...
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,391 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-12: 现代、跨平台、低阶的3D图形库。
...
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,969 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,921 | 🐛 2 | 🌐 C++ | 📅 2026-08-14: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,402 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,385 | 🐛 16 | 🌐 C | 📅 2026-08-05: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,345 | 🐛 182 | 🌐 C++ | 📅 2026-08-14: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,263 | 🐛 27 | 🌐 C++ | 📅 2026-08-14: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,069 | 🐛 69 | 🌐 C | 📅 2026-08-04: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,973 | 🐛 10 | 🌐 C++ | 📅 2026-08-09: C和C++的单个头文件的utf8字符串函数。
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,288 | 🐛 30 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,285 | 🐛 1,379 | 🌐 C++ | 📅 2026-08-14: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,158 | 🐛 330 | 🌐 C++ | 📅 2026-08-14: 快速的数据交换格式和基于功能的RPC系统。
...
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,188 | 🐛 167 | 🌐 C++ | 📅 2026-08-14: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,373 | 🐛 100 | 🌐 C++ | 📅 2026-08-13: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,148 | 🐛 135 | 🌐 C++ | 📅 2026-08-14: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,112 | 🐛 789 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,919 | 🐛 353 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
...
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,354 | 🐛 127 | 🌐 C | 📅 2026-07-09: 进行编解码和处理Json数据的C语言库。
...
* [jsoncons](https://github.com/danielaparker/jsoncons) ⭐ 851 | 🐛 17 | 🌐 C++ | 📅 2026-08-14: 使用JSONPointer、JSONPatch、JSONPath和JMESPath的JSON和类似JSON二进制格式的C++库，只有头文件。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,480 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [plog](https://github.com/SergiusTheBest/plog) ⭐ 2,574 | 🐛 58 | 🌐 C++ | 📅 2026-08-07: C++可移植且简单的日志，少于1000行代码。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,436 | 🐛 2,753 | 🌐 C++ | 📅 2026-08-14: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,574 | 🐛 1,553 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,655 | 🐛 420 | 🌐 C++ | 📅 2026-08-14: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
* [darknet](https://github.com/pjreddie/darknet) ⭐ 26,488 | 🐛 1,975 | 🌐 C | 📅 2024-05-03: 用C和CUDA编写的开源神经网络框架。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++ 11的机器学习、计算机视觉、数值优化和深度学习的工具包。
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,238 | 🐛 80 | 🌐 C++ | 📅 2026-08-14: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,153 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,554 | 🐛 117 | 🌐 C | 📅 2026-08-14: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,510 | 🐛 43 | 🌐 C++ | 📅 2026-08-14v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,010 | 🐛 684 | 🌐 C++ | 📅 2026-08-12: 高效，可靠的几何算法集合。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 500 | 🐛 22 | 🌐 C++ | 📅 2026-08-15: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,291 | 🐛 324 | 🌐 C | 📅 2026-08-14: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,043 | 🐛 362 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,444 | 🐛 41 | 🌐 C++ | 📅 2026-08-14: 用于读取和编辑几种流行音频格式的元数据的库。
...
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 785 | 🐛 355 | 🌐 C++ | 📅 2026-06-21: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,951 | 🐛 47 | 🌐 C++ | 📅 2026-07-31: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,867 | 🐛 195 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,743 | 🐛 3 | 🌐 C++ | 📅 2026-08-14: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,224 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 12,992 | 🐛 4 | 🌐 C | 📅 2026-08-14<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,529 | 🐛 730 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-14: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
* [C++ REST SDK](https://github.com/Microsoft/cpprestsdk) ⚠️ Archived: C++ REST SDK（以前称为Casablanca）。
* [WebSocket++](https://github.com/zaphoyd/websocketpp) ⭐ 7,709 | 🐛 483 | 🌐 C++ | 📅 2026-05-04: 基于C++/Boost Aiso的websocket 客户端/服务器库。
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,404 | 🐛 87 | 🌐 C++ | 📅 2026-07-26: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,314 | 🐛 230 | 🌐 C | 📅 2026-08-12: 提供客户端和服务器库的轻量级纯C WebSocket实现。
...
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,369 | 🐛 24 | 🌐 C | 📅 2026-08-14: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,157 | 🐛 177 | 🌐 C | 📅 2026-08-14: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,129 | 🐛 51 | 🌐 C++ | 📅 2026-08-14: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-14: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
...
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,176 | 🐛 61 | 🌐 C | 📅 2026-08-01: 用于异步DNS请求的C库。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,031 | 🐛 592 | 🌐 C | 📅 2026-08-10: 用于C和C++的Apache Kafka客户端库。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,673 | 🐛 423 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,982 | 🐛 26 | 🌐 C++ | 📅 2026-08-14: 开源的多物理场仿真引擎。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,244 | 🐛 447 | 🌐 C++ | 📅 2026-08-11: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,166 | 🐛 19 | 🌐 C++ | 📅 2026-08-11: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
* [RTTR](https://github.com/rttrorg/rttr) ⭐ 3,482 | 🐛 150 | 🌐 C++ | 📅 2024-04-25: C++11的映射库。
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,352 | 🐛 0 | 🌐 C++ | 📅 2026-08-05: 只包含头文件的的C++ 17库，提供名称宏和函数以获取变量、类型、函数、宏和枚举的简单名称。
...
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions) ⭐ 3,830 | 🐛 104 | 🌐 C++ | 📅 2026-07-11: 编译时PCRE（几乎）兼容的正则表达式匹配器。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,092 | 🐛 581 | 🌐 C++ | 📅 2026-08-14: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Torch](https://github.com/torch/torch7) ⭐ 9,137 | 🐛 298 | 🌐 C | 📅 2025-03-31: 科学的计算框架，广泛支持将GPU放在首位的机器学习算法。
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,070 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组的DBMS。
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,416 | 🐛 322 | 🌐 C++ | 📅 2026-08-14: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 17,996 | 🐛 712 | 🌐 C++ | 📅 2026-08-14: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,824 | 🐛 1,497 | 🌐 Cython | 📅 2026-08-14: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
* [ChakraCore](https://github.com/Microsoft/ChakraCore) ⭐ 9,256 | 🐛 613 | 🌐 JavaScript | 📅 2026-02-19: Microsoft的JavaScript引擎，可以嵌入到nodejs中。
* [Duktape](https://github.com/svaarala/duktape) ⭐ 6,209 | 🐛 474 | 🌐 JavaScript | 📅 2024-03-22: 具有紧凑脚本的嵌入式Javascript引擎。
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,124 | 🐛 308 | 🌐 C++ | 📅 2025-03-07: 具有高级功能和一流性能的C++ <-> Lua API封装器。
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,705 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,348 | 🐛 193 | 🌐 C | 📅 2026-08-09: 可移植的外部功能接口库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,334 | 🐛 263 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,520 | 🐛 79 | 🌐 C | 📅 2026-07-24: ANSI C中的小型代码大小的协议缓冲区实现。
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,134 | 🐛 304 | 🌐 C++ | 📅 2026-08-10: 开源H.364 编解码器。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 21,992 | 🐛 1,532 | 🌐 C | 📅 2026-08-14: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,184 | 🐛 422 | 🌐 C++ | 📅 2026-08-11: 基于C++ 14/17的高性能HTTP应用程序框架。
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,643 | 🐛 333 | 🌐 C++ | 📅 2025-11-12: 轻量、零依赖的框架，可创建高性能的Web服务。
...
* [facil.io](https://github.com/boazsegev/facil.io) ⭐ 2,395 | 🐛 36 | 🌐 C | 📅 2026-04-14: 事件型、高性能的C Web框架，支持HTTP、WebSocket、SSE等。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,402 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,066 | 🐛 0 | 🌐 Java | 📅 2026-07-28: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,741 | 🐛 9 | 🌐 C++ | 📅 2026-08-13: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,741 | 🐛 9 | 🌐 C++ | 📅 2026-08-13: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,533 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
* [Klib](https://github.com/attractivechaos/klib) ⭐ 4,714 | 🐛 94 | 🌐 C | 📅 2025-12-22: 通用算法和数据结构的小型、轻量级实现。
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,430 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: C++语言编写的跨平台，串口库。
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,430 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: 跨平台，用C++编写的串行端口库。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,359 | 🐛 1,170 | 🌐 CMake | 📅 2026-08-15: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,436 | 🐛 0 | 🌐 Rust | 📅 2026-08-13: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,674 | 🐛 298 | 🌐 OCaml | 📅 2026-08-12: 用于Java、C和Objective-C的静态分析器。
* [IKOS](https://github.com/NASA-SW-VnV/ikos) ⭐ 3,160 | 🐛 50 | 🌐 C++ | 📅 2026-05-31: 基于抽象解释理论的C / C++静态分析器。
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,842 | 🐛 82 | 🌐 Python | 📅 2026-08-14: 遵循Google C++样式指南的C++样式检查器。
