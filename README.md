...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,069 | 🐛 312 | 📅 2026-09-01 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,116 | 🐛 238 | 🌐 C++ | 📅 2026-09-01: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,528 | 🐛 465 | 🌐 C++ | 📅 2026-09-02: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,850 | 🐛 477 | 🌐 C++ | 📅 2026-09-01: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,113 | 🐛 62 | 🌐 C++ | 📅 2026-09-01: 嵌入式模板库。
- [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus) ⭐ 2,294 | 🐛 0 | 🌐 C++ | 📅 2026-07-15: C++ 的函数式编程库，编写简洁易读的C++代码。
- [BDE](https://github.com/bloomberg/bde) ⭐ 1,840 | 🐛 15 | 🌐 C++ | 📅 2026-08-27: 来自于彭博资讯实验室的开发环境。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,352 | 🐛 3,004 | 🌐 C++ | 📅 2026-09-02: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,709 | 🐛 17,535 | 🌐 Python | 📅 2026-09-02: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,885 | 🐛 144 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,184 | 🐛 989 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,542 | 🐛 40 | 🌐 C | 📅 2026-09-01: 跨平台的事件循环库。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,217 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [minimp3](https://github.com/lieff/minimp3) ⭐ 1,949 | 🐛 55 | 🌐 C | 📅 2026-07-27: 公共域，无尘室实现的MP3解码器，只有头文件。
- [libsndfile](https://github.com/erikd/libsndfile/) ⭐ 1,711 | 🐛 213 | 🌐 C | 📅 2026-09-01: C++封装的C库，用于通过标准库接口读写包含采样声音的文件。
- [Maximilian](https://github.com/micknoise/Maximilian) ⭐ 1,698 | 🐛 32 | 🌐 C++ | 📅 2025-01-04: C++音频和音乐数字信号处理库。
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 917 | 🐛 176 | 🌐 C++ | 📅 2026-09-01: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,048 | 🐛 251 | 🌐 C++ | 📅 2026-09-01(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 1,000 | 🐛 47 | 🌐 C++ | 📅 2026-08-30 (a.k.a. libtorrent-rakshasa): 比特流库。
* [jech/dht](https://github.com/jech/dht) ⭐ 709 | 🐛 7 | 🌐 C | 📅 2023-03-18: C实现的比特流分布式哈希表库。

### 化学

化学，地球化学，生物化学

* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,040 | 🐛 91 | 🌐 C++ | 📅 2026-09-01: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 957 | 🐛 0 | 🌐 C++ | 📅 2026-09-01: 传递消息的并行分子动力学实现。
* [Reaktoro](https://github.com/reaktoro/reaktoro) ⭐ 219 | 🐛 34 | 🌐 C++ | 📅 2026-02-02: C++和python中用于对化学反应系统进行建模的计算框架。
* [d-SEAMS](https://github.com/d-SEAMS/seams-core) ⭐ 42 | 🐛 17 | 🌐 C++ | 📅 2026-08-20: 具有Nix的C++和Lua实现的分子动力学轨道分析引擎，它是分子模拟的递延结构分析的首字母缩写。

### 命令行界面

控制台/终端用户界面，命令行界面

* [jarro2783/cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,805 | 🐛 70 | 🌐 C++ | 📅 2026-07-13: 轻量级的C++命令行选项解析器。
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,432 | 🐛 78 | 🌐 C++ | 📅 2026-09-01: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
* [linenoise](https://github.com/antirez/linenoise) ⭐ 4,347 | 🐛 154 | 🌐 C | 📅 2026-05-02: readline和libedit的独立小选择。
...
* [Taywee / args](https://github.com/taywee/args) ⭐ 1,635 | 🐛 15 | 🌐 C++ | 📅 2026-08-03: 简单的只有头文件的C++参数解析库。
...
* [PDCurses](https://github.com/wmcbrine/PDCurses) ⭐ 1,244 | 🐛 44 | 🌐 C | 📅 2026-01-10: 具有源代码和预编译库的公共域curses库。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,862 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-01: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 854 | 🐛 42 | 🌐 C++ | 📅 2026-08-30: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,660 | 🐛 353 | 🌐 C | 📅 2026-09-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,605 | 🐛 599 | 🌐 C | 📅 2026-09-01: 多格式的存档和压缩库。
...
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,489 | 🐛 15 | 🌐 C | 📅 2026-09-01: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,470 | 🐛 77 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,138 | 🐛 34 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,040 | 🐛 416 | 🌐 C++ | 📅 2026-09-01: 用于集体多GPU通信的优化基元。
- [readerwriterqueue](https://github.com/cameron314/readerwriterqueue) ⭐ 4,617 | 🐛 23 | 🌐 C++ | 📅 2026-08-23: C++的快速单生产者、单消费者的无锁队列。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,889 | 🐛 136 | 🌐 C++ | 📅 2026-09-01: 适用于任何规模的并行分布式应用的通用C++运行时系统。
- [libcds](https://github.com/khizmax/libcds) ⭐ 2,744 | 🐛 55 | 🌐 C++ | 📅 2023-10-17: 并行数据结构的C++库。
- [ck](https://github.com/concurrencykit/ck) ⭐ 2,693 | 🐛 8 | 🌐 C | 📅 2026-08-31: 并发基元，安全内存回收机制和非阻塞数据结构。
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,652 | 🐛 547 | 🌐 C++ | 📅 2026-09-01: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,601 | 🐛 115 | 🌐 C | 📅 2026-08-31: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
- [Boost.Compute](https://github.com/kylelutz/compute) ⭐ 1,662 | 🐛 157 | 🌐 C++ | 📅 2026-08-12: 用于OpenCL的C++GPU计算库。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 215 | 🌐 C++ | 📅 2026-09-01: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [iniparser](https://github.com/ndevilla/iniparser) ⭐ 1,073 | 🐛 6 | 🌐 C | 📅 2026-07-19: INI文件解析器。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 73,069 | 🐛 312 | 📅 2026-09-01: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,927 | 🐛 1 | 🌐 C | 📅 2026-08-31: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,932 | 🐛 1,726 | 🌐 C | 📅 2026-09-01: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 5,006 | 🐛 35 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,760 | 🐛 319 | 🌐 C | 📅 2026-09-02: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,973 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,789 | 🐛 49 | 🌐 C | 📅 2026-09-01: 相当全面、模块化和可移植的加密工具包。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,376 | 🐛 404 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,035 | 🐛 1,628 | 🌐 C++ | 📅 2026-09-01: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,680 | 🐛 84 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,781 | 🐛 92 | 🌐 C | 📅 2026-08-25: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,693 | 🐛 16 | 🌐 C++ | 📅 2026-09-01: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 117 | 🌐 C++ | 📅 2026-09-01: 快速密集和稀疏多维数组DBMS。
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,619 | 🐛 138 | 🌐 C++ | 📅 2026-09-01: C++的数据库抽象层。
...
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 5 | 🌐 C | 📅 2026-08-31: C的MongoDB客户端库。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 39,435 | 🐛 496 | 🌐 C++ | 📅 2026-09-01: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 39,435 | 🐛 496 | 🌐 C++ | 📅 2026-09-01: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,460 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,460 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,380 | 🐛 174 | 🌐 C++ | 📅 2026-08-28: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,858 | 🐛 140 | 🌐 C++ | 📅 2026-08-29: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,363 | 🐛 85 | 🌐 C | 📅 2026-08-25: C的简单单元测试。
...
* [fff](https://github.com/meekrosoft/fff) ⭐ 933 | 🐛 59 | 🌐 C | 📅 2023-11-02: 创建伪C函数的微框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,504 | 🐛 18,819 | 🌐 C++ | 📅 2026-09-01: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,551 | 🐛 20 | 🌐 C | 📅 2026-08-29: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,072 | 🐛 11 | 🌐 C++ | 📅 2026-08-31: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,215 | 🐛 368 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,901 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
...
* [Spring](https://github.com/spring/spring) ⭐ 3,979 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,856 | 🐛 47 | 🌐 C | 📅 2026-09-01: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,553 | 🐛 295 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [Corange](https://github.com/orangeduck/Corange) ⭐ 1,987 | 🐛 22 | 🌐 C | 📅 2024-06-03: 用纯C、SDL、OpenGL编写的游戏引擎。
...
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-09-02: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 76,006 | 🐛 1,230 | 🌐 C++ | 📅 2026-09-01: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,363 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
...
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,401 | 🐛 56 | 🌐 C++ | 📅 2026-08-29: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,684 | 🐛 8 | 🌐 C++ | 📅 2026-09-01: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,813 | 🐛 92 | 🌐 C++ | 📅 2026-08-31: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,450 | 🐛 288 | 🌐 C++ | 📅 2026-09-02: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,302 | 🐛 765 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,173 | 🐛 543 | 🌐 C++ | 📅 2026-09-01: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,913 | 🐛 50 | 🌐 C++ | 📅 2026-09-02 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,702 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,199 | 🐛 76 | 🌐 C++ | 📅 2026-08-23: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,080 | 🐛 157 | 🌐 C++ | 📅 2026-09-01: 简单的C++几何处理库。
...
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,628 | 🐛 8 | 🌐 C++ | 📅 2026-08-30: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,983 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,922 | 🐛 2 | 🌐 C++ | 📅 2026-08-29: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,571 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,411 | 🐛 16 | 🌐 C | 📅 2026-08-27: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,352 | 🐛 183 | 🌐 C++ | 📅 2026-09-02: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,266 | 🐛 26 | 🌐 C++ | 📅 2026-09-01: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,076 | 🐛 68 | 🌐 C | 📅 2026-09-01: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
* [GD](https://github.com/libgd/libgd) ⭐ 984 | 🐛 106 | 🌐 C | 📅 2026-08-25: GD图形库，有名的用于PHP中图形加载/操作和缩略图生成。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,980 | 🐛 9 | 🌐 C++ | 📅 2026-08-26: C和C++的单个头文件的utf8字符串函数。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,282 | 🐛 1,349 | 🌐 C++ | 📅 2026-09-01: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,169 | 🐛 325 | 🌐 C++ | 📅 2026-09-01: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,293 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,659 | 🐛 59 | 🌐 C | 📅 2026-09-01: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,192 | 🐛 152 | 🌐 C++ | 📅 2026-09-01: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,501 | 🐛 140 | 🌐 C++ | 📅 2026-09-01: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,224 | 🐛 132 | 🌐 C++ | 📅 2026-09-01: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,120 | 🐛 791 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,967 | 🐛 357 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,886 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
...
* [json-c](https://github.com/json-c/json-c) ⭐ 3,288 | 🐛 20 | 🌐 C | 📅 2026-08-30: C中的JSON实现。
...
* [jsoncons](https://github.com/danielaparker/jsoncons) ⭐ 855 | 🐛 17 | 🌐 C++ | 📅 2026-08-15: 使用JSONPointer、JSONPatch、JSONPath和JMESPath的JSON和类似JSON二进制格式的C++库，只有头文件。
* [json.h](https://github.com/sheredom/json.h) ⭐ 839 | 🐛 4 | 🌐 C | 📅 2026-08-24: 在C和C++中解析JSON的简单的单头文件/单源文件的解决方案。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,562 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,016 | 🐛 7 | 🌐 C++ | 📅 2026-08-31: 异步、跨平台、低时延的日志库。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,683 | 🐛 2,756 | 🌐 C++ | 📅 2026-09-01: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,555 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,721 | 🐛 436 | 🌐 C++ | 📅 2026-09-01: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,241 | 🐛 80 | 🌐 C++ | 📅 2026-09-01: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,572 | 🐛 52 | 🌐 C++ | 📅 2026-09-01v: 用于计量金融的免费/开源库。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,567 | 🐛 118 | 🌐 C | 📅 2026-09-01: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,029 | 🐛 681 | 🌐 C++ | 📅 2026-08-27: 高效，可靠的几何算法集合。
* [xtensor](https://github.com/QuantStack/xtensor) ⭐ 3,762 | 🐛 425 | 🌐 C++ | 📅 2026-08-27: 受NumPy语法启发的C++ 14库，用于使用多维数组表达式进行数值分析。
* [autodiff](https://github.com/autodiff/autodiff) ⭐ 1,953 | 🐛 109 | 🌐 C++ | 📅 2025-01-27: 用于自动微分的现代、快速且富有表现力的C++库。
* [TinyExpr](https://github.com/codeplea/tinyexpr) ⭐ 1,920 | 🐛 0 | 🌐 C | 📅 2026-08-31: 用于解析和评估字符串中的数学表达式的C库。
* [Vc](https://github.com/VcDevel/Vc) ⭐ 1,542 | 🐛 88 | 🌐 C++ | 📅 2026-07-07: C++的SIMD矢量类。
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,404 | 🐛 252 | 🌐 C++ | 📅 2026-09-01: 快速符号处理库，用C++重写了SymPy的核心。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,344 | 🐛 309 | 🌐 C | 📅 2026-09-01: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,084 | 🐛 370 | 🌐 C | 📅 2026-09-01: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,534 | 🐛 188 | 🌐 C | 📅 2026-08-23: C和C++的保守的垃圾回收器。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,449 | 🐛 41 | 🌐 C++ | 📅 2026-08-30: 用于读取和编辑几种流行音频格式的元数据的库。
...
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 790 | 🐛 349 | 🌐 C++ | 📅 2026-08-28: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,978 | 🐛 48 | 🌐 C++ | 📅 2026-08-29: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,892 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,801 | 🐛 3 | 🌐 C++ | 📅 2026-09-01: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,226 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,021 | 🐛 0 | 🌐 C | 📅 2026-09-02<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
...
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,321 | 🐛 230 | 🌐 C | 📅 2026-09-01: 提供客户端和服务器库的轻量级纯C WebSocket实现。
...
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,401 | 🐛 24 | 🌐 C | 📅 2026-08-31: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [ENet](https://github.com/lsalzman/enet) ⭐ 3,259 | 🐛 98 | 🌐 C | 📅 2026-06-23: 可靠的UDP网络库。
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,168 | 🐛 181 | 🌐 C | 📅 2026-08-31: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,133 | 🐛 60 | 🌐 C++ | 📅 2026-09-01: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
...
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,185 | 🐛 71 | 🌐 C | 📅 2026-09-01: 用于异步DNS请求的C库。
...
* [Restinio](https://github.com/Stiffstream/restinio) ⭐ 1,302 | 🐛 43 | 🌐 C++ | 📅 2026-04-02: 只有头文件的C++ 14库，为您提供嵌入式HTTP / Websocket服务器。
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,041 | 🐛 584 | 🌐 C | 📅 2026-09-01: 用于C和C++的Apache Kafka客户端库。
* [libhttpserver](https://github.com/etr/libhttpserver) ⭐ 951 | 🐛 10 | 🌐 C++ | 📅 2026-09-01: 用于创建嵌入式Rest HTTP服务器（以及更多）的C++库。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,710 | 🐛 424 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 3,007 | 🐛 18 | 🌐 C++ | 📅 2026-09-01: 开源的多物理场仿真引擎。
* [Simbody](https://github.com/simbody/simbody) ⭐ 2,548 | 🐛 159 | 🌐 C++ | 📅 2026-08-25: 高性能C++多体动力学/物理库，模拟关节生物力学和机械系统，像车辆，机器人和人体骨骼。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,251 | 🐛 470 | 🌐 C++ | 📅 2026-09-01: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,179 | 🐛 16 | 🌐 C++ | 📅 2026-09-01: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
* [RTTR](https://github.com/rttrorg/rttr) ⭐ 3,485 | 🐛 150 | 🌐 C++ | 📅 2024-04-25: C++11的映射库。
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,357 | 🐛 0 | 🌐 C++ | 📅 2026-08-28: 只包含头文件的的C++ 17库，提供名称宏和函数以获取变量、类型、函数、宏和枚举的简单名称。
...
* [RE2](https://github.com/google/re2) ⭐ 9,789 | 🐛 63 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,104 | 🐛 579 | 🌐 C++ | 📅 2026-08-29: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 117 | 🌐 C++ | 📅 2026-09-01: 快速密集和稀疏多维数组的DBMS。
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,420 | 🐛 332 | 🌐 C++ | 📅 2026-09-01: 高性能的PDE解算器。
* [AMGCL](https://github.com/ddemidov/amgcl) ⭐ 876 | 🐛 60 | 🌐 C++ | 📅 2026-08-03: 只包含头文件的C++库，用于解决具有代数多重网格的大型稀疏线性系统。
* [FFTW](http://www.fftw.org/): 用一维或者多维计算DFT的C语言库。
* [GSL](http://www.gnu.org/software/gsl/): GNU科学库。

### 脚本

* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,010 | 🐛 714 | 🌐 C++ | 📅 2026-09-01: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,841 | 🐛 1,515 | 🌐 Cython | 📅 2026-09-01: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,705 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,362 | 🐛 196 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,423 | 🐛 275 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,544 | 🐛 79 | 🌐 C | 📅 2026-09-01: ANSI C中的小型代码大小的协议缓冲区实现。
...
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,348 | 🐛 103 | 📅 2026-08-25: C/C++的高效二进制序列化库，例如 JSON。
...
* [libde265](https://github.com/strukturag/libde265) ⭐ 1,911 | 🐛 29 | 🌐 C++ | 📅 2026-08-26: 开放的h.265视频编解码器的实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,037 | 🐛 1,534 | 🌐 C | 📅 2026-08-31: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,231 | 🐛 424 | 🌐 C++ | 📅 2026-08-27: 基于C++ 14/17的高性能HTTP应用程序框架。
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,647 | 🐛 348 | 🌐 C++ | 📅 2025-11-12: 轻量、零依赖的框架，可创建高性能的Web服务。
...
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,444 | 🐛 241 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,794 | 🐛 122 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,571 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,077 | 🐛 0 | 🌐 Java | 📅 2026-09-01: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,773 | 🐛 10 | 🌐 C++ | 📅 2026-09-01: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,773 | 🐛 10 | 🌐 C++ | 📅 2026-09-01: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,552 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
...
* [stdman](https://github.com/jeaye/stdman) ⭐ 998 | 🐛 10 | 🌐 C++ | 📅 2024-07-06: 格式化的C++ 11/14 stdlib手册页（来自cppreference）。
...
* [Kangaru](https://github.com/gracicot/kangaru) ⭐ 553 | 🐛 9 | 🌐 C++ | 📅 2026-08-31: 用于C++ 11和C++ 14的依赖注入容器。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,422 | 🐛 1,189 | 🌐 CMake | 📅 2026-08-31: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,461 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,700 | 🐛 205 | 🌐 OCaml | 📅 2026-09-01: 用于Java、C和Objective-C的静态分析器。
* [IKOS](https://github.com/NASA-SW-VnV/ikos) ⭐ 3,163 | 🐛 50 | 🌐 C++ | 📅 2026-05-31: 基于抽象解释理论的C / C++静态分析器。
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,846 | 🐛 84 | 🌐 Python | 📅 2026-08-31: 遵循Google C++样式指南的C++样式检查器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,068 | 🐛 390 | 🌐 C++ | 📅 2026-08-28: 代码美化器。
