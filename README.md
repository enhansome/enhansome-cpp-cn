...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,060 | 🐛 313 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,110 | 🐛 236 | 🌐 C++ | 📅 2026-08-31: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,525 | 🐛 465 | 🌐 C++ | 📅 2026-09-01: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,850 | 🐛 479 | 🌐 C++ | 📅 2026-08-28: 包罗万象的C++类库，用于开发跨平台软件。
- [tbox](https://github.com/tboox/tbox) ⭐ 5,121 | 🐛 37 | 🌐 C | 📅 2026-08-28: 类似于glib的多平台C库。
- [CO](https://github.com/idealvin/co) ⭐ 4,210 | 🐛 15 | 🌐 C++ | 📅 2025-05-27 - C++基础库，包含 go-style 协程库，日志库, JSON库, RPC 框架以及其他基本组件。
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,112 | 🐛 60 | 🌐 C++ | 📅 2026-08-31: 嵌入式模板库。
- [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus) ⭐ 2,295 | 🐛 0 | 🌐 C++ | 📅 2026-07-15: C++ 的函数式编程库，编写简洁易读的C++代码。
...
- [LibSourcey](https://github.com/sourcey/libsourcey) ⭐ 1,368 | 🐛 6 | 🌐 C++ | 📅 2026-06-30: 用于实时的视频流和高性能网络应用程序的C++11 evented IO。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,095 | 🐛 2,984 | 🌐 C++ | 📅 2026-09-01: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,696 | 🐛 17,497 | 🌐 Python | 📅 2026-09-01: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,473 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,883 | 🐛 144 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,181 | 🐛 989 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,541 | 🐛 42 | 🌐 C | 📅 2026-08-24: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,433 | 🐛 58 | 🌐 C++ | 📅 2026-08-30: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,213 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,168 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
- [libsoundio](https://github.com/andrewrk/libsoundio) ⭐ 2,100 | 🐛 137 | 🌐 C | 📅 2025-01-13: 用于跨平台实时音频输入输出的C库。
- [minimp3](https://github.com/lieff/minimp3) ⭐ 1,948 | 🐛 54 | 🌐 C | 📅 2026-07-27: 公共域，无尘室实现的MP3解码器，只有头文件。
- [libsndfile](https://github.com/erikd/libsndfile/) ⭐ 1,711 | 🐛 222 | 🌐 C | 📅 2026-08-01: C++封装的C库，用于通过标准库接口读写包含采样声音的文件。
- [Maximilian](https://github.com/micknoise/Maximilian) ⭐ 1,698 | 🐛 32 | 🌐 C++ | 📅 2025-01-04: C++音频和音乐数字信号处理库。
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 916 | 🐛 175 | 🌐 C++ | 📅 2026-08-27: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,046 | 🐛 251 | 🌐 C++ | 📅 2026-08-31(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 999 | 🐛 47 | 🌐 C++ | 📅 2026-08-30 (a.k.a. libtorrent-rakshasa): 比特流库。
* [jech/dht](https://github.com/jech/dht) ⭐ 709 | 🐛 5 | 🌐 C | 📅 2023-03-18: C实现的比特流分布式哈希表库。

### 化学

化学，地球化学，生物化学

* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,037 | 🐛 93 | 🌐 C++ | 📅 2026-08-31: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 957 | 🐛 0 | 🌐 C++ | 📅 2026-08-31: 传递消息的并行分子动力学实现。
* [Reaktoro](https://github.com/reaktoro/reaktoro) ⭐ 218 | 🐛 34 | 🌐 C++ | 📅 2026-02-02: C++和python中用于对化学反应系统进行建模的计算框架。
...
* [jarro2783/cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,803 | 🐛 70 | 🌐 C++ | 📅 2026-07-13: 轻量级的C++命令行选项解析器。
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,432 | 🐛 78 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,860 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-31: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 853 | 🐛 42 | 🌐 C++ | 📅 2026-08-30: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,650 | 🐛 351 | 🌐 C | 📅 2026-08-29: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,604 | 🐛 596 | 🌐 C | 📅 2026-08-31: 多格式的存档和压缩库。
...
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,487 | 🐛 14 | 🌐 C | 📅 2026-09-01: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,469 | 🐛 77 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,135 | 🐛 34 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,040 | 🐛 417 | 🌐 C++ | 📅 2026-08-31: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,888 | 🐛 134 | 🌐 C++ | 📅 2026-08-31: 适用于任何规模的并行分布式应用的通用C++运行时系统。
- [libcds](https://github.com/khizmax/libcds) ⭐ 2,745 | 🐛 55 | 🌐 C++ | 📅 2023-10-17: 并行数据结构的C++库。
- [ck](https://github.com/concurrencykit/ck) ⭐ 2,692 | 🐛 8 | 🌐 C | 📅 2026-08-31: 并发基元，安全内存回收机制和非阻塞数据结构。
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,652 | 🐛 547 | 🌐 C++ | 📅 2026-08-31: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,600 | 🐛 115 | 🌐 C | 📅 2026-08-31: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 212 | 🌐 C++ | 📅 2026-08-31: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [inih](https://github.com/benhoyt/inih) ⭐ 3,038 | 🐛 6 | 🌐 C++ | 📅 2026-01-30: C语言的简单.INI文件解析器，很适合嵌入式系统。

* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,137 | 🐛 28 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。

* [simpleini](https://github.com/brofield/simpleini) ⭐ 1,325 | 🐛 1 | 🌐 C++ | 📅 2026-06-19: 跨平台的C++库，提供用于读写INI配置文件的简单API。
...
* [inih](https://github.com/jtilly/inih) ⭐ 451 | 🐛 0 | 🌐 C++ | 📅 2024-09-18: [inih](https://github.com/benhoyt/inih) ⭐ 3,038 | 🐛 6 | 🌐 C++ | 📅 2026-01-30的C++版本，只有头文件。
...
* [PGM-index](https://github.com/gvinciguerra/PGM-index) ⭐ 872 | 🐛 12 | 🌐 C++ | 📅 2024-11-28: 能够快速查找、前导、范围搜索和更新数以亿计项数组的数据结构，其跟传统索引相比，使用梯度的顺序而不是空间。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 73,060 | 🐛 313 | 📅 2026-08-22: 可移植和快速的加密库。
...
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,931 | 🐛 1,729 | 🌐 C | 📅 2026-08-31: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 5,004 | 🐛 35 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,760 | 🐛 319 | 🌐 C | 📅 2026-09-01: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,973 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,789 | 🐛 54 | 🌐 C | 📅 2026-08-31: 相当全面、模块化和可移植的加密工具包。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,375 | 🐛 404 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,032 | 🐛 1,630 | 🌐 C++ | 📅 2026-09-01: 来自Facebook的嵌入键值的快速存储。
...
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,692 | 🐛 15 | 🌐 C++ | 📅 2026-08-31: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组DBMS。
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,620 | 🐛 138 | 🌐 C++ | 📅 2026-09-01: C++的数据库抽象层。
* [MongoDB C++ Driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,106 | 🐛 1 | 🌐 C++ | 📅 2026-08-27: MongDB的C++驱动程序。
...
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 385 | 🐛 2 | 🌐 C++ | 📅 2026-08-31: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 39,416 | 🐛 496 | 🌐 C++ | 📅 2026-08-31: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 39,416 | 🐛 496 | 🌐 C++ | 📅 2026-08-31: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,457 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,457 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,377 | 🐛 174 | 🌐 C++ | 📅 2026-08-28: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,857 | 🐛 138 | 🌐 C++ | 📅 2026-08-29: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,362 | 🐛 85 | 🌐 C | 📅 2026-08-25: C的简单单元测试。
* [backward-cpp](https://github.com/bombela/backward-cpp) ⭐ 4,297 | 🐛 126 | 🌐 C++ | 📅 2025-04-14: C++的漂亮堆栈轨迹打印机。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,452 | 🐛 18,822 | 🌐 C++ | 📅 2026-08-31: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,545 | 🐛 16 | 🌐 C | 📅 2026-08-29: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,069 | 🐛 11 | 🌐 C++ | 📅 2026-08-31: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,214 | 🐛 368 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,901 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
* [PixelGameEngine](https://github.com/OneLoneCoder/olcPixelGameEngine) ⭐ 4,237 | 🐛 141 | 🌐 C++ | 📅 2025-09-26: olcPixelGameEngine的官方发行版，该工具用于javidx9的YouTube视频和项目。
* [Spring](https://github.com/spring/spring) ⭐ 3,978 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,855 | 🐛 47 | 🌐 C | 📅 2026-08-30: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
...
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-09-01: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,980 | 🐛 1,233 | 🌐 C++ | 📅 2026-08-31: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,361 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,897 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,209 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,396 | 🐛 56 | 🌐 C++ | 📅 2026-08-29: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,683 | 🐛 9 | 🌐 C++ | 📅 2026-08-31: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,450 | 🐛 287 | 🌐 C++ | 📅 2026-09-01: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,300 | 🐛 763 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,173 | 🐛 544 | 🌐 C++ | 📅 2026-08-29: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,912 | 🐛 50 | 🌐 C++ | 📅 2026-09-01 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,702 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,198 | 🐛 76 | 🌐 C++ | 📅 2026-08-23: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,079 | 🐛 159 | 🌐 C++ | 📅 2026-09-01: 简单的C++几何处理库。
* [urho3d](https://github.com/urho3d/Urho3D) ⚠️ Archived 跨平台的渲染和游戏引擎。
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,421 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
...
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,852 | 🐛 33 | 🌐 C++ | 📅 2026-08-20: 用于在C++中编写DirectX 11.x代码的帮助类的集合。
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,626 | 🐛 8 | 🌐 C++ | 📅 2026-08-30: 低水平图形库（LLGL）是现代图形API的薄抽象层。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,559 | 🐛 417 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,410 | 🐛 16 | 🌐 C | 📅 2026-08-27: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,351 | 🐛 182 | 🌐 C++ | 📅 2026-09-01: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
...
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,073 | 🐛 68 | 🌐 C | 📅 2026-08-31: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
...
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,293 | 🐛 35 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,282 | 🐛 1,349 | 🌐 C++ | 📅 2026-08-31: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,169 | 🐛 327 | 🌐 C++ | 📅 2026-08-31: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,293 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,660 | 🐛 62 | 🌐 C | 📅 2026-08-31: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,192 | 🐛 159 | 🌐 C++ | 📅 2026-08-31: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,492 | 🐛 140 | 🌐 C++ | 📅 2026-09-01: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,219 | 🐛 135 | 🌐 C++ | 📅 2026-08-31: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,119 | 🐛 791 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,964 | 🐛 356 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
...
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,359 | 🐛 128 | 🌐 C | 📅 2026-07-09: 进行编解码和处理Json数据的C语言库。
* [json-c](https://github.com/json-c/json-c) ⭐ 3,286 | 🐛 20 | 🌐 C | 📅 2026-08-30: C中的JSON实现。
...
* [json.h](https://github.com/sheredom/json.h) ⭐ 840 | 🐛 4 | 🌐 C | 📅 2026-08-24: 在C和C++中解析JSON的简单的单头文件/单源文件的解决方案。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,556 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,013 | 🐛 7 | 🌐 C++ | 📅 2026-08-31: 异步、跨平台、低时延的日志库。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,664 | 🐛 2,754 | 🌐 C++ | 📅 2026-08-31: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,555 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,718 | 🐛 429 | 🌐 C++ | 📅 2026-08-31: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,241 | 🐛 80 | 🌐 C++ | 📅 2026-08-26: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,436 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,191 | 🐛 126 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,567 | 🐛 50 | 🌐 C++ | 📅 2026-08-31v: 用于计量金融的免费/开源库。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,565 | 🐛 116 | 🌐 C | 📅 2026-08-30: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,028 | 🐛 678 | 🌐 C++ | 📅 2026-08-27: 高效，可靠的几何算法集合。
* [xtensor](https://github.com/QuantStack/xtensor) ⭐ 3,762 | 🐛 425 | 🌐 C++ | 📅 2026-08-27: 受NumPy语法启发的C++ 14库，用于使用多维数组表达式进行数值分析。
* [autodiff](https://github.com/autodiff/autodiff) ⭐ 1,952 | 🐛 109 | 🌐 C++ | 📅 2025-01-27: 用于自动微分的现代、快速且富有表现力的C++库。
...
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,404 | 🐛 252 | 🌐 C++ | 📅 2026-08-27: 快速符号处理库，用C++重写了SymPy的核心。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,341 | 🐛 312 | 🌐 C | 📅 2026-08-31: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,078 | 🐛 373 | 🌐 C | 📅 2026-08-27: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,533 | 🐛 188 | 🌐 C | 📅 2026-08-23: C和C++的保守的垃圾回收器。
...
* [libass](https://github.com/libass/libass) ⭐ 1,163 | 🐛 168 | 🌐 C | 📅 2026-08-22: ASS / SSA字幕格式的便携式字幕渲染器。
* [libass](https://github.com/libass/libass) ⭐ 1,163 | 🐛 168 | 🌐 C | 📅 2026-08-22: 处理多媒体内容（例如音频、视频、字幕和相关元数据）的库和工具的集合。
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 789 | 🐛 349 | 🌐 C++ | 📅 2026-08-28: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,976 | 🐛 48 | 🌐 C++ | 📅 2026-08-29: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,890 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,795 | 🐛 2 | 🌐 C++ | 📅 2026-09-01: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,226 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,016 | 🐛 0 | 🌐 C | 📅 2026-08-31<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,541 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,373 | 🐛 39 | 🌐 C++ | 📅 2026-09-01: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,321 | 🐛 233 | 🌐 C | 📅 2026-08-31: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,046 | 🐛 46 | 🌐 C++ | 📅 2026-08-24: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,821 | 🐛 106 | 🌐 C++ | 📅 2026-08-25: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,399 | 🐛 24 | 🌐 C | 📅 2026-08-31: 用于快速打包处理的数据平面开发工具、库和驱动程序。
* [evpp](https://github.com/Qihoo360/evpp) ⭐ 3,772 | 🐛 150 | 🌐 C++ | 📅 2024-04-10: 具有TCP / UDP / HTTP协议的C++高性能网络。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,167 | 🐛 181 | 🌐 C | 📅 2026-08-31: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,134 | 🐛 61 | 🌐 C++ | 📅 2026-09-01: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,093 | 🐛 48 | 🌐 C++ | 📅 2026-08-31: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,966 | 🐛 43 | 🌐 C | 📅 2026-08-31: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,957 | 🐛 82 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,184 | 🐛 70 | 🌐 C | 📅 2026-08-24: 用于异步DNS请求的C库。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,041 | 🐛 584 | 🌐 C | 📅 2026-08-31: 用于C和C++的Apache Kafka客户端库。
* [libhttpserver](https://github.com/etr/libhttpserver) ⭐ 951 | 🐛 9 | 🌐 C++ | 📅 2026-07-23: 用于创建嵌入式Rest HTTP服务器（以及更多）的C++库。
...
* [tlse](https://github.com/eduardsui/tlse) ⭐ 685 | 🐛 33 | 🌐 C | 📅 2026-08-07: 单个C文件的TLS 1.2 / 1.3实现，使用tomcrypt作为加密库。
...
* [libharu](https://github.com/libharu/libharu) ⭐ 1,994 | 🐛 114 | 🌐 C | 📅 2026-03-26: 免费、跨平台、开源的软件库，用于生成PDF。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,706 | 🐛 424 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 3,004 | 🐛 18 | 🌐 C++ | 📅 2026-08-31: 开源的多物理场仿真引擎。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,251 | 🐛 470 | 🌐 C++ | 📅 2026-08-31: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,179 | 🐛 16 | 🌐 C++ | 📅 2026-08-31: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
...
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,476 | 🐛 200 | 🌐 C++ | 📅 2026-08-26: Hyperscan是Intel的高性能、多种正则表达式匹配库，提供大量正则表达式（多达数万个）的同时匹配，通常在DPI库堆栈中使用。
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions) ⭐ 3,842 | 🐛 104 | 🌐 C++ | 📅 2026-07-11: 编译时PCRE（几乎）兼容的正则表达式匹配器。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,105 | 🐛 578 | 🌐 C++ | 📅 2026-08-29: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组的DBMS。
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,420 | 🐛 331 | 🌐 C++ | 📅 2026-09-01: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,009 | 🐛 714 | 🌐 C++ | 📅 2026-09-01: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,841 | 🐛 1,516 | 🌐 Cython | 📅 2026-08-31: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,133 | 🐛 308 | 🌐 C++ | 📅 2025-03-07: 具有高级功能和一流性能的C++ <-> Lua API封装器。
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,705 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,361 | 🐛 196 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,422 | 🐛 271 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,544 | 🐛 81 | 🌐 C | 📅 2026-08-26: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,705 | 🐛 344 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,499 | 🐛 39 | 🌐 Java | 📅 2026-08-31: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,347 | 🐛 103 | 📅 2026-08-25: C/C++的高效二进制序列化库，例如 JSON。
...
* [YAS](https://github.com/niXman/yas) ⭐ 795 | 🐛 13 | 🌐 C++ | 📅 2025-02-18: 非常快的序列化库，支持二进制/文本/ JSON格式。
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,142 | 🐛 304 | 🌐 C++ | 📅 2026-08-31: 开源H.364 编解码器。
* [libde265](https://github.com/strukturag/libde265) ⭐ 1,910 | 🐛 29 | 🌐 C++ | 📅 2026-08-26: 开放的h.265视频编解码器的实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,034 | 🐛 1,533 | 🌐 C | 📅 2026-08-31: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,224 | 🐛 422 | 🌐 C++ | 📅 2026-08-27: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [Crow](https://github.com/ipkn/crow) ⭐ 7,630 | 🐛 212 | 🌐 C++ | 📅 2024-06-06: 一个C++微型web框架（灵感来自于Python Flask）。
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,033 | 🐛 49 | 🌐 C | 📅 2026-08-27: 实验性、可扩展的高性能HTTP服务器。
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,443 | 🐛 241 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
...
* [Mini-XML](https://github.com/michaelrsweet/mxml) ⭐ 518 | 🐛 3 | 🌐 C | 📅 2026-08-20: 用ANSI C编写的小型XML解析库。
* [Boost.PropertyTree](http://www.boost.org/doc/libs/1_55_0/doc/html/property_tree.html): 属性树解析器/生成器，可用于解析XML / JSON / INI / Info文件。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,559 | 🐛 417 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,078 | 🐛 1 | 🌐 Java | 📅 2026-08-31: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,768 | 🐛 10 | 🌐 C++ | 📅 2026-08-30: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,768 | 🐛 10 | 🌐 C++ | 📅 2026-08-30: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,551 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,415 | 🐛 1,177 | 🌐 CMake | 📅 2026-08-31: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,458 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,699 | 🐛 202 | 🌐 OCaml | 📅 2026-08-27: 用于Java、C和Objective-C的静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,066 | 🐛 389 | 🌐 C++ | 📅 2026-08-28: 代码美化器。
