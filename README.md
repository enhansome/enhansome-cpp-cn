...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,836 | 🐛 312 | 📅 2026-08-19 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,084 | 🐛 232 | 🌐 C++ | 📅 2026-08-19: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,502 | 🐛 461 | 🌐 C++ | 📅 2026-08-19: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,796 | 🐛 471 | 🌐 C++ | 📅 2026-08-19: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,099 | 🐛 70 | 🌐 C++ | 📅 2026-08-17: 嵌入式模板库。
- [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus) ⭐ 2,296 | 🐛 0 | 🌐 C++ | 📅 2026-07-15: C++ 的函数式编程库，编写简洁易读的C++代码。
- [BDE](https://github.com/bloomberg/bde) ⭐ 1,837 | 🐛 15 | 🌐 C++ | 📅 2026-08-19: 来自于彭博资讯实验室的开发环境。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,068 | 🐛 3,089 | 🌐 C++ | 📅 2026-08-20: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,488 | 🐛 17,141 | 🌐 Python | 📅 2026-08-20: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,166 | 🐛 986 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,537 | 🐛 41 | 🌐 C | 📅 2026-08-19: 跨平台的事件循环库。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,159 | 🐛 3 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 912 | 🐛 177 | 🌐 C++ | 📅 2026-08-19: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,030 | 🐛 251 | 🌐 C++ | 📅 2026-08-19(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 998 | 🐛 55 | 🌐 C++ | 📅 2026-08-19 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,020 | 🐛 94 | 🌐 C++ | 📅 2026-08-19: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,840 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-18: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 850 | 🐛 42 | 🌐 C++ | 📅 2026-08-15: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,580 | 🐛 340 | 🌐 C | 📅 2026-08-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,595 | 🐛 598 | 🌐 C | 📅 2026-08-19: 多格式的存档和压缩库。
...
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,012 | 🐛 410 | 🌐 C++ | 📅 2026-08-19: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 137 | 🌐 C++ | 📅 2026-08-19: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,646 | 🐛 550 | 🌐 C++ | 📅 2026-08-19: 用于并行运行和内存抽象的便携式编程模型。
...
* [robin-map](https://github.com/Tessil/robin-map) ⭐ 1,501 | 🐛 18 | 🌐 C++ | 📅 2026-06-13: 使用robin hood哈希算法的哈希映射和哈希集。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,836 | 🐛 312 | 📅 2026-08-19: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,904 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,884 | 🐛 1,728 | 🌐 C | 📅 2026-08-18: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,998 | 🐛 33 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,752 | 🐛 316 | 🌐 C | 📅 2026-08-20: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,973 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,786 | 🐛 51 | 🌐 C | 📅 2026-08-08: 相当全面、模块化和可移植的加密工具包。
...
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 31,984 | 🐛 1,618 | 🌐 C++ | 📅 2026-08-19: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,676 | 🐛 75 | 🌐 C | 📅 2026-08-14: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,772 | 🐛 93 | 🌐 C | 📅 2026-07-24: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
...
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 385 | 🐛 64 | 🌐 C++ | 📅 2026-08-19: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,939 | 🐛 493 | 🌐 C++ | 📅 2026-08-19: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,939 | 🐛 493 | 🌐 C++ | 📅 2026-08-19: Google的C++测试框架。
...
* [utest.h](https://github.com/sheredom/utest.h) ⭐ 990 | 🐛 11 | 🌐 C++ | 📅 2026-08-19: C和C++的单个头文件测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 115,886 | 🐛 18,713 | 🌐 C++ | 📅 2026-08-19: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,398 | 🐛 20 | 🌐 C | 📅 2026-08-19: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,029 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,207 | 🐛 368 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
...
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-08-19: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,744 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-19: 拥有最小依赖关系的即时模式图形用户界面。
...
* [implot](https://github.com/epezent/implot) ⭐ 6,195 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,361 | 🐛 59 | 🌐 C++ | 📅 2026-08-17: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,414 | 🐛 287 | 🌐 C++ | 📅 2026-08-19: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,262 | 🐛 760 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,146 | 🐛 525 | 🌐 C++ | 📅 2026-08-19: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,888 | 🐛 50 | 🌐 C++ | 📅 2026-08-19 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,693 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,188 | 🐛 76 | 🌐 C++ | 📅 2026-08-18: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,071 | 🐛 157 | 🌐 C++ | 📅 2026-08-19: 简单的C++几何处理库。
* [urho3d](https://github.com/urho3d/Urho3D) ⚠️ Archived 跨平台的渲染和游戏引擎。
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,401 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
...
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,847 | 🐛 33 | 🌐 C++ | 📅 2026-08-20: 用于在C++中编写DirectX 11.x代码的帮助类的集合。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,443 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
...
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,395 | 🐛 16 | 🌐 C | 📅 2026-08-19: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,348 | 🐛 180 | 🌐 C++ | 📅 2026-08-19: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
...
* [GD](https://github.com/libgd/libgd) ⭐ 982 | 🐛 107 | 🌐 C | 📅 2026-08-19: GD图形库，有名的用于PHP中图形加载/操作和缩略图生成。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,231 | 🐛 1,384 | 🌐 C++ | 📅 2026-08-19: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,162 | 🐛 326 | 🌐 C++ | 📅 2026-08-20: 快速的数据交换格式和基于功能的RPC系统。
...
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,190 | 🐛 161 | 🌐 C++ | 📅 2026-08-19: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,404 | 🐛 95 | 🌐 C++ | 📅 2026-08-20: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,161 | 🐛 133 | 🌐 C++ | 📅 2026-08-19: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,113 | 🐛 789 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,927 | 🐛 353 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,883 | 🐛 112 | 🌐 C++ | 📅 2026-07-29: 可与JSON交互的C++库。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,502 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,005 | 🐛 7 | 🌐 C++ | 📅 2026-08-11: 异步、跨平台、低时延的日志库。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,509 | 🐛 2,748 | 🌐 C++ | 📅 2026-08-19: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,560 | 🐛 1,566 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,673 | 🐛 422 | 🌐 C++ | 📅 2026-08-19: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,431 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,162 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,559 | 🐛 113 | 🌐 C | 📅 2026-08-19: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,526 | 🐛 48 | 🌐 C++ | 📅 2026-08-18v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,011 | 🐛 675 | 🌐 C++ | 📅 2026-08-19: 高效，可靠的几何算法集合。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 499 | 🐛 19 | 🌐 C++ | 📅 2026-08-19: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,305 | 🐛 318 | 🌐 C | 📅 2026-08-19: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,050 | 🐛 362 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,523 | 🐛 190 | 🌐 C | 📅 2026-07-23: C和C++的保守的垃圾回收器。
* [memory-allocators](https://github.com/mtrebi/memory-allocators) ⭐ 1,992 | 🐛 17 | 🌐 C++ | 📅 2026-04-12: 自定义内存分配器，可提高动态内存分配的性能。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,445 | 🐛 39 | 🌐 C++ | 📅 2026-08-19: 用于读取和编辑几种流行音频格式的元数据的库。
* [libass](https://github.com/libass/libass) ⭐ 1,159 | 🐛 165 | 🌐 C | 📅 2026-08-10: ASS / SSA字幕格式的便携式字幕渲染器。
* [libass](https://github.com/libass/libass) ⭐ 1,159 | 🐛 165 | 🌐 C | 📅 2026-08-10: 处理多媒体内容（例如音频、视频、字幕和相关元数据）的库和工具的集合。
...
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,874 | 🐛 195 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,753 | 🐛 3 | 🌐 C++ | 📅 2026-08-19: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,224 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,003 | 🐛 4 | 🌐 C | 📅 2026-08-19<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,533 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
...
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,379 | 🐛 24 | 🌐 C | 📅 2026-08-19: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [ENet](https://github.com/lsalzman/enet) ⭐ 3,256 | 🐛 98 | 🌐 C | 📅 2026-06-23: 可靠的UDP网络库。
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,158 | 🐛 179 | 🌐 C | 📅 2026-08-19: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,131 | 🐛 56 | 🌐 C++ | 📅 2026-08-19: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,034 | 🐛 592 | 🌐 C | 📅 2026-08-18: 用于C和C++的Apache Kafka客户端库。
...
* [tlse](https://github.com/eduardsui/tlse) ⭐ 684 | 🐛 32 | 🌐 C | 📅 2026-08-07: 单个C文件的TLS 1.2 / 1.3实现，使用tomcrypt作为加密库。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,684 | 🐛 423 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
...
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,464 | 🐛 200 | 🌐 C++ | 📅 2026-08-17: Hyperscan是Intel的高性能、多种正则表达式匹配库，提供大量正则表达式（多达数万个）的同时匹配，通常在DPI库堆栈中使用。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,001 | 🐛 711 | 🌐 C++ | 📅 2026-08-19: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,829 | 🐛 1,497 | 🌐 Cython | 📅 2026-08-19: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [libffi](https://github.com/libffi/libffi) ⭐ 4,355 | 🐛 193 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,347 | 🐛 266 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,526 | 🐛 79 | 🌐 C | 📅 2026-07-24: ANSI C中的小型代码大小的协议缓冲区实现。
...
* [libde265](https://github.com/strukturag/libde265) ⭐ 1,904 | 🐛 33 | 🌐 C++ | 📅 2026-07-24: 开放的h.265视频编解码器的实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 21,995 | 🐛 1,535 | 🌐 C | 📅 2026-08-18: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,191 | 🐛 426 | 🌐 C++ | 📅 2026-08-11: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,443 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,070 | 🐛 1 | 🌐 Java | 📅 2026-08-17: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,747 | 🐛 10 | 🌐 C++ | 📅 2026-08-16: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,747 | 🐛 10 | 🌐 C++ | 📅 2026-08-16: C++的小型，安全和快速格式化库。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,379 | 🐛 1,140 | 🌐 CMake | 📅 2026-08-20: Windows，Linux和MacOS的C++库管理器。
