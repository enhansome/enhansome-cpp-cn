...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,043 | 🐛 311 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,108 | 🐛 235 | 🌐 C++ | 📅 2026-08-29: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,523 | 🐛 465 | 🌐 C++ | 📅 2026-08-30: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,847 | 🐛 479 | 🌐 C++ | 📅 2026-08-28: 包罗万象的C++类库，用于开发跨平台软件。
- [tbox](https://github.com/tboox/tbox) ⭐ 5,121 | 🐛 37 | 🌐 C | 📅 2026-08-28: 类似于glib的多平台C库。
- [CO](https://github.com/idealvin/co) ⭐ 4,211 | 🐛 15 | 🌐 C++ | 📅 2025-05-27 - C++基础库，包含 go-style 协程库，日志库, JSON库, RPC 框架以及其他基本组件。
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,110 | 🐛 62 | 🌐 C++ | 📅 2026-08-30: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,073 | 🐛 2,991 | 🌐 C++ | 📅 2026-08-31: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,687 | 🐛 17,480 | 🌐 Python | 📅 2026-08-31: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,472 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,882 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,177 | 🐛 989 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,542 | 🐛 42 | 🌐 C | 📅 2026-08-24: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,432 | 🐛 58 | 🌐 C++ | 📅 2026-08-30: C++中Actor Model的开源实现。
...
* [AudioFile](https://github.com/adamstark/AudioFile) ⭐ 1,147 | 🐛 3 | 🌐 C++ | 📅 2025-10-15: 用于读写音频文件的简单C++库。

- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,209 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,167 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,044 | 🐛 249 | 🌐 C++ | 📅 2026-08-30(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,036 | 🐛 98 | 🌐 C++ | 📅 2026-08-30: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 957 | 🐛 0 | 🌐 C++ | 📅 2026-08-28: 传递消息的并行分子动力学实现。
* [Reaktoro](https://github.com/reaktoro/reaktoro) ⭐ 217 | 🐛 34 | 🌐 C++ | 📅 2026-02-02: C++和python中用于对化学反应系统进行建模的计算框架。
...
* [jarro2783/cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,801 | 🐛 70 | 🌐 C++ | 📅 2026-07-13: 轻量级的C++命令行选项解析器。
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,429 | 🐛 76 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
* [linenoise](https://github.com/antirez/linenoise) ⭐ 4,346 | 🐛 154 | 🌐 C | 📅 2026-05-02: readline和libedit的独立小选择。
...
* [replxx](https://github.com/AmokHuginnsson/replxx) ⭐ 762 | 🐛 36 | 🌐 C++ | 📅 2024-04-14: 支持UTF-8、语法高亮、提示的readline和libedit替换，可在Unix和Windows上工作。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,857 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-27: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 852 | 🐛 42 | 🌐 C++ | 📅 2026-08-30: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,651 | 🐛 347 | 🌐 C | 📅 2026-08-29: Zstandard-快速实时压缩算法。由Facebook开发。
...
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,134 | 🐛 34 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,037 | 🐛 417 | 🌐 C++ | 📅 2026-08-29: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,887 | 🐛 138 | 🌐 C++ | 📅 2026-08-31: 适用于任何规模的并行分布式应用的通用C++运行时系统。
- [libcds](https://github.com/khizmax/libcds) ⭐ 2,745 | 🐛 55 | 🌐 C++ | 📅 2023-10-17: 并行数据结构的C++库。
- [ck](https://github.com/concurrencykit/ck) ⭐ 2,692 | 🐛 8 | 🌐 C | 📅 2026-08-10: 并发基元，安全内存回收机制和非阻塞数据结构。
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,651 | 🐛 551 | 🌐 C++ | 📅 2026-08-28: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,600 | 🐛 117 | 🌐 C | 📅 2026-08-30: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 210 | 🌐 C++ | 📅 2026-08-29: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [inih](https://github.com/benhoyt/inih) ⭐ 3,037 | 🐛 6 | 🌐 C++ | 📅 2026-01-30: C语言的简单.INI文件解析器，很适合嵌入式系统。

* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,136 | 🐛 28 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。
...
* [libconfuse](https://github.com/martinh/libconfuse) ⭐ 518 | 🐛 7 | 🌐 C | 📅 2026-08-21: C的小型配置文件解析库。

* [inih](https://github.com/jtilly/inih) ⭐ 451 | 🐛 0 | 🌐 C++ | 📅 2024-09-18: [inih](https://github.com/benhoyt/inih) ⭐ 3,037 | 🐛 6 | 🌐 C++ | 📅 2026-01-30的C++版本，只有头文件。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 73,043 | 🐛 311 | 📅 2026-08-22: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,922 | 🐛 1 | 🌐 C | 📅 2026-08-28: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,929 | 🐛 1,731 | 🌐 C | 📅 2026-08-27: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 5,003 | 🐛 35 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,759 | 🐛 319 | 🌐 C | 📅 2026-08-31: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,973 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,788 | 🐛 53 | 🌐 C | 📅 2026-08-30: 相当全面、模块化和可移植的加密工具包。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,368 | 🐛 404 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,030 | 🐛 1,631 | 🌐 C++ | 📅 2026-08-28: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,680 | 🐛 83 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,781 | 🐛 92 | 🌐 C | 📅 2026-08-25: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,693 | 🐛 16 | 🌐 C++ | 📅 2026-08-30: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 117 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组DBMS。
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,620 | 🐛 138 | 🌐 C++ | 📅 2026-08-29: C++的数据库抽象层。
...
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 5 | 🌐 C | 📅 2026-08-28: C的MongoDB客户端库。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 39,384 | 🐛 496 | 🌐 C++ | 📅 2026-08-27: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 39,384 | 🐛 496 | 🌐 C++ | 📅 2026-08-27: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,452 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,452 | 🐛 438 | 🌐 C++ | 📅 2026-08-25: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,374 | 🐛 174 | 🌐 C++ | 📅 2026-08-28: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,856 | 🐛 138 | 🌐 C++ | 📅 2026-08-29: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,360 | 🐛 85 | 🌐 C | 📅 2026-08-25: C的简单单元测试。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,401 | 🐛 18,824 | 🌐 C++ | 📅 2026-08-29: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,534 | 🐛 16 | 🌐 C | 📅 2026-08-29: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,065 | 🐛 11 | 🌐 C++ | 📅 2026-08-28: 游戏与现代C++的碰撞。
...
* [PixelGameEngine](https://github.com/OneLoneCoder/olcPixelGameEngine) ⭐ 4,230 | 🐛 141 | 🌐 C++ | 📅 2025-09-26: olcPixelGameEngine的官方发行版，该工具用于javidx9的YouTube视频和项目。
...
* [nCine](https://github.com/nCine/nCine) ⭐ 1,327 | 🐛 1 | 🌐 C++ | 📅 2026-08-24: 注重性能的跨平台2D游戏引擎，用C++11编写，还可以选择使用Lua编写脚本。
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-08-31: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,965 | 🐛 1,238 | 🌐 C++ | 📅 2026-08-30: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,356 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,897 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,208 | 🐛 130 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,395 | 🐛 56 | 🌐 C++ | 📅 2026-08-29: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,683 | 🐛 9 | 🌐 C++ | 📅 2026-08-30: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,813 | 🐛 92 | 🌐 C++ | 📅 2026-08-28: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,446 | 🐛 286 | 🌐 C++ | 📅 2026-08-31: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,299 | 🐛 762 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,171 | 🐛 544 | 🌐 C++ | 📅 2026-08-29: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,911 | 🐛 50 | 🌐 C++ | 📅 2026-08-31 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,702 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,196 | 🐛 76 | 🌐 C++ | 📅 2026-08-23: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,078 | 🐛 156 | 🌐 C++ | 📅 2026-08-26: 简单的C++几何处理库。
* [urho3d](https://github.com/urho3d/Urho3D) ⚠️ Archived 跨平台的渲染和游戏引擎。
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,419 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16: 现代、跨平台、低阶的3D图形库。
...
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,624 | 🐛 8 | 🌐 C++ | 📅 2026-08-30: 低水平图形库（LLGL）是现代图形API的薄抽象层。
...
* [Horde3D](https://github.com/horde3d/Horde3D) ⭐ 1,585 | 🐛 22 | 🌐 C++ | 📅 2026-07-30 一个小型的3D渲染和动画引擎。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,551 | 🐛 417 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,435 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,785 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: 用于图像中人脸检测的开源库，其人脸检测的速度能达到1500FPS。
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,409 | 🐛 16 | 🌐 C | 📅 2026-08-27: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,350 | 🐛 183 | 🌐 C++ | 📅 2026-08-31: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
...
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,073 | 🐛 68 | 🌐 C | 📅 2026-08-30: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,279 | 🐛 1,357 | 🌐 C++ | 📅 2026-08-29: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,169 | 🐛 327 | 🌐 C++ | 📅 2026-08-28: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,293 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,660 | 🐛 62 | 🌐 C | 📅 2026-08-30: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,192 | 🐛 156 | 🌐 C++ | 📅 2026-08-28: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,489 | 🐛 141 | 🌐 C++ | 📅 2026-08-30: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,216 | 🐛 134 | 🌐 C++ | 📅 2026-08-27: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,119 | 🐛 791 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,963 | 🐛 356 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,886 | 🐛 110 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,180 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
...
* [json.h](https://github.com/sheredom/json.h) ⭐ 840 | 🐛 3 | 🌐 C | 📅 2026-08-24: 在C和C++中解析JSON的简单的单头文件/单源文件的解决方案。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,548 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,013 | 🐛 7 | 🌐 C++ | 📅 2026-08-30: 异步、跨平台、低时延的日志库。
* [plog](https://github.com/SergiusTheBest/plog) ⭐ 2,578 | 🐛 58 | 🌐 C++ | 📅 2026-08-07: C++可移植且简单的日志，少于1000行代码。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,651 | 🐛 2,755 | 🌐 C++ | 📅 2026-08-30: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,555 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,715 | 🐛 429 | 🌐 C++ | 📅 2026-08-27: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
* [darknet](https://github.com/pjreddie/darknet) ⭐ 26,494 | 🐛 1,976 | 🌐 C | 📅 2024-05-03: 用C和CUDA编写的开源神经网络框架。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,435 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++ 11的机器学习、计算机视觉、数值优化和深度学习的工具包。
...
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,564 | 🐛 116 | 🌐 C | 📅 2026-08-30: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,556 | 🐛 52 | 🌐 C++ | 📅 2026-08-28v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,028 | 🐛 677 | 🌐 C++ | 📅 2026-08-27: 高效，可靠的几何算法集合。
* [xtensor](https://github.com/QuantStack/xtensor) ⭐ 3,762 | 🐛 425 | 🌐 C++ | 📅 2026-08-27: 受NumPy语法启发的C++ 14库，用于使用多维数组表达式进行数值分析。
* [autodiff](https://github.com/autodiff/autodiff) ⭐ 1,951 | 🐛 109 | 🌐 C++ | 📅 2025-01-27: 用于自动微分的现代、快速且富有表现力的C++库。
* [TinyExpr](https://github.com/codeplea/tinyexpr) ⭐ 1,920 | 🐛 1 | 🌐 C | 📅 2026-08-06: 用于解析和评估字符串中的数学表达式的C库。
* [Vc](https://github.com/VcDevel/Vc) ⭐ 1,541 | 🐛 88 | 🌐 C++ | 📅 2026-07-07: C++的SIMD矢量类。
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,403 | 🐛 252 | 🌐 C++ | 📅 2026-08-27: 快速符号处理库，用C++重写了SymPy的核心。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 500 | 🐛 23 | 🌐 C++ | 📅 2026-08-28: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,336 | 🐛 313 | 🌐 C | 📅 2026-08-30: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,077 | 🐛 370 | 🌐 C | 📅 2026-08-27: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
...
* [tgc](https://github.com/orangeduck/tgc) ⭐ 1,100 | 🐛 7 | 🌐 C | 📅 2023-06-26: 用 \~500 LOC编写的C语言微型垃圾回收器。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,973 | 🐛 48 | 🌐 C++ | 📅 2026-08-29: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,889 | 🐛 196 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,794 | 🐛 2 | 🌐 C++ | 📅 2026-08-30: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,228 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,015 | 🐛 2 | 🌐 C | 📅 2026-08-28<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,542 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-30: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,321 | 🐛 232 | 🌐 C | 📅 2026-08-30: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,046 | 🐛 47 | 🌐 C++ | 📅 2026-08-24: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,821 | 🐛 106 | 🌐 C++ | 📅 2026-08-25: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,399 | 🐛 24 | 🌐 C | 📅 2026-08-28: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,167 | 🐛 182 | 🌐 C | 📅 2026-08-30: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,134 | 🐛 63 | 🌐 C++ | 📅 2026-08-27: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,094 | 🐛 48 | 🌐 C++ | 📅 2026-08-30: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,966 | 🐛 43 | 🌐 C | 📅 2026-08-29: 高速打包处理框架。
...
* [PicoHTTPParser](https://github.com/h2o/picohttpparser) ⭐ 2,104 | 🐛 22 | 🌐 C | 📅 2026-04-06: 微小、原始、快速的HTTP请求/响应解析器。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,041 | 🐛 586 | 🌐 C | 📅 2026-08-28: 用于C和C++的Apache Kafka客户端库。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,705 | 🐛 424 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 3,003 | 🐛 18 | 🌐 C++ | 📅 2026-08-30: 开源的多物理场仿真引擎。
...
* [Chipmunk](https://github.com/slembcke/Chipmunk2D) ⭐ 2,402 | 🐛 69 | 🌐 C | 📅 2026-05-05: 快速、轻量级的2D游戏物理库。
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,251 | 🐛 466 | 🌐 C++ | 📅 2026-08-27: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,178 | 🐛 17 | 🌐 C++ | 📅 2026-08-11: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
...
* [RE2](https://github.com/google/re2) ⭐ 9,788 | 🐛 64 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,102 | 🐛 578 | 🌐 C++ | 📅 2026-08-29: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 117 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组的DBMS。
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,420 | 🐛 325 | 🌐 C++ | 📅 2026-08-30: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,008 | 🐛 715 | 🌐 C++ | 📅 2026-08-29: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,840 | 🐛 1,519 | 🌐 Cython | 📅 2026-08-30: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,131 | 🐛 308 | 🌐 C++ | 📅 2025-03-07: 具有高级功能和一流性能的C++ <-> Lua API封装器。
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,705 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,364 | 🐛 194 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
* [CppSharp](https://github.com/mono/CppSharp) ⭐ 3,407 | 🐛 346 | 🌐 C# | 📅 2026-05-18: 用于将C / C++ API融合到高级语言中的工具和库。
* [ChaiScript](https://github.com/ChaiScript/ChaiScript/) ⭐ 3,125 | 🐛 73 | 🌐 C++ | 📅 2026-05-02: 用于C++的易于使用的嵌入式脚本语言。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,420 | 🐛 272 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,542 | 🐛 80 | 🌐 C | 📅 2026-08-26: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,705 | 🐛 344 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,498 | 🐛 39 | 🌐 Java | 📅 2026-08-22: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
...
* [mrpt-serialization](https://github.com/mrpt/mrpt/) ⭐ 2,159 | 🐛 28 | 🌐 C++ | 📅 2026-08-29: 已版本控制的二进制或文本格式的序列化。
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,140 | 🐛 306 | 🌐 C++ | 📅 2026-08-28: 开源H.364 编解码器。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,027 | 🐛 1,537 | 🌐 C | 📅 2026-08-28: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,222 | 🐛 420 | 🌐 C++ | 📅 2026-08-27: 基于C++ 14/17的高性能HTTP应用程序框架。
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,648 | 🐛 348 | 🌐 C++ | 📅 2025-11-12: 轻量、零依赖的框架，可创建高性能的Web服务。
...
* [Cutelyst](https://github.com/cutelyst/cutelyst) ⭐ 976 | 🐛 16 | 🌐 C++ | 📅 2026-08-19: 在Qt上构建的C++ Web框架，使用Catalyst（Perl）框架的简单方法。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,792 | 🐛 122 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,551 | 🐛 417 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,078 | 🐛 0 | 🌐 Java | 📅 2026-08-24: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,764 | 🐛 10 | 🌐 C++ | 📅 2026-08-30: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,764 | 🐛 10 | 🌐 C++ | 📅 2026-08-30: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,550 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
...
* [Kangaru](https://github.com/gracicot/kangaru) ⭐ 553 | 🐛 9 | 🌐 C++ | 📅 2026-08-29: 用于C++ 11和C++ 14的依赖注入容器。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,412 | 🐛 1,214 | 🌐 CMake | 📅 2026-08-31: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,457 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,692 | 🐛 201 | 🌐 OCaml | 📅 2026-08-27: 用于Java、C和Objective-C的静态分析器。
* [IKOS](https://github.com/NASA-SW-VnV/ikos) ⭐ 3,162 | 🐛 50 | 🌐 C++ | 📅 2026-05-31: 基于抽象解释理论的C / C++静态分析器。
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,846 | 🐛 82 | 🌐 Python | 📅 2026-08-14: 遵循Google C++样式指南的C++样式检查器。
