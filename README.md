...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,103 | 🐛 312 | 📅 2026-09-01 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,121 | 🐛 234 | 🌐 C++ | 📅 2026-09-03: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,526 | 🐛 465 | 🌐 C++ | 📅 2026-09-04: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,857 | 🐛 481 | 🌐 C++ | 📅 2026-09-03: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,116 | 🐛 60 | 🌐 C++ | 📅 2026-09-03: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,793 | 🐛 3,065 | 🌐 C++ | 📅 2026-09-04: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,742 | 🐛 17,497 | 🌐 Python | 📅 2026-09-04: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,891 | 🐛 144 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
- [libhv](https://github.com/ithewei/libhv) ⭐ 7,546 | 🐛 41 | 🌐 C | 📅 2026-09-01: 跨平台的事件循环库。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,220 | 🐛 7 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [libsndfile](https://github.com/erikd/libsndfile/) ⭐ 1,711 | 🐛 213 | 🌐 C | 📅 2026-09-01: C++封装的C库，用于通过标准库接口读写包含采样声音的文件。
- [Maximilian](https://github.com/micknoise/Maximilian) ⭐ 1,699 | 🐛 32 | 🌐 C++ | 📅 2025-01-04: C++音频和音乐数字信号处理库。
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 919 | 🐛 177 | 🌐 C++ | 📅 2026-09-01: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,046 | 🐛 251 | 🌐 C++ | 📅 2026-09-03(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
...
* [jech/dht](https://github.com/jech/dht) ⭐ 710 | 🐛 5 | 🌐 C | 📅 2026-09-02: C实现的比特流分布式哈希表库。

### 化学

化学，地球化学，生物化学

* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,043 | 🐛 77 | 🌐 C++ | 📅 2026-09-03: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 957 | 🐛 0 | 🌐 C++ | 📅 2026-09-03: 传递消息的并行分子动力学实现。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,437 | 🐛 78 | 🌐 C++ | 📅 2026-09-01: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
...
* [Taywee / args](https://github.com/taywee/args) ⭐ 1,636 | 🐛 15 | 🌐 C++ | 📅 2026-08-03: 简单的只有头文件的C++参数解析库。
...
* [replxx](https://github.com/AmokHuginnsson/replxx) ⭐ 763 | 🐛 36 | 🌐 C++ | 📅 2024-04-14: 支持UTF-8、语法高亮、提示的readline和libedit替换，可在Unix和Windows上工作。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,862 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-03: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 854 | 🐛 42 | 🌐 C++ | 📅 2026-08-30: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,691 | 🐛 358 | 🌐 C | 📅 2026-09-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,606 | 🐛 600 | 🌐 C | 📅 2026-09-04: 多格式的存档和压缩库。
...
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,490 | 🐛 16 | 🌐 C | 📅 2026-09-02: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,477 | 🐛 77 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,140 | 🐛 34 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,044 | 🐛 420 | 🌐 C++ | 📅 2026-09-03: 用于集体多GPU通信的优化基元。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,891 | 🐛 138 | 🌐 C++ | 📅 2026-09-01: 适用于任何规模的并行分布式应用的通用C++运行时系统。
- [libcds](https://github.com/khizmax/libcds) ⭐ 2,745 | 🐛 55 | 🌐 C++ | 📅 2023-10-17: 并行数据结构的C++库。
- [ck](https://github.com/concurrencykit/ck) ⭐ 2,696 | 🐛 8 | 🌐 C | 📅 2026-09-02: 并发基元，安全内存回收机制和非阻塞数据结构。
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,672 | 🐛 549 | 🌐 C++ | 📅 2026-09-03: 用于并行运行和内存抽象的便携式编程模型。
...
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 213 | 🌐 C++ | 📅 2026-09-03: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,139 | 🐛 28 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。
...
* [iniparser](https://github.com/ndevilla/iniparser) ⭐ 1,074 | 🐛 6 | 🌐 C | 📅 2026-07-19: INI文件解析器。
...
* [robin-map](https://github.com/Tessil/robin-map) ⭐ 1,504 | 🐛 18 | 🌐 C++ | 📅 2026-06-13: 使用robin hood哈希算法的哈希映射和哈希集。
...
* [Hopscotch map](https://github.com/Tessil/hopscotch-map) ⭐ 850 | 🐛 7 | 🌐 C++ | 📅 2025-11-02: 使用hopscotch哈希算法来实现冲突解决的快速哈希映射，只有头文件。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 73,103 | 🐛 312 | 📅 2026-09-01: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,928 | 🐛 1 | 🌐 C | 📅 2026-08-31: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,936 | 🐛 1,721 | 🌐 C | 📅 2026-09-03: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 5,006 | 🐛 35 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,762 | 🐛 317 | 🌐 C | 📅 2026-09-04: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,974 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,789 | 🐛 54 | 🌐 C | 📅 2026-09-01: 相当全面、模块化和可移植的加密工具包。
...
* [libhydrogen](https://github.com/jedisct1/libhydrogen) ⭐ 781 | 🐛 0 | 🌐 C | 📅 2026-08-26: 轻量级、安全、易于使用的加密库，适用于受限的环境。
...
* [Vince's CSV Parser](https://github.com/vincentlaucsb/csv-parser) ⭐ 1,123 | 🐛 2 | 🌐 C++ | 📅 2026-08-23: 快速、独立、流式的C++17 CSV解析器，具有可选的类型转换和统计信息。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,374 | 🐛 406 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,043 | 🐛 1,629 | 🌐 C++ | 📅 2026-09-03: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,680 | 🐛 85 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,781 | 🐛 92 | 🌐 C | 📅 2026-08-25: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,694 | 🐛 15 | 🌐 C++ | 📅 2026-09-03: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [MongoDB C++ Driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,106 | 🐛 4 | 🌐 C++ | 📅 2026-09-03: MongDB的C++驱动程序。
* [sqlite\_modern\_cpp](https://github.com/SqliteModernCpp/sqlite_modern_cpp) ⭐ 949 | 🐛 43 | 🌐 C++ | 📅 2024-07-23: sqlite库的C++14封装器，只有头文件。
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 11 | 🌐 C | 📅 2026-09-03: C的MongoDB客户端库。
...
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 384 | 🐛 2 | 🌐 C++ | 📅 2026-08-31: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 39,486 | 🐛 500 | 🌐 C++ | 📅 2026-09-03: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 39,486 | 🐛 500 | 🌐 C++ | 📅 2026-09-03: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,464 | 🐛 438 | 🌐 C++ | 📅 2026-09-03: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,464 | 🐛 438 | 🌐 C++ | 📅 2026-09-03: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,383 | 🐛 175 | 🌐 C++ | 📅 2026-08-28: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,858 | 🐛 140 | 🌐 C++ | 📅 2026-08-29: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,365 | 🐛 85 | 🌐 C | 📅 2026-08-25: C的简单单元测试。
* [backward-cpp](https://github.com/bombela/backward-cpp) ⭐ 4,298 | 🐛 126 | 🌐 C++ | 📅 2025-04-14: C++的漂亮堆栈轨迹打印机。
...
* [CppUTest](https://github.com/cpputest/cpputest) ⭐ 1,481 | 🐛 190 | 🌐 C++ | 📅 2026-07-30: C/C++的单元测试和模拟框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,567 | 🐛 18,823 | 🌐 C++ | 📅 2026-09-03: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,575 | 🐛 19 | 🌐 C | 📅 2026-09-03: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,078 | 🐛 11 | 🌐 C++ | 📅 2026-09-02: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,218 | 🐛 368 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
...
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,855 | 🐛 47 | 🌐 C | 📅 2026-09-03: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,553 | 🐛 294 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
...
* [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,021 | 🐛 21 | 🌐 C++ | 📅 2023-09-21: 高速的C++17 Vulkan游戏引擎。
* [Corange](https://github.com/orangeduck/Corange) ⭐ 1,988 | 🐛 22 | 🌐 C | 📅 2024-06-03: 用纯C、SDL、OpenGL编写的游戏引擎。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 76,049 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-03: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,373 | 🐛 319 | 🌐 C | 📅 2026-09-02: 单个头文件的ANSI C gui库。
...
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,405 | 🐛 57 | 🌐 C++ | 📅 2026-08-29: 进化的HTML/CSS用户界面库，libRocket的分支。
* [Elements](https://github.com/cycfi/elements) ⭐ 3,718 | 🐛 41 | 🌐 C++ | 📅 2026-06-13: 轻量级、细粒度、分辨率无关的模块化GUI库。
* [Yue](https://github.com/yue/yue) ⭐ 3,612 | 🐛 13 | 🌐 C++ | 📅 2025-01-24: 创建本机跨平台GUI应用的库。
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,685 | 🐛 8 | 🌐 C++ | 📅 2026-09-03: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,813 | 🐛 92 | 🌐 C++ | 📅 2026-09-02: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,455 | 🐛 287 | 🌐 C++ | 📅 2026-09-03: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,309 | 🐛 766 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,175 | 🐛 535 | 🌐 C++ | 📅 2026-09-03: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,913 | 🐛 50 | 🌐 C++ | 📅 2026-09-04 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,704 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,204 | 🐛 76 | 🌐 C++ | 📅 2026-08-23: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,081 | 🐛 157 | 🌐 C++ | 📅 2026-09-02: 简单的C++几何处理库。
* [urho3d](https://github.com/urho3d/Urho3D) ⚠️ Archived 跨平台的渲染和游戏引擎。
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,425 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-01: 现代、跨平台、低阶的3D图形库。
...
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,984 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,922 | 🐛 2 | 🌐 C++ | 📅 2026-09-02: 用于实时图形应用开发的现代C++14库。
* [herebedragons](https://github.com/kosua20/herebedragons) ⭐ 1,795 | 🐛 3 | 🌐 C | 📅 2025-07-11: 使用各种引擎、框架或者API实现的基本3D场景。
* [Horde3D](https://github.com/horde3d/Horde3D) ⭐ 1,586 | 🐛 22 | 🌐 C++ | 📅 2026-07-30 一个小型的3D渲染和动画引擎。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,585 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,436 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,783 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: 用于图像中人脸检测的开源库，其人脸检测的速度能达到1500FPS。
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,415 | 🐛 16 | 🌐 C | 📅 2026-08-27: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,354 | 🐛 183 | 🌐 C++ | 📅 2026-09-02: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,266 | 🐛 25 | 🌐 C++ | 📅 2026-09-03: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,078 | 🐛 68 | 🌐 C | 📅 2026-09-02: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
...
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,294 | 🐛 35 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,290 | 🐛 1,350 | 🌐 C++ | 📅 2026-09-03: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,171 | 🐛 325 | 🌐 C++ | 📅 2026-09-03: 快速的数据交换格式和基于功能的RPC系统。
...
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,191 | 🐛 150 | 🌐 C++ | 📅 2026-09-03: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,525 | 🐛 144 | 🌐 C++ | 📅 2026-09-03: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,235 | 🐛 132 | 🌐 C++ | 📅 2026-09-03: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,121 | 🐛 792 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,970 | 🐛 359 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,887 | 🐛 111 | 🌐 C++ | 📅 2026-08-20: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,183 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,360 | 🐛 128 | 🌐 C | 📅 2026-07-09: 进行编解码和处理Json数据的C语言库。
...
* [LIBUCL](https://github.com/vstakhov/libucl) ⭐ 1,743 | 🐛 115 | 🌐 C | 📅 2026-08-24: 通用配置库解析器。
* [parson](https://github.com/kgabis/parson) ⭐ 1,467 | 🐛 29 | 🌐 C | 📅 2024-05-11: 用C编写的轻量级的JSON库。
* [json-parser](https://github.com/udp/json-parser) ⭐ 1,337 | 🐛 34 | 🌐 C | 📅 2026-09-04: 用可移植的ANSI C编写的JSON解析器，占用内存非常少。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,568 | 🐛 51 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,017 | 🐛 7 | 🌐 C++ | 📅 2026-08-31: 异步、跨平台、低时延的日志库。
...
* [G3log](https://github.com/KjellKod/g3log) ⭐ 961 | 🐛 1 | 🌐 C++ | 📅 2026-09-01: 具有动态接收模块的异步记录器。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,708 | 🐛 2,763 | 🌐 C++ | 📅 2026-09-03: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,553 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,730 | 🐛 428 | 🌐 C++ | 📅 2026-09-03: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,242 | 🐛 80 | 🌐 C++ | 📅 2026-09-03: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
* [flashlight](https://github.com/facebookresearch/flashlight) ⭐ 5,467 | 🐛 126 | 🌐 C++ | 📅 2026-06-22: 来自Facebook AI研究中心的快速、灵活的机器学习库，其完全用C++编写，基于ArrayFire张量库。
* [libsvm](https://github.com/cjlin1/libsvm) ⭐ 4,709 | 🐛 112 | 🌐 Java | 📅 2025-12-29: 支持向量机的简单、易用、高效的库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,436 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,198 | 🐛 126 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,573 | 🐛 54 | 🌐 C++ | 📅 2026-09-03v: 用于计量金融的免费/开源库。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,569 | 🐛 113 | 🌐 C | 📅 2026-09-03: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,031 | 🐛 682 | 🌐 C++ | 📅 2026-09-03: 高效，可靠的几何算法集合。
...
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,406 | 🐛 253 | 🌐 C++ | 📅 2026-09-01: 快速符号处理库，用C++重写了SymPy的核心。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,347 | 🐛 307 | 🌐 C | 📅 2026-09-03: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,092 | 🐛 365 | 🌐 C | 📅 2026-09-02: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,449 | 🐛 40 | 🌐 C++ | 📅 2026-08-30: 用于读取和编辑几种流行音频格式的元数据的库。
...
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 791 | 🐛 350 | 🌐 C++ | 📅 2026-08-28: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,808 | 🐛 2 | 🌐 C++ | 📅 2026-09-03: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,229 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,025 | 🐛 0 | 🌐 C | 📅 2026-09-03<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,540 | 🐛 732 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-09-03: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
...
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,424 | 🐛 87 | 🌐 C++ | 📅 2026-08-28: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,323 | 🐛 229 | 🌐 C | 📅 2026-09-03: 提供客户端和服务器库的轻量级纯C WebSocket实现。
...
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,406 | 🐛 24 | 🌐 C | 📅 2026-09-03: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [ENet](https://github.com/lsalzman/enet) ⭐ 3,260 | 🐛 98 | 🌐 C | 📅 2026-06-23: 可靠的UDP网络库。
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,166 | 🐛 178 | 🌐 C | 📅 2026-09-02: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,133 | 🐛 59 | 🌐 C++ | 📅 2026-09-03: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,093 | 🐛 48 | 🌐 C++ | 📅 2026-09-03: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,965 | 🐛 44 | 🌐 C | 📅 2026-08-31: 高速打包处理框架。
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,041 | 🐛 584 | 🌐 C | 📅 2026-09-01: 用于C和C++的Apache Kafka客户端库。
...
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 3,011 | 🐛 21 | 🌐 C++ | 📅 2026-09-03: 开源的多物理场仿真引擎。
...
* [Chipmunk](https://github.com/slembcke/Chipmunk2D) ⭐ 2,404 | 🐛 69 | 🌐 C | 📅 2026-05-05: 快速、轻量级的2D游戏物理库。
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,253 | 🐛 469 | 🌐 C++ | 📅 2026-09-03: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,182 | 🐛 16 | 🌐 C++ | 📅 2026-09-02: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
...
* [RE2](https://github.com/google/re2) ⭐ 9,793 | 🐛 63 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,105 | 🐛 580 | 🌐 C++ | 📅 2026-08-29: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,421 | 🐛 332 | 🌐 C++ | 📅 2026-09-03: 高性能的PDE解算器。
...
* [Cython](https://github.com/cython/cython) ⭐ 10,842 | 🐛 1,518 | 🌐 Cython | 📅 2026-09-03: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
* [ChakraCore](https://github.com/Microsoft/ChakraCore) ⭐ 9,257 | 🐛 615 | 🌐 JavaScript | 📅 2026-02-19: Microsoft的JavaScript引擎，可以嵌入到nodejs中。
* [Duktape](https://github.com/svaarala/duktape) ⭐ 6,208 | 🐛 474 | 🌐 JavaScript | 📅 2024-03-22: 具有紧凑脚本的嵌入式Javascript引擎。
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,134 | 🐛 308 | 🌐 C++ | 📅 2025-03-07: 具有高级功能和一流性能的C++ <-> Lua API封装器。
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,707 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,362 | 🐛 198 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
* [CppSharp](https://github.com/mono/CppSharp) ⭐ 3,407 | 🐛 346 | 🌐 C# | 📅 2026-05-18: 用于将C / C++ API融合到高级语言中的工具和库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,425 | 🐛 278 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
...
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,347 | 🐛 104 | 📅 2026-08-25: C/C++的高效二进制序列化库，例如 JSON。
...
* [mrpt-serialization](https://github.com/mrpt/mrpt/) ⭐ 2,159 | 🐛 34 | 🌐 C++ | 📅 2026-09-03: 已版本控制的二进制或文本格式的序列化。
...
* [pdqsort](https://github.com/orlp/pdqsort) ⭐ 2,506 | 🐛 5 | 🌐 C++ | 📅 2023-12-06: 破坏模式的快速排序。
* [Timsort](https://github.com/gfx/cpp-TimSort) ⭐ 317 | 🐛 2 | 🌐 C++ | 📅 2024-12-03: 模板化的稳定排序功能，其性能优于基于快速排序的算法（包括std: : sort），用于反向或半排序数据。

### 视频

* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,142 | 🐛 306 | 🌐 C++ | 📅 2026-09-03: 开源H.364 编解码器。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,040 | 🐛 1,532 | 🌐 C | 📅 2026-09-03: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,240 | 🐛 425 | 🌐 C++ | 📅 2026-09-03: 基于C++ 14/17的高性能HTTP应用程序框架。
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,651 | 🐛 348 | 🌐 C++ | 📅 2025-11-12: 轻量、零依赖的框架，可创建高性能的Web服务。
...
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,034 | 🐛 49 | 🌐 C | 📅 2026-08-27: 实验性、可扩展的高性能HTTP服务器。
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,445 | 🐛 243 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,795 | 🐛 123 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
* [Mini-XML](https://github.com/michaelrsweet/mxml) ⭐ 518 | 🐛 3 | 🌐 C | 📅 2026-09-01: 用ANSI C编写的小型XML解析库。
* [Boost.PropertyTree](http://www.boost.org/doc/libs/1_55_0/doc/html/property_tree.html): 属性树解析器/生成器，可用于解析XML / JSON / INI / Info文件。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,585 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,083 | 🐛 0 | 🌐 Java | 📅 2026-09-01: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 25,097 | 🐛 13 | 🌐 C++ | 📅 2026-09-02: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 25,097 | 🐛 13 | 🌐 C++ | 📅 2026-09-02: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,554 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
* [Klib](https://github.com/attractivechaos/klib) ⭐ 4,717 | 🐛 94 | 🌐 C | 📅 2025-12-22: 通用算法和数据结构的小型、轻量级实现。
...
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,154 | 🐛 5 | 🌐 C++ | 📅 2026-08-17: 解析表达语法模板库。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,431 | 🐛 1,185 | 🌐 CMake | 📅 2026-09-03: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,466 | 🐛 0 | 🌐 Rust | 📅 2026-09-03: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,698 | 🐛 204 | 🌐 OCaml | 📅 2026-09-03: 用于Java、C和Objective-C的静态分析器。
* [IKOS](https://github.com/NASA-SW-VnV/ikos) ⭐ 3,163 | 🐛 50 | 🌐 C++ | 📅 2026-05-31: 基于抽象解释理论的C / C++静态分析器。
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,846 | 🐛 84 | 🌐 Python | 📅 2026-09-02: 遵循Google C++样式指南的C++样式检查器。
