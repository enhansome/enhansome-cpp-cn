...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,759 | 🐛 312 | 📅 2026-08-04 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,078 | 🐛 229 | 🌐 C++ | 📅 2026-08-14: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,492 | 🐛 459 | 🌐 C++ | 📅 2026-08-13: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,778 | 🐛 471 | 🌐 C++ | 📅 2026-08-13: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,091 | 🐛 68 | 🌐 C++ | 📅 2026-08-13: 嵌入式模板库。
- [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus) ⭐ 2,292 | 🐛 0 | 🌐 C++ | 📅 2026-07-15: C++ 的函数式编程库，编写简洁易读的C++代码。
- [BDE](https://github.com/bloomberg/bde) ⭐ 1,837 | 🐛 15 | 🌐 C++ | 📅 2026-08-07: 来自于彭博资讯实验室的开发环境。
...
* [ANNetGPGPU](https://github.com/ANNetGPGPU/ANNetGPGPU) ⭐ 114 | 🐛 4 | 🌐 C++ | 📅 2021-09-25: 基于GPU(CUDA)的人工神经网络库。

- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,006 | 🐛 2,862 | 🌐 C++ | 📅 2026-08-14: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,359 | 🐛 17,236 | 🌐 Python | 📅 2026-08-14: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,454 | 🐛 261 | 🌐 Shell | 📅 2025-09-22: 语音识别工具包。
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,858 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 6,161 | 🐛 985 | 🌐 C++ | 📅 2026-07-18: 用于网络和底层I/O编程的跨平台 C++ 库，使用现代 C++ 方法为开发者提供一致的异步模型。

- [libhv](https://github.com/ithewei/libhv) ⭐ 7,536 | 🐛 40 | 🌐 C | 📅 2026-08-06: 跨平台的事件循环库。
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,430 | 🐛 57 | 🌐 C++ | 📅 2026-08-12: C++中Actor Model的开源实现。
- [libuv](https://github.com/joyent/libuv) ⚠️ Archived: 跨平台异步I/O。
- [uvw](https://github.com/skypjack/uvw) ⭐ 2,052 | 🐛 13 | 🌐 C++ | 📅 2025-12-17: libuv的C++封装器。
...
* [AudioFile](https://github.com/adamstark/AudioFile) ⭐ 1,145 | 🐛 3 | 🌐 C++ | 📅 2025-10-15: 用于读写音频文件的简单C++库。

- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,132 | 🐛 5 | 🌐 C | 📅 2026-08-03: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,146 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
- [libsoundio](https://github.com/andrewrk/libsoundio) ⭐ 2,100 | 🐛 137 | 🌐 C | 📅 2025-01-13: 用于跨平台实时音频输入输出的C库。
- [minimp3](https://github.com/lieff/minimp3) ⭐ 1,938 | 🐛 54 | 🌐 C | 📅 2026-07-27: 公共域，无尘室实现的MP3解码器，只有头文件。
- [libsndfile](https://github.com/erikd/libsndfile/) ⭐ 1,709 | 🐛 217 | 🌐 C | 📅 2026-08-01: C++封装的C库，用于通过标准库接口读写包含采样声音的文件。
- [Maximilian](https://github.com/micknoise/Maximilian) ⭐ 1,700 | 🐛 32 | 🌐 C++ | 📅 2025-01-04: C++音频和音乐数字信号处理库。
- [Verovio](https://github.com/rism-ch/verovio) ⭐ 910 | 🐛 190 | 🌐 C++ | 📅 2026-08-02: 快速、轻量级的音乐符号雕刻库。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,015 | 🐛 251 | 🌐 C++ | 📅 2026-08-14(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
* [libutp](https://github.com/bittorrent/libutp) ⭐ 1,159 | 🐛 47 | 🌐 C++ | 📅 2023-10-19: uTorrent传输协议库。
* [LibTorrent](https://github.com/rakshasa/libtorrent) ⭐ 998 | 🐛 59 | 🌐 C++ | 📅 2026-08-13 (a.k.a. libtorrent-rakshasa): 比特流库。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,016 | 🐛 94 | 🌐 C++ | 📅 2026-08-12: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 950 | 🐛 0 | 🌐 C++ | 📅 2026-08-12: 传递消息的并行分子动力学实现。
* [Reaktoro](https://github.com/reaktoro/reaktoro) ⭐ 216 | 🐛 34 | 🌐 C++ | 📅 2026-02-02: C++和python中用于对化学反应系统进行建模的计算框架。
* [d-SEAMS](https://github.com/d-SEAMS/seams-core) ⭐ 42 | 🐛 17 | 🌐 C++ | 📅 2026-05-28: 具有Nix的C++和Lua实现的分子动力学轨道分析引擎，它是分子模拟的递延结构分析的首字母缩写。

### 命令行界面

控制台/终端用户界面，命令行界面

* [jarro2783/cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,798 | 🐛 70 | 🌐 C++ | 📅 2026-07-13: 轻量级的C++命令行选项解析器。
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,412 | 🐛 75 | 🌐 C++ | 📅 2026-08-09: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
* [linenoise](https://github.com/antirez/linenoise) ⭐ 4,335 | 🐛 154 | 🌐 C | 📅 2026-05-02: readline和libedit的独立小选择。
...
* [Taywee / args](https://github.com/taywee/args) ⭐ 1,630 | 🐛 14 | 🌐 C++ | 📅 2026-08-03: 简单的只有头文件的C++参数解析库。
* [Argh!](https://github.com/adishavit/argh) ⭐ 1,445 | 🐛 24 | 🌐 C++ | 📅 2025-01-21: 极简的只有头文件的参数处理程序。
* [cli](https://github.com/daniele77/cli) ⭐ 1,357 | 🐛 39 | 🌐 C++ | 📅 2025-12-22: 用于交互式命令行界面的跨平台的C++14库，只有头文件。
* [PDCurses](https://github.com/wmcbrine/PDCurses) ⭐ 1,242 | 🐛 44 | 🌐 C | 📅 2026-01-10: 具有源代码和预编译库的公共域curses库。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,840 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-11: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 849 | 🐛 41 | 🌐 C++ | 📅 2026-08-09: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,547 | 🐛 338 | 🌐 C | 📅 2026-08-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,592 | 🐛 597 | 🌐 C | 📅 2026-08-12: 多格式的存档和压缩库。
...
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,478 | 🐛 15 | 🌐 C | 📅 2026-08-07: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
- [smaz](https://github.com/antirez/smaz) ⭐ 1,219 | 🐛 13 | 🌐 C | 📅 2019-10-25: 小型字符压缩库。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,441 | 🐛 76 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,107 | 🐛 33 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 4,994 | 🐛 396 | 🌐 C++ | 📅 2026-08-13: 用于集体多GPU通信的优化基元。
- [readerwriterqueue](https://github.com/cameron314/readerwriterqueue) ⭐ 4,608 | 🐛 21 | 🌐 C++ | 📅 2026-03-28: C++的快速单生产者、单消费者的无锁队列。
- [libmill](https://github.com/sustrik/libmill/) ⭐ 3,174 | 🐛 22 | 🌐 C | 📅 2021-02-09: 在C中引入结构并发性。
- [libmill](https://github.com/sustrik/libmill/) ⭐ 3,174 | 🐛 22 | 🌐 C | 📅 2021-02-09: 在C中引入Go-style并发性。
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,884 | 🐛 140 | 🌐 C++ | 📅 2026-08-13: 适用于任何规模的并行分布式应用的通用C++运行时系统。
- [libcds](https://github.com/khizmax/libcds) ⭐ 2,744 | 🐛 55 | 🌐 C++ | 📅 2023-10-17: 并行数据结构的C++库。
- [ck](https://github.com/concurrencykit/ck) ⭐ 2,688 | 🐛 8 | 🌐 C | 📅 2026-08-10: 并发基元，安全内存回收机制和非阻塞数据结构。
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,642 | 🐛 610 | 🌐 C++ | 📅 2026-08-13: 用于并行运行和内存抽象的便携式编程模型。
- [libdispatch](https://github.com/apple/swift-corelibs-libdispatch) ⭐ 2,597 | 🐛 116 | 🌐 C | 📅 2026-08-12: Apple公司开发的Grand Central Dispatch（GCD）是基于线程池模式的任务并行技术。libdispatch库提供了GCD服务的实现。
- [marl](https://github.com/google/marl) ⚠️ Archived: Marl是用C++11编写的混合线程/纤程的任务调度程序。
- [moderngpu](https://github.com/moderngpu/moderngpu) ⭐ 1,788 | 🐛 12 | 🌐 C++ | 📅 2026-01-17: moderngpu是用于GPUs通用计算的生产力库，它只有为CUDA编写的C++头文件。该库的独特价值在于其用于解决不规则并行问题的加速基元。
- [Boost.Compute](https://github.com/kylelutz/compute) ⭐ 1,661 | 🐛 157 | 🌐 C++ | 📅 2026-08-12: 用于OpenCL的C++GPU计算库。
- [junction](https://github.com/preshing/junction) ⭐ 1,458 | 🐛 17 | 🌐 C++ | 📅 2026-05-16: 并发数据结构的C++库。
- [stdgpu](https://github.com/stotko/stdgpu) ⭐ 1,266 | 🐛 12 | 🌐 C++ | 📅 2026-07-08: GPU上高效的类似STL的数据结构。
- [C++React](https://github.com/schlangster/cpp.react) ⭐ 1,043 | 🐛 19 | 🌐 C++ | 📅 2021-05-17: 用于C++11的反应性编程库。
- [FiberTaskingLib](https://github.com/RichieSams/FiberTaskingLib) ⭐ 983 | 🐛 17 | 🌐 C++ | 📅 2025-03-21: 基于任务的多线程库，支持具有任意依赖关系的任务图表。
- [cuda-api-wrappers](https://github.com/eyalroz/cuda-api-wrappers) ⭐ 902 | 🐛 117 | 🌐 C++ | 📅 2026-07-16: 轻量级的现代C++封装器，用于CUDA GPU的运行时API编程。
- [Intel Parallel STL](https://github.com/intel/parallelstl) ⭐ 776 | 🐛 215 | 🌐 C++ | 📅 2026-08-13: C++ 17 STL的英特尔实现，适用于C++11及更高版本。
...
- [Quantum](https://github.com/bloomberg/quantum) ⭐ 637 | 🐛 7 | 🌐 C++ | 📅 2026-04-08: 建立在[boost::coroutines2](https://www.boost.org/doc/libs/1_65_0/libs/coroutine2/doc/html/index.html)顶层的强大的C++协同调度程序框架。
- [transwarp](https://github.com/bloomen/transwarp) ⭐ 633 | 🐛 2 | 🌐 C++ | 📅 2023-05-18: 任务并发性的C++库，只有头文件。
- [SObjectizer](https://github.com/Stiffstream/sobjectizer) ⭐ 619 | 🐛 13 | 🌐 C++ | 📅 2026-08-04: 实现Actor、Publish-Subscribe和CSP模式的相当小的C++框架。
...
* [inih](https://github.com/benhoyt/inih) ⭐ 3,030 | 🐛 5 | 🌐 C++ | 📅 2026-01-30: C语言的简单.INI文件解析器，很适合嵌入式系统。

* [toml++](https://github.com/marzer/tomlplusplus) ⭐ 2,123 | 🐛 26 | 🌐 C++ | 📅 2026-07-21: TOML解析器和串化器，适用于C++17及更高版本，只有头文件。

* [simpleini](https://github.com/brofield/simpleini) ⭐ 1,319 | 🐛 1 | 🌐 C++ | 📅 2026-06-19: 跨平台的C++库，提供用于读写INI配置文件的简单API。

* [libconfig](https://github.com/hyperrealm/libconfig) ⭐ 1,223 | 🐛 39 | 🌐 C | 📅 2026-02-09: 用于处理结构化配置文件的C、C++库。

* [iniparser](https://github.com/ndevilla/iniparser) ⭐ 1,069 | 🐛 6 | 🌐 C | 📅 2026-07-19: INI文件解析器。

* [libconfuse](https://github.com/martinh/libconfuse) ⭐ 516 | 🐛 7 | 🌐 C | 📅 2026-08-01: C的小型配置文件解析库。

* [inih](https://github.com/jtilly/inih) ⭐ 450 | 🐛 0 | 🌐 C++ | 📅 2024-09-18: [inih](https://github.com/benhoyt/inih) ⭐ 3,030 | 🐛 5 | 🌐 C++ | 📅 2026-01-30的C++版本，只有头文件。

### 容器

* [robin-hood-hashing](https://github.com/martinus/robin-hood-hashing) ⚠️ Archived: 用于C++1的快速、节约内存的哈希表，基于robin hood哈希算法。
* [robin-map](https://github.com/Tessil/robin-map) ⭐ 1,499 | 🐛 17 | 🌐 C++ | 📅 2026-06-13: 使用robin hood哈希算法的哈希映射和哈希集。
...
* [Hopscotch map](https://github.com/Tessil/hopscotch-map) ⭐ 848 | 🐛 7 | 🌐 C++ | 📅 2025-11-02: 使用hopscotch哈希算法来实现冲突解决的快速哈希映射，只有头文件。
* [Colony](https://github.com/mattreecebentley/plf_colony) ⭐ 502 | 🐛 0 | 🌐 C++ | 📅 2026-07-31: 无序的”bag“型容器，在高度修改的情况下，其性能优于标准容器。同时，无论插入还是擦除，其都能始终保持指向未擦除元素的永久指针。
...
* [plf::list](https://github.com/mattreecebentley/plf_list) ⭐ 175 | 🐛 0 | 🌐 C++ | 📅 2026-07-31: std::list实现，其清除范围拼接以启用缓存友好的结构，从而显著提高性能。
* [ring\_span lite](https://github.com/martinmoene/ring-span-lite) ⭐ 168 | 🐛 7 | 🌐 C++ | 📅 2025-11-28: Arthur O'Dwyer的ring\_span的简化实现，例如循环缓冲视图。
* [plf::stack](https://github.com/mattreecebentley/plf_stack) ⭐ 78 | 🐛 0 | 🌐 C++ | 📅 2026-07-31: std::stack容器适配器的替换容器，其在堆栈上下文中比任何标准容器都有更好的性能。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,759 | 🐛 312 | 📅 2026-08-04: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,886 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,869 | 🐛 1,731 | 🌐 C | 📅 2026-08-13: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,996 | 🐛 34 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,750 | 🐛 301 | 🌐 C | 📅 2026-08-14: TLS/SSL协议的实现。
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,971 | 🐛 31 | 🌐 C | 📅 2026-04-24: 用于无痛数据安全的加密库，为移动和服务器平台提供对称和非对称加密，具有向前保密性的安全套接字。
* [LibTomCrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,784 | 🐛 49 | 🌐 C | 📅 2026-08-08: 相当全面、模块化和可移植的加密工具包。
* [sha1collisiondetection](https://github.com/cr-marcstevens/sha1collisiondetection) ⭐ 1,411 | 🐛 17 | 🌐 C | 📅 2025-10-30: 用于检测文件中SHA-1冲突的库和命令行工具。
* [libhydrogen](https://github.com/jedisct1/libhydrogen) ⭐ 779 | 🐛 1 | 🌐 C | 📅 2026-06-08: 轻量级、安全、易于使用的加密库，适用于受限的环境。
...
* [Vince's CSV Parser](https://github.com/vincentlaucsb/csv-parser) ⭐ 1,117 | 🐛 3 | 🌐 C++ | 📅 2026-08-06: 快速、独立、流式的C++17 CSV解析器，具有可选的类型转换和统计信息。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,325 | 🐛 401 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 31,971 | 🐛 1,606 | 🌐 C++ | 📅 2026-08-13: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,678 | 🐛 72 | 🌐 C | 📅 2026-08-10: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,766 | 🐛 93 | 🌐 C | 📅 2026-07-24: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
* [sqlite\_orm](https://github.com/fnc12/sqlite_orm) ⭐ 2,688 | 🐛 19 | 🌐 C++ | 📅 2026-08-13: 适用于现代C++的SQLite ORM轻量库，只有头文件。
...
* [SOCI](https://github.com/SOCI/soci) ⭐ 1,615 | 🐛 140 | 🌐 C++ | 📅 2026-08-11: C++的数据库抽象层。
* [MongoDB C++ Driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,104 | 🐛 4 | 🌐 C++ | 📅 2026-08-13: MongDB的C++驱动程序。
* [sqlite\_modern\_cpp](https://github.com/SqliteModernCpp/sqlite_modern_cpp) ⭐ 948 | 🐛 43 | 🌐 C++ | 📅 2024-07-23: sqlite库的C++14封装器，只有头文件。
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 880 | 🐛 5 | 🌐 C | 📅 2026-08-13: C的MongoDB客户端库。
* [hiberlite](https://github.com/paulftw/hiberlite) ⭐ 723 | 🐛 14 | 🌐 C++ | 📅 2023-07-24: 用于Sqlite3的C++对象关系映射。
* [SimDB](https://github.com/LiveAsynchronousVisualizedArchitecture/simdb) ⭐ 558 | 🐛 8 | 🌐 C++ | 📅 2024-01-05: 高性能、共享内存、无锁、跨平台、单文件、最小依赖的C++11键值存储。
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 384 | 🐛 66 | 🌐 C++ | 📅 2025-12-28: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,924 | 🐛 488 | 🌐 C++ | 📅 2026-08-13: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,924 | 🐛 488 | 🌐 C++ | 📅 2026-08-13: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,428 | 🐛 440 | 🌐 C++ | 📅 2026-08-10: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,428 | 🐛 440 | 🌐 C++ | 📅 2026-08-10: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,349 | 🐛 175 | 🌐 C++ | 📅 2026-08-12: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,843 | 🐛 136 | 🌐 C++ | 📅 2026-07-12: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,344 | 🐛 87 | 🌐 C | 📅 2026-07-21: C的简单单元测试。
...
* [dbg-macro](https://github.com/sharkdp/dbg-macro) ⭐ 3,231 | 🐛 9 | 🌐 C++ | 📅 2026-02-14: C++的dbg（……）宏。
* [CppUTest](https://github.com/cpputest/cpputest) ⭐ 1,480 | 🐛 191 | 🌐 C++ | 📅 2026-07-30: C/C++的单元测试和模拟框架。
* [μt](https://github.com/boost-experimental/ut) ⭐ 1,437 | 🐛 97 | 🌐 C++ | 📅 2026-02-14: C++20的单头文件/单模块、无宏的μ（微型）/单元测试框架。
* [check](https://github.com/libcheck/check) ⭐ 1,173 | 🐛 104 | 🌐 C | 📅 2026-07-13: C的单元测试框架。
* [utest.h](https://github.com/sheredom/utest.h) ⭐ 987 | 🐛 13 | 🌐 C++ | 📅 2026-07-21: C和C++的单个头文件测试框架。
* [fff](https://github.com/meekrosoft/fff) ⭐ 931 | 🐛 59 | 🌐 C | 📅 2023-11-02: 创建伪C函数的微框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 115,672 | 🐛 18,647 | 🌐 C++ | 📅 2026-08-13: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,302 | 🐛 28 | 🌐 C | 📅 2026-08-13: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,010 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,203 | 🐛 366 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,893 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
* [PixelGameEngine](https://github.com/OneLoneCoder/olcPixelGameEngine) ⭐ 4,223 | 🐛 140 | 🌐 C++ | 📅 2025-09-26: olcPixelGameEngine的官方发行版，该工具用于javidx9的YouTube视频和项目。
* [Spring](https://github.com/spring/spring) ⭐ 3,962 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,854 | 🐛 47 | 🌐 C | 📅 2026-08-13: 用C++14编写的轻量级游戏引擎，带有“真实的”实体组件系统。
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,537 | 🐛 292 | 🌐 C++ | 📅 2026-07-30: 在S.T.A.L.K.E.R.游戏系列中使用的社群修改的X射线引擎。
* [Torque3D](https://github.com/GarageGames/Torque3D) ⭐ 3,362 | 🐛 372 | 🌐 C++ | 📅 2022-04-03: 为3D游戏开发构建的开源C++引擎。
* [KlayGE](https://github.com/gongminmin/KlayGE) ⭐ 2,176 | 🐛 41 | 🌐 C++ | 📅 2026-07-17: 具有基于插件架构的跨平台、开源的游戏引擎。
* [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,015 | 🐛 21 | 🌐 C++ | 📅 2023-09-21: 高速的C++17 Vulkan游戏引擎。
...
* [Crown](https://github.com/dbartolini/crown) ⭐ 29 | 🐛 0 | 🌐 C++ | 📅 2026-08-10: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,644 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-07: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,321 | 🐛 315 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
* [libui](https://github.com/andlabs/libui) ⭐ 10,894 | 🐛 249 | 🌐 C | 📅 2024-05-29: C中简单、可移植（但是不灵活）的GUI库，使用其支持的每一种平台的本机GUI技术。
* [implot](https://github.com/epezent/implot) ⭐ 6,186 | 🐛 128 | 🌐 C++ | 📅 2026-08-06: imgui的即时模式绘图控件。
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,346 | 🐛 62 | 🌐 C++ | 📅 2026-08-07: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,678 | 🐛 9 | 🌐 C++ | 📅 2026-08-09: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
* [NanoGui](https://github.com/mitsuba-renderer/nanogui) ⭐ 1,807 | 🐛 93 | 🌐 C++ | 📅 2026-07-29: 简约、跨平台的控件库，用于OpenGL 3.x及更高版本。
* [Boden](https://github.com/AshampooSystems/boden) ⭐ 1,745 | 🐛 29 | 🌐 C++ | 📅 2021-12-17: 本机、移动、跨平台的GUI框架。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,396 | 🐛 288 | 🌐 C | 📅 2026-08-14: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,252 | 🐛 760 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,133 | 🐛 525 | 🌐 C++ | 📅 2026-08-13: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,875 | 🐛 51 | 🌐 C++ | 📅 2026-08-13 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,685 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,187 | 🐛 77 | 🌐 C++ | 📅 2026-08-06: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
* [libigl](https://github.com/libigl/libigl) ⭐ 5,068 | 🐛 155 | 🌐 C++ | 📅 2026-08-04: 简单的C++几何处理库。
* [urho3d](https://github.com/urho3d/Urho3D) ⚠️ Archived 跨平台的渲染和游戏引擎。
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,388 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-12: 现代、跨平台、低阶的3D图形库。
* [OpenSubdiv](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,069 | 🐛 62 | 🌐 C++ | 📅 2026-07-17: Pixar的库，用于评估和渲染CPU和GPU上的细分曲面。
* [Yocto/GL](https://github.com/xelatihy/yocto-gl) ⭐ 2,921 | 🐛 14 | 🌐 C++ | 📅 2024-02-21: 用于数据驱动的基于物理图形的微型C++库。
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,847 | 🐛 33 | 🌐 C++ | 📅 2026-08-10: 用于在C++中编写DirectX 11.x代码的帮助类的集合。
* [LLGL](https://github.com/LukasBanana/LLGL) ⭐ 2,614 | 🐛 12 | 🌐 C++ | 📅 2026-08-13: 低水平图形库（LLGL）是现代图形API的薄抽象层。
* [Blend2D](https://github.com/blend2d/blend2d) ⭐ 1,968 | 🐛 39 | 🌐 C++ | 📅 2025-11-29: 由JIT编译器提供技术支持的2D矢量图形引擎。
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,920 | 🐛 2 | 🌐 C++ | 📅 2026-08-13: 用于实时图形应用开发的现代C++14库。
...
* [Partio](https://github.com/wdas/partio) ⭐ 495 | 🐛 3 | 🌐 C | 📅 2026-04-22: 用于处理粒子数据的库，支持大多数常见文件形式。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,395 | 🐛 418 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,777 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: 用于图像中人脸检测的开源库，其人脸检测的速度能达到1500FPS。
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,383 | 🐛 16 | 🌐 C | 📅 2026-08-05: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,344 | 🐛 184 | 🌐 C++ | 📅 2026-08-13: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,262 | 🐛 27 | 🌐 C++ | 📅 2026-08-13: 使用SIMD的C++图像处理库: SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM。
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,071 | 🐛 69 | 🌐 C | 📅 2026-08-04: Leptonica是一个包含软件的开源库，其广泛应用于图像处理和图形分析应用程序。
* [GD](https://github.com/libgd/libgd) ⭐ 983 | 🐛 107 | 🌐 C | 📅 2026-08-06: GD图形库，有名的用于PHP中图形加载/操作和缩略图生成。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,972 | 🐛 10 | 🌐 C++ | 📅 2026-08-09: C和C++的单个头文件的utf8字符串函数。
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,286 | 🐛 30 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,282 | 🐛 1,378 | 🌐 C++ | 📅 2026-08-13: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,159 | 🐛 330 | 🌐 C++ | 📅 2026-08-13: 快速的数据交换格式和基于功能的RPC系统。
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,292 | 🐛 0 | 🌐 C | 📅 2026-08-02: 好几个“可扩展协议”的简单高性能实现。
* [nng](https://github.com/nanomsg/nng) ⭐ 4,654 | 🐛 66 | 🌐 C | 📅 2026-08-02: nanomsg的下一代，轻量级、无代理消息的传递库。
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,188 | 🐛 166 | 🌐 C++ | 📅 2026-08-13: 全面的RPC框架，支持C++、C＃、Java、JavaScript、Python等。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,365 | 🐛 100 | 🌐 C++ | 📅 2026-08-13: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,148 | 🐛 135 | 🌐 C++ | 📅 2026-08-12: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,111 | 🐛 789 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,918 | 🐛 352 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
* [JsonCpp](https://github.com/open-source-parsers/jsoncpp) ⭐ 8,881 | 🐛 112 | 🌐 C++ | 📅 2026-07-29: 可与JSON交互的C++库。
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,168 | 🐛 98 | 🌐 C | 📅 2024-06-09: C语言中的简约JSON解析器。
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,355 | 🐛 127 | 🌐 C | 📅 2026-07-09: 进行编解码和处理Json数据的C语言库。
* [json-c](https://github.com/json-c/json-c) ⭐ 3,286 | 🐛 21 | 🌐 C | 📅 2026-08-04: C中的JSON实现。
...
* [LIBUCL](https://github.com/vstakhov/libucl) ⭐ 1,742 | 🐛 116 | 🌐 C | 📅 2026-06-20: 通用配置库解析器。
* [parson](https://github.com/kgabis/parson) ⭐ 1,466 | 🐛 29 | 🌐 C | 📅 2024-05-11: 用C编写的轻量级的JSON库。
...
* [jsoncons](https://github.com/danielaparker/jsoncons) ⭐ 850 | 🐛 17 | 🌐 C++ | 📅 2026-08-13: 使用JSONPointer、JSONPatch、JSONPath和JMESPath的JSON和类似JSON二进制格式的C++库，只有头文件。
* [json.h](https://github.com/sheredom/json.h) ⭐ 835 | 🐛 4 | 🌐 C | 📅 2026-07-20: 在C和C++中解析JSON的简单的单头文件/单源文件的解决方案。
* [frozen](https://github.com/cesanta/frozen) ⭐ 774 | 🐛 34 | 🌐 C | 📅 2026-01-05:  C/C++的Json解析生成器。
* [taoJSON](https://github.com/taocpp/json) ⭐ 677 | 🐛 5 | 🌐 C++ | 📅 2025-12-05: 零依赖的C++JSON库，只包含头文件。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,481 | 🐛 48 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 2,999 | 🐛 7 | 🌐 C++ | 📅 2026-08-11: 异步、跨平台、低时延的日志库。
* [plog](https://github.com/SergiusTheBest/plog) ⭐ 2,574 | 🐛 55 | 🌐 C++ | 📅 2026-08-07: C++可移植且简单的日志，少于1000行代码。
* [loguru](https://github.com/emilk/loguru) ⭐ 1,906 | 🐛 91 | 🌐 C++ | 📅 2026-07-31: 轻量级的C++日志库。
* [log4cplus](https://github.com/log4cplus/log4cplus) ⭐ 1,727 | 🐛 60 | 🌐 C++ | 📅 2026-07-11: 易于使用的C++日志API，可提供对日志管理和配置的线程安全、灵活且任意粒度的控制。
* [G3log](https://github.com/KjellKod/g3log) ⭐ 959 | 🐛 0 | 🌐 C++ | 📅 2026-08-10: 具有动态接收模块的异步记录器。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,416 | 🐛 2,752 | 🌐 C++ | 📅 2026-08-13: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,572 | 🐛 1,549 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,650 | 🐛 419 | 🌐 C++ | 📅 2026-08-13: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
* [darknet](https://github.com/pjreddie/darknet) ⭐ 26,490 | 🐛 1,975 | 🌐 C | 📅 2024-05-03: 用C和CUDA编写的开源神经网络框架。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++ 11的机器学习、计算机视觉、数值优化和深度学习的工具包。
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,237 | 🐛 80 | 🌐 C++ | 📅 2026-08-13: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [libsvm](https://github.com/cjlin1/libsvm) ⭐ 4,707 | 🐛 112 | 🌐 Java | 📅 2025-12-29: 支持向量机的简单、易用、高效的库。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 39 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,152 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,553 | 🐛 118 | 🌐 C | 📅 2026-08-13: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,508 | 🐛 47 | 🌐 C++ | 📅 2026-08-13v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,008 | 🐛 684 | 🌐 C++ | 📅 2026-08-12: 高效，可靠的几何算法集合。
* [xtensor](https://github.com/QuantStack/xtensor) ⭐ 3,760 | 🐛 428 | 🌐 C++ | 📅 2026-07-15: 受NumPy语法启发的C++ 14库，用于使用多维数组表达式进行数值分析。
* [autodiff](https://github.com/autodiff/autodiff) ⭐ 1,948 | 🐛 109 | 🌐 C++ | 📅 2025-01-27: 用于自动微分的现代、快速且富有表现力的C++库。
* [TinyExpr](https://github.com/codeplea/tinyexpr) ⭐ 1,914 | 🐛 0 | 🌐 C | 📅 2026-08-06: 用于解析和评估字符串中的数学表达式的C库。
* [Vc](https://github.com/VcDevel/Vc) ⭐ 1,540 | 🐛 88 | 🌐 C++ | 📅 2026-07-07: C++的SIMD矢量类。
* [SymEngine](https://github.com/symengine/symengine) ⭐ 1,400 | 🐛 258 | 🌐 C++ | 📅 2026-07-29: 快速符号处理库，用C++重写了SymPy的核心。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 500 | 🐛 22 | 🌐 C++ | 📅 2026-08-13: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,283 | 🐛 322 | 🌐 C | 📅 2026-08-14: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,039 | 🐛 362 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,521 | 🐛 190 | 🌐 C | 📅 2026-07-23: C和C++的保守的垃圾回收器。
...
* [memory](https://github.com/foonathan/memory) ⭐ 1,616 | 🐛 10 | 🌐 C++ | 📅 2025-05-29: 兼容STL的C++内存分配器库。
...
* [TagLib](https://github.com/taglib/taglib) ⭐ 1,444 | 🐛 42 | 🌐 C++ | 📅 2026-08-13: 用于读取和编辑几种流行音频格式的元数据的库。
* [libass](https://github.com/libass/libass) ⭐ 1,160 | 🐛 163 | 🌐 C | 📅 2026-08-10: ASS / SSA字幕格式的便携式字幕渲染器。
* [libass](https://github.com/libass/libass) ⭐ 1,160 | 🐛 163 | 🌐 C | 📅 2026-08-10: 处理多媒体内容（例如音频、视频、字幕和相关元数据）的库和工具的集合。
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 785 | 🐛 354 | 🌐 C++ | 📅 2026-06-21: 用于视频和音频文件中最相关的技术和标签数据的方便统一显示。
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,950 | 🐛 47 | 🌐 C++ | 📅 2026-07-31: µWS是最轻量级、高效和可伸缩的WebSocket和HTTP服务器的实现之一。
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,864 | 🐛 195 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,743 | 🐛 4 | 🌐 C++ | 📅 2026-08-09: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,225 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 12,990 | 🐛 4 | 🌐 C | 📅 2026-08-13<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,527 | 🐛 730 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-13: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
* [C++ REST SDK](https://github.com/Microsoft/cpprestsdk) ⚠️ Archived: C++ REST SDK（以前称为Casablanca）。
* [WebSocket++](https://github.com/zaphoyd/websocketpp) ⭐ 7,710 | 🐛 483 | 🌐 C++ | 📅 2026-05-04: 基于C++/Boost Aiso的websocket 客户端/服务器库。
* [cpr](https://github.com/whoshuu/cpr) ⭐ 7,402 | 🐛 87 | 🌐 C++ | 📅 2026-07-26: 现代C++ HTTP请求库，具有简单但功能强大的接口。模仿Python Requests模块。
* [HTTP Parser](https://github.com/nodejs/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,314 | 🐛 229 | 🌐 C | 📅 2026-08-12: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,038 | 🐛 47 | 🌐 C++ | 📅 2026-08-11: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,817 | 🐛 106 | 🌐 C++ | 📅 2026-08-12: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,369 | 🐛 24 | 🌐 C | 📅 2026-08-13: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [ENet](https://github.com/lsalzman/enet) ⭐ 3,251 | 🐛 98 | 🌐 C | 📅 2026-06-23: 可靠的UDP网络库。
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,157 | 🐛 178 | 🌐 C | 📅 2026-08-11: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,129 | 🐛 51 | 🌐 C++ | 📅 2026-08-13: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-13: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
* [PF\_RING™](https://github.com/ntop/PF_RING) ⭐ 2,961 | 🐛 45 | 🌐 C | 📅 2026-07-23: 高速打包处理框架。
* [wdt](https://github.com/facebook/wdt) ⭐ 2,956 | 🐛 81 | 🌐 C++ | 📅 2026-06-26: 可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据。
* [c-ares](https://github.com/c-ares/c-ares) ⭐ 2,176 | 🐛 60 | 🌐 C | 📅 2026-08-01: 用于异步DNS请求的C库。
* [mTCP](https://github.com/mtcp-stack/mtcp) ⭐ 2,135 | 🐛 97 | 🌐 C | 📅 2024-07-04: 用于多核系统的高度可扩展的用户级TCP堆栈。
* [PicoHTTPParser](https://github.com/h2o/picohttpparser) ⭐ 2,099 | 🐛 22 | 🌐 C | 📅 2026-04-06: 微小、原始、快速的HTTP请求/响应解析器。
* [Onion](https://github.com/davidmoreno/onion) ⭐ 2,088 | 🐛 62 | 🌐 C | 📅 2022-10-17: C语言HTTP服务器库，其设计为轻量级，易使用。
* [Restbed](https://github.com/corvusoft/restbed) ⭐ 2,002 | 🐛 4 | 🌐 C++ | 📅 2026-06-23: C++ 11异步RESTful框架。
* [libquic](https://github.com/devsisters/libquic) ⭐ 1,833 | 🐛 20 | 🌐 C++ | 📅 2022-10-10: 从Chromium的QUIC实现中提取的QUIC协议库。
* [restclient-cpp](https://github.com/mrtazz/restclient-cpp) ⭐ 1,612 | 🐛 35 | 🌐 C++ | 📅 2025-01-03: 用于C++的简单REST客户端。它包装libcurl用于HTTP请求。
* [Dyad.c](https://github.com/rxi/dyad) ⚠️ Archived: C的异步网络。
* [Restinio](https://github.com/Stiffstream/restinio) ⭐ 1,301 | 🐛 42 | 🌐 C++ | 📅 2026-04-02: 只有头文件的C++ 14库，为您提供嵌入式HTTP / Websocket服务器。
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,029 | 🐛 592 | 🌐 C | 📅 2026-08-10: 用于C和C++的Apache Kafka客户端库。
...
* [tlse](https://github.com/eduardsui/tlse) ⭐ 682 | 🐛 31 | 🌐 C | 📅 2026-08-07: 单个C文件的TLS 1.2 / 1.3实现，使用tomcrypt作为加密库。
* [curlcpp](https://github.com/JosephP91/curlcpp) ⭐ 676 | 🐛 11 | 🌐 C++ | 📅 2026-06-28: CURL（libcurl）的面向对象C++封装器。
* [Tufão](https://github.com/vinipsmaker/tufao) ⭐ 594 | 🐛 35 | 🌐 C++ | 📅 2022-02-10: 基于Qt构建的C++异步Web框架。
...
* [libharu](https://github.com/libharu/libharu) ⭐ 1,990 | 🐛 114 | 🌐 C | 📅 2026-03-26: 免费、跨平台、开源的软件库，用于生成PDF。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,671 | 🐛 423 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,981 | 🐛 25 | 🌐 C++ | 📅 2026-08-13: 开源的多物理场仿真引擎。
* [Simbody](https://github.com/simbody/simbody) ⭐ 2,545 | 🐛 161 | 🌐 C++ | 📅 2026-08-12: 高性能C++多体动力学/物理库，模拟关节生物力学和机械系统，像车辆，机器人和人体骨骼。
* [PhysX](https://github.com/NVIDIAGameWorks/PhysX-3.4) ⭐ 2,411 | 🐛 59 | 🌐 C++ | 📅 2022-11-15: Nvidia开发的开源的实时物理引擎中间件SDK，作为Nvidia GameWorks软件套件的一部分。
* [Chipmunk](https://github.com/slembcke/Chipmunk2D) ⭐ 2,402 | 🐛 69 | 🌐 C | 📅 2026-05-05: 快速、轻量级的2D游戏物理库。
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,241 | 🐛 447 | 🌐 C++ | 📅 2026-08-11: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
* [Newton Dynamics](https://github.com/MADEAPPS/newton-dynamics) ⭐ 1,024 | 🐛 0 | 🌐 HTML | 📅 2026-01-17: 用于物理环境实时仿真的集成解决方案。
* [Quantum++](https://github.com/vsoftco/qpp) ⭐ 672 | 🐛 2 | 🌐 C++ | 📅 2026-07-20: 现代的C++ 11量子计算库。
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 6,166 | 🐛 17 | 🌐 C++ | 📅 2026-08-11: 只包含头文件的的C++ 17库，为枚举类型（字符串、迭代）提供静态映射，可与任何枚举类型一起使用，无需任何宏或样板代码。
* [RTTR](https://github.com/rttrorg/rttr) ⭐ 3,481 | 🐛 150 | 🌐 C++ | 📅 2024-04-25: C++11的映射库。
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,351 | 🐛 0 | 🌐 C++ | 📅 2026-08-05: 只包含头文件的的C++ 17库，提供名称宏和函数以获取变量、类型、函数、宏和枚举的简单名称。
...
* [RE2](https://github.com/google/re2) ⭐ 9,781 | 🐛 62 | 🌐 C++ | 📅 2026-01-22: 使用自动机理论、通过有限状态机进行的正则表达式软件库。
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,458 | 🐛 200 | 🌐 C++ | 📅 2026-08-13: Hyperscan是Intel的高性能、多种正则表达式匹配库，提供大量正则表达式（多达数万个）的同时匹配，通常在DPI库堆栈中使用。
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions) ⭐ 3,830 | 🐛 102 | 🌐 C++ | 📅 2026-07-11: 编译时PCRE（几乎）兼容的正则表达式匹配器。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,090 | 🐛 582 | 🌐 C++ | 📅 2026-08-12: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Torch](https://github.com/torch/torch7) ⭐ 9,138 | 🐛 298 | 🌐 C | 📅 2025-03-31: 科学的计算框架，广泛支持将GPU放在首位的机器学习算法。
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,070 | 🐛 116 | 🌐 C++ | 📅 2026-07-01: 快速密集和稀疏多维数组的DBMS。
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,416 | 🐛 325 | 🌐 C++ | 📅 2026-08-13: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 17,991 | 🐛 714 | 🌐 C++ | 📅 2026-08-12: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,824 | 🐛 1,499 | 🌐 Cython | 📅 2026-08-12: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
* [ChakraCore](https://github.com/Microsoft/ChakraCore) ⭐ 9,257 | 🐛 613 | 🌐 JavaScript | 📅 2026-02-19: Microsoft的JavaScript引擎，可以嵌入到nodejs中。
* [Duktape](https://github.com/svaarala/duktape) ⭐ 6,209 | 🐛 474 | 🌐 JavaScript | 📅 2024-03-22: 具有紧凑脚本的嵌入式Javascript引擎。
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,123 | 🐛 308 | 🌐 C++ | 📅 2025-03-07: 具有高级功能和一流性能的C++ <-> Lua API封装器。
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,704 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,347 | 🐛 193 | 🌐 C | 📅 2026-08-09: 可移植的外部功能接口库。
* [CppSharp](https://github.com/mono/CppSharp) ⭐ 3,400 | 🐛 346 | 🌐 C# | 📅 2026-05-18: 用于将C / C++ API融合到高级语言中的工具和库。
* [ChaiScript](https://github.com/ChaiScript/ChaiScript/) ⭐ 3,122 | 🐛 73 | 🌐 C++ | 📅 2026-05-02: 用于C++的易于使用的嵌入式脚本语言。
...
* [LuaBridge](https://github.com/vinniefalco/LuaBridge) ⭐ 1,777 | 🐛 48 | 🌐 C | 📅 2025-10-13: 轻量级、无依赖的库，用于将Lua绑定到C++。
* [V7](https://github.com/cesanta/v7) ⭐ 1,453 | 🐛 51 | 🌐 C | 📅 2020-11-30: 嵌入式的JavaScript 引擎。
* [PHP-CPP](https://github.com/CopernicaMarketingSoftware/PHP-CPP) ⭐ 1,451 | 🐛 119 | 🌐 C++ | 📅 2026-07-06: 使用C++构建PHP扩展的库。
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,330 | 🐛 263 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,520 | 🐛 78 | 🌐 C | 📅 2026-07-24: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,701 | 🐛 343 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,486 | 🐛 43 | 🌐 Java | 📅 2026-07-27: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,340 | 🐛 104 | 📅 2026-06-09: C/C++的高效二进制序列化库，例如 JSON。
* [protobuf-c](https://github.com/protobuf-c/protobuf-c) ⭐ 2,984 | 🐛 48 | 🌐 C++ | 📅 2025-04-07: C语言的协议缓冲实现。
* [Bond](https://github.com/Microsoft/bond) ⚠️ Archived: 用于处理模式化数据的开源、跨平台框架。
* [mrpt-serialization](https://github.com/mrpt/mrpt/) ⭐ 2,154 | 🐛 29 | 🌐 C++ | 📅 2026-08-11: 已版本控制的二进制或文本格式的序列化。
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,133 | 🐛 303 | 🌐 C++ | 📅 2026-08-10: 开源H.364 编解码器。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 21,990 | 🐛 1,537 | 🌐 C | 📅 2026-08-13: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,186 | 🐛 420 | 🌐 C++ | 📅 2026-08-11: 基于C++ 14/17的高性能HTTP应用程序框架。
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,644 | 🐛 333 | 🌐 C++ | 📅 2025-11-12: 轻量、零依赖的框架，可创建高性能的Web服务。
* [C++ REST SDK](https://github.com/Microsoft/cpprestsdk) ⚠️ Archived: 使用现代异步C++ API设计、以本机代码进行基于云的客户端-服务器通信的Microsoft项目。
* [Crow](https://github.com/ipkn/crow) ⭐ 7,625 | 🐛 212 | 🌐 C++ | 📅 2024-06-06: 一个C++微型web框架（灵感来自于Python Flask）。
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,036 | 🐛 49 | 🌐 C | 📅 2026-08-08: 实验性、可扩展的高性能HTTP服务器。
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,433 | 🐛 234 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
* [facil.io](https://github.com/boazsegev/facil.io) ⭐ 2,396 | 🐛 36 | 🌐 C | 📅 2026-04-14: 事件型、高性能的C Web框架，支持HTTP、WebSocket、SSE等。
* [TreeFrog Framework](https://github.com/treefrogframework/treefrog-framework) ⭐ 1,378 | 🐛 5 | 🌐 C++ | 📅 2026-08-09: 基于C++和Qt的高速、全栈的Web应用程序框架，支持HTTP和WebSocket协议（带有O / R映射）。
* [Cutelyst](https://github.com/cutelyst/cutelyst) ⭐ 975 | 🐛 16 | 🌐 C++ | 📅 2026-08-12: 在Qt上构建的C++ Web框架，使用Catalyst（Perl）框架的简单方法。
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,784 | 🐛 122 | 🌐 C++ | 📅 2026-05-24: 简单快速的C++CML解析器，可以很容易集成到其它项目中。
* [Mini-XML](https://github.com/michaelrsweet/mxml) ⭐ 518 | 🐛 3 | 🌐 C | 📅 2026-03-21: 用ANSI C编写的小型XML解析库。
* [Boost.PropertyTree](http://www.boost.org/doc/libs/1_55_0/doc/html/property_tree.html): 属性树解析器/生成器，可用于解析XML / JSON / INI / Info文件。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,395 | 🐛 418 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,068 | 🐛 0 | 🌐 Java | 📅 2026-07-28: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,737 | 🐛 11 | 🌐 C++ | 📅 2026-08-13: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,737 | 🐛 11 | 🌐 C++ | 📅 2026-08-13: C++的小型，安全和快速格式化库。
* [HTTP Parser](https://github.com/joyent/http-parser) ⚠️ Archived: C的http请求/响应解析器。
* [SDS](https://github.com/antirez/sds) ⭐ 5,532 | 🐛 107 | 🌐 C | 📅 2025-04-18: C的简单动态字符串库。
* [Klib](https://github.com/attractivechaos/klib) ⭐ 4,714 | 🐛 94 | 🌐 C | 📅 2025-12-22: 通用算法和数据结构的小型、轻量级实现。
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,429 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: C++语言编写的跨平台，串口库。
* [Serial Communication Library](https://github.com/wjwwood/serial) ⭐ 2,429 | 🐛 101 | 🌐 C++ | 📅 2024-08-21: 跨平台，用C++编写的串行端口库。
* [PEGTL](https://github.com/taocpp/PEGTL) ⭐ 2,148 | 🐛 8 | 🌐 C++ | 📅 2026-08-12: 解析表达语法模板库。
...
* [icecream-cpp](https://github.com/renatoGarcia/icecream-cpp) ⭐ 748 | 🐛 1 | 🌐 C++ | 📅 2026-04-22: 用于调试目的的小型打印库。
...
* [rtags](https://github.com/Andersbakken/rtags) ⭐ 1,844 | 🐛 176 | 🌐 C++ | 📅 2026-08-11: C/C++的客户端服务器索引，用于 跟基于clang的emacs的集成。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,355 | 🐛 1,168 | 🌐 CMake | 📅 2026-08-13: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,435 | 🐛 0 | 🌐 Rust | 📅 2026-08-13: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,673 | 🐛 298 | 🌐 OCaml | 📅 2026-08-12: 用于Java、C和Objective-C的静态分析器。
* [IKOS](https://github.com/NASA-SW-VnV/ikos) ⭐ 3,160 | 🐛 50 | 🌐 C++ | 📅 2026-05-31: 基于抽象解释理论的C / C++静态分析器。
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,842 | 🐛 83 | 🌐 Python | 📅 2026-08-12: 遵循Google C++样式指南的C++样式检查器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,065 | 🐛 385 | 🌐 C++ | 📅 2026-08-09: 代码美化器。
