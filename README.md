...
[awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,878 | 🐛 311 | 📅 2026-08-22 就是 `fffaraz` 发起维护的 C++ 资源列表，内容包括: 标准库、Web应用框架、人工智能、数据库、图片处理、机器学习、日志、代码分析等。
...
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,093 | 🐛 233 | 🌐 C++ | 📅 2026-08-22: Abseil C++ 通用库。

- [Folly](https://github.com/facebook/folly) ⭐ 30,506 | 🐛 462 | 🌐 C++ | 📅 2026-08-22: 由Facebook开发和使用的开源C++库。
- [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,804 | 🐛 472 | 🌐 C++ | 📅 2026-08-21: 包罗万象的C++类库，用于开发跨平台软件。
...
- [ETL](https://github.com/ETLCPP/etl) ⭐ 3,104 | 🐛 63 | 🌐 C++ | 📅 2026-08-22: 嵌入式模板库。
...
- [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,330 | 🐛 2,932 | 🌐 C++ | 📅 2026-08-22: 使用数据流图进行数值计算的开源软件库。
- [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,548 | 🐛 17,272 | 🌐 Python | 📅 2026-08-23: 具有强大CPU加速功能，包含张量和动态神经网络的Python库。
...
- [Recast/Detour](https://github.com/recastnavigation/recastnavigation) ⭐ 7,868 | 🐛 133 | 🌐 C++ | 📅 2026-02-27: （3D）导航网格生成器和路径查找，主要用于游戏。
...
- [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,432 | 🐛 58 | 🌐 C++ | 📅 2026-08-22: C++中Actor Model的开源实现。
...
- [miniaudio](https://github.com/dr-soft/miniaudio) ⭐ 7,167 | 🐛 5 | 🌐 C | 📅 2026-08-19: 单文件音频回放和录制的库。
...
- [SoLoud](https://github.com/jarikomppa/soloud) ⭐ 2,154 | 🐛 122 | 🌐 C | 📅 2024-08-13: 简单便携的游戏音频引擎。
...
- [libsndfile](https://github.com/erikd/libsndfile/) ⭐ 1,710 | 🐛 220 | 🌐 C | 📅 2026-08-01: C++封装的C库，用于通过标准库接口读写包含采样声音的文件。
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 6,032 | 🐛 250 | 🌐 C++ | 📅 2026-08-22(a.k.a. libtorrent-rasterbar): 高效的、功能完整的C++比特流实现。
...
* [LAMMPS](https://github.com/lammps/lammps) ⭐ 3,025 | 🐛 96 | 🌐 C++ | 📅 2026-08-21: 经典的用于材料建模的分子动力学代码，它是大范围原子/分子巨量平行模拟器的首字母缩写。
...
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,416 | 🐛 73 | 🌐 C++ | 📅 2026-08-21: 单文件或多文件的C++11库，用于简单和高级的CLI解析，只有头文件。
* [linenoise](https://github.com/antirez/linenoise) ⭐ 4,341 | 🐛 155 | 🌐 C | 📅 2026-05-02: readline和libedit的独立小选择。
...
* [Taywee / args](https://github.com/taywee/args) ⭐ 1,632 | 🐛 15 | 🌐 C++ | 📅 2026-08-03: 简单的只有头文件的C++参数解析库。
...
* [Brotli](https://github.com/google/brotli) ⭐ 14,847 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-18: Brotli压缩格式，由Google开发。
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 851 | 🐛 42 | 🌐 C++ | 📅 2026-08-20: C++静态库，提供与7-zip DLLs的简洁接口。

- [zstd](https://github.com/facebook/zstd) ⭐ 27,599 | 🐛 344 | 🌐 C | 📅 2026-08-01: Zstandard-快速实时压缩算法。由Facebook开发。
- [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,598 | 🐛 603 | 🌐 C | 📅 2026-08-22: 多格式的存档和压缩库。
- [LZFSE](https://github.com/lzfse/lzfse) ⭐ 1,822 | 🐛 29 | 🌐 C | 📅 2022-09-05: LZFSE压缩库和命令行工具。
- [FiniteStateEntropy](https://github.com/Cyan4973/FiniteStateEntropy) ⭐ 1,494 | 🐛 22 | 🌐 C | 📅 2024-03-21: 新一代熵编解码器: 有限状态熵和Huff()。
- [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,483 | 🐛 17 | 🌐 C | 📅 2026-08-07: Zlib最新bug修复，支持PKWARE磁盘跨越，AES加密和IO缓冲。
...
- [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,458 | 🐛 76 | 🌐 C++ | 📅 2026-07-11: C++11的快速多生产者、多消费者的无锁并发队列。
- [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow) ⭐ 12,122 | 🐛 33 | 🌐 C++ | 📅 2026-08-06: 具有任务依赖性的快速C++并行编程。
- [NCCL](https://github.com/NVIDIA/nccl) ⭐ 5,022 | 🐛 411 | 🌐 C++ | 📅 2026-08-21: 用于集体多GPU通信的优化基元。
- [readerwriterqueue](https://github.com/cameron314/readerwriterqueue) ⭐ 4,613 | 🐛 24 | 🌐 C++ | 📅 2026-03-28: C++的快速单生产者、单消费者的无锁队列。
...
- [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,885 | 🐛 142 | 🌐 C++ | 📅 2026-08-22: 适用于任何规模的并行分布式应用的通用C++运行时系统。
...
- [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,648 | 🐛 546 | 🌐 C++ | 📅 2026-08-21: 用于并行运行和内存抽象的便携式编程模型。
...
* [robin-map](https://github.com/Tessil/robin-map) ⭐ 1,502 | 🐛 18 | 🌐 C++ | 📅 2026-06-13: 使用robin hood哈希算法的哈希映射和哈希集。
...
* [BeeCrypt](https://github.com/fffaraz/awesome-cpp/blob/master) ⭐ 72,878 | 🐛 311 | 📅 2026-08-22: 可移植和快速的加密库。
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,910 | 🐛 1 | 🌐 C | 📅 2026-08-13: 基于NaCI的加密库，固执己见，容易使用。
* [Tink](https://github.com/google/tink) ⚠️ Archived: 多语言、跨平台的库，提供安全、易于正确使用且难以滥用的加密API。
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,897 | 🐛 1,724 | 🌐 C | 📅 2026-08-20: 开源的、可移植的、易于使用的、可读的、灵活的SSL库，以前被称为PolarSSL。
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,999 | 🐛 33 | 🌐 C | 📅 2024-10-04: C中小型可移植的AES128/192/256。
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,753 | 🐛 321 | 🌐 C | 📅 2026-08-21: TLS/SSL协议的实现。
...
* [libhydrogen](https://github.com/jedisct1/libhydrogen) ⭐ 778 | 🐛 0 | 🌐 C | 📅 2026-08-14: 轻量级、安全、易于使用的加密库，适用于受限的环境。
...
* [Vince's CSV Parser](https://github.com/vincentlaucsb/csv-parser) ⭐ 1,120 | 🐛 4 | 🌐 C++ | 📅 2026-08-22: 快速、独立、流式的C++17 CSV解析器，具有可选的类型转换和统计信息。
...
* [LevelDB](https://github.com/google/leveldb) ⭐ 39,349 | 🐛 403 | 🌐 C++ | 📅 2026-03-11: 由Google编写的快速键值存储库，提供了从字符键到字符串值的有序映射。
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 32,000 | 🐛 1,613 | 🌐 C++ | 📅 2026-08-22: 来自Facebook的嵌入键值的快速存储。
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,677 | 🐛 73 | 🌐 C | 📅 2026-08-20: 用于Redis数据库的很简单的C客户端库。
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,775 | 🐛 93 | 🌐 C | 📅 2026-07-24: SQLiteC++ (SQLiteCpp)是聪明且易于使用的C++ SQLite3封装器。
...
* [nanodbc](https://github.com/nanodbc/nanodbc) ⭐ 385 | 🐛 42 | 🌐 C++ | 📅 2026-08-22: 用于本机C ODBC API的小型C++封装器。
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,952 | 🐛 493 | 🌐 C++ | 📅 2026-08-21: 编写和使用C++模拟类的库。
* [Google Test](https://github.com/google/googletest) ⭐ 38,952 | 🐛 493 | 🌐 C++ | 📅 2026-08-21: Google的C++测试框架。
* [Catch](https://github.com/philsquared/Catch) ⭐ 21,435 | 🐛 438 | 🌐 C++ | 📅 2026-08-22: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 21,435 | 🐛 438 | 🌐 C++ | 📅 2026-08-22: 一个很时尚的，C++原生的框架，只包含头文件，用于单元测试，测试驱动开发和行为驱动开发。
* [benchmark](https://github.com/google/benchmark) ⭐ 10,362 | 🐛 176 | 🌐 C++ | 📅 2026-08-18: Google提供的小型微基准支持库。
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,848 | 🐛 140 | 🌐 C++ | 📅 2026-08-18: 功能最轻便的单个C++头文件的测试框架。
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,350 | 🐛 90 | 🌐 C | 📅 2026-07-21: C的简单单元测试。
...
* [utest.h](https://github.com/sheredom/utest.h) ⭐ 990 | 🐛 9 | 🌐 C++ | 📅 2026-08-22: C和C++的单个头文件测试框架。
...
* [Godot](https://github.com/godotengine/godot) ⭐ 115,994 | 🐛 18,746 | 🌐 C++ | 📅 2026-08-21: 功能齐全、开源、有MIT许可的游戏引擎。
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,430 | 🐛 27 | 🌐 C | 📅 2026-08-21: 简单、易于使用的库，用于享受视频游戏编程的乐趣。
* [EnTT](https://github.com/skypjack/entt) ⭐ 13,034 | 🐛 11 | 🌐 C++ | 📅 2026-08-09: 游戏与现代C++的碰撞。
* [Panda3D](https://github.com/panda3d/panda3d) ⭐ 5,210 | 🐛 368 | 🌐 C++ | 📅 2026-07-28: 游戏引擎，用于Python和C++程序的3D渲染和游戏开发的框架。
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,898 | 🐛 9 | 🌐 C++ | 📅 2025-02-25: 用于创建2D/3D移动和桌面游戏的跨平台本机C++游戏框架。
...
* [Spring](https://github.com/spring/spring) ⭐ 3,973 | 🐛 2 | 🌐 C++ | 📅 2024-03-31: 强大、免费、跨平台的RTS游戏引擎。
...
* [nCine](https://github.com/nCine/nCine) ⭐ 1,326 | 🐛 1 | 🌐 C++ | 📅 2026-08-11: 注重性能的跨平台2D游戏引擎，用C++11编写，还可以选择使用Lua编写脚本。
* [Crown](https://github.com/dbartolini/crown) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2026-08-21: Crown是一款通用的数据驱动游戏引擎，使用正统C++从零开始编写，并牢记简约和面向数据的设计理念。
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,817 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-19: 拥有最小依赖关系的即时模式图形用户界面。
* [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,337 | 🐛 316 | 🌐 C | 📅 2026-08-08: 单个头文件的ANSI C gui库。
...
* [RmlUi](https://github.com/mikke89/RmlUi) ⭐ 4,364 | 🐛 56 | 🌐 C++ | 📅 2026-08-22: 进化的HTML/CSS用户界面库，libRocket的分支。
...
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,681 | 🐛 9 | 🌐 C++ | 📅 2026-08-22: GPU加速的C++用户界面，具有所见即所得的开发工具，支持XML，具有内置数据绑定和MVVM功能。
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,427 | 🐛 285 | 🌐 C++ | 📅 2026-08-22: 跨平台的渲染库。
* [GLFW](https://github.com/glfw/glfw) ⭐ 15,271 | 🐛 760 | 🌐 C | 📅 2026-08-04: 简单、跨平台的OpenGL处理库。
* [assimp](https://github.com/assimp/assimp) ⭐ 13,152 | 🐛 540 | 🌐 C++ | 📅 2026-08-22: 开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API。
* [Skia](https://github.com/google/skia) ⭐ 10,895 | 🐛 50 | 🌐 C++ | 📅 2026-08-22 用于绘制文字，图形和图像的完整的2D图形库。
* [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,696 | 🐛 321 | 🌐 C | 📅 2026-02-19: OpenGL之上的抗锯齿2D矢量图形库，用于UI和可视化。
* [magnum](https://github.com/mosra/magnum) ⭐ 5,194 | 🐛 76 | 🌐 C++ | 📅 2026-08-22: 用于游戏和数据可视化的轻量级和模块化的 C++ 11 /C++ 14图形中间件。
...
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,848 | 🐛 33 | 🌐 C++ | 📅 2026-08-20: 用于在C++中编写DirectX 11.x代码的帮助类的集合。
...
* [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,920 | 🐛 2 | 🌐 C++ | 📅 2026-08-22: 用于实时图形应用开发的现代C++14库。
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 34,470 | 🐛 417 | 🌐 C | 📅 2026-08-02: STB单个头文件的图像加载库。
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,782 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: 用于图像中人脸检测的开源库，其人脸检测的速度能达到1500FPS。
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,398 | 🐛 16 | 🌐 C | 📅 2026-08-19: 使用SIMD指令来加速基线JPEG编码和解码的JPEG图像编解码器。
* [OpenImageIO](https://github.com/OpenImageIO/oiio) ⭐ 2,348 | 🐛 188 | 🌐 C++ | 📅 2026-08-22: 强大的图像和纹理处理库，支持多种常见的有损和RAW格式。
...
* [GD](https://github.com/libgd/libgd) ⭐ 980 | 🐛 106 | 🌐 C | 📅 2026-08-20: GD图形库，有名的用于PHP中图形加载/操作和缩略图生成。
...
* [TinyEXIF](https://github.com/cdcseacave/TinyEXIF) ⭐ 147 | 🐛 4 | 🌐 C++ | 📅 2026-08-22: 用于JPEG的微型ISO兼容的C++ EXIF和XMP解析库。
...
* [utf8.h](https://github.com/sheredom/utf8.h) ⭐ 1,976 | 🐛 10 | 🌐 C++ | 📅 2026-08-22: C和C++的单个头文件的utf8字符串函数。
* [utf8proc](https://github.com/JuliaStrings/utf8proc) ⭐ 1,291 | 🐛 31 | 🌐 C | 📅 2026-07-22: 干净的C库，用于处理UTF-8 Unicode数据。
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 45,243 | 🐛 1,383 | 🌐 C++ | 📅 2026-08-22: 高性能、开源、通用的RPC框架。
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 13,164 | 🐛 324 | 🌐 C++ | 📅 2026-08-21: 快速的数据交换格式和基于功能的RPC系统。
...
* [json](https://github.com/nlohmann/json) ⭐ 50,438 | 🐛 101 | 🌐 C++ | 📅 2026-08-21: 用于现代C++的JSON。
* [simdjson](https://github.com/lemire/simdjson) ⭐ 24,173 | 🐛 137 | 🌐 C++ | 📅 2026-08-20: 极快的JSON库，可以千兆字节每秒的速度解析JSON。
* [RapidJSON](https://github.com/miloyip/rapidjson) ⭐ 15,116 | 🐛 791 | 🌐 C++ | 📅 2025-02-05: 用于C++的快速JSON 解析生成器，包含SAX和DOM两种风格的API。
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,937 | 🐛 355 | 🌐 C | 📅 2026-04-09: ANSI C的超轻量级JSON解析器。
...
* [json-c](https://github.com/json-c/json-c) ⭐ 3,286 | 🐛 21 | 🌐 C | 📅 2026-08-21: C中的JSON实现。
...
* [json.h](https://github.com/sheredom/json.h) ⭐ 839 | 🐛 4 | 🌐 C | 📅 2026-07-20: 在C和C++中解析JSON的简单的单头文件/单源文件的解决方案。
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,515 | 🐛 49 | 🌐 C++ | 📅 2026-08-08: 超级快的C++日志库，只包含头文件。
...
* [Quill](https://github.com/odygrd/quill) ⭐ 3,004 | 🐛 7 | 🌐 C++ | 📅 2026-08-22: 异步、跨平台、低时延的日志库。
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 90,553 | 🐛 2,752 | 🌐 C++ | 📅 2026-08-22: 开源计算机视觉库。
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,560 | 🐛 1,545 | 🌐 C++ | 📅 2024-07-31: 快速的神经网络框架。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,689 | 🐛 424 | 🌐 C++ | 📅 2026-08-21: 用于Python、R、Java、Scala、C++等的可扩展、便携式和分布式梯度增强（GBDT，GBRT或GBM）的库。在单机、Hadoop、Spark、Flink和DataFlow上运行。
...
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,242 | 🐛 80 | 🌐 C++ | 📅 2026-08-22: 基于C /缓存/核心的计算机视觉库，现代计算机视觉库。
...
* [SHOGUN](https://github.com/shogun-toolbox/shogun) ⭐ 3,079 | 🐛 426 | 🌐 C++ | 📅 2023-12-19: Shogun 机器学习工具。
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,433 | 🐛 38 | 🌐 C++ | 📅 2026-08-11: 现代C++11的机器学习、计算机视觉、数值优化和深度学习工具包。
* [GLM](https://github.com/g-truc/glm) ⭐ 11,173 | 🐛 124 | 🌐 C++ | 📅 2026-04-07: 只包含头文件的C++数学库，可与OpenGL的GLSL数学匹配并互操作。
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,558 | 🐛 114 | 🌐 C | 📅 2026-08-22: 基于GotoBLAS2 1.13 BSD版本的优化BLAS库。
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 7,535 | 🐛 48 | 🌐 C++ | 📅 2026-08-20v: 用于计量金融的免费/开源库。
* [CGAL](https://github.com/CGAL/cgal) ⭐ 6,017 | 🐛 678 | 🌐 C++ | 📅 2026-08-22: 高效，可靠的几何算法集合。
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 499 | 🐛 16 | 🌐 C++ | 📅 2026-08-23: 只包含头文件的C++ 14库，实现任意假定算数。假定数值系统是一个锥形浮点，比IEEE浮点更有效。假定数使可复现的计算科学成为可能。
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,323 | 🐛 312 | 🌐 C | 📅 2026-08-22: 具有出色性能的紧凑型通用分配器。
* [jemalloc](https://github.com/jemalloc/jemalloc) ⭐ 11,054 | 🐛 365 | 🌐 C | 📅 2026-08-10: 通用的malloc（3）实现，强调避免存储碎片和可扩展的并发支持。
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,527 | 🐛 190 | 🌐 C | 📅 2026-07-23: C和C++的保守的垃圾回收器。
...
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,877 | 🐛 195 | 🌐 C | 📅 2026-06-23: 快速、可靠的ARQ协议，可帮助应用程序减少网络延迟。
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,762 | 🐛 3 | 🌐 C++ | 📅 2026-08-20: 单文件的C++ 11 HTTP / HTTPS服务器库，只包含头文件。
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 16,228 | 🐛 86 | 🌐 C++ | 📅 2025-12-23: 用于Linux多线程服务器的C++非阻塞网络库。
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 13,007 | 🐛 5 | 🌐 C | 📅 2026-08-20<span style="text-decoration: underline;">: </span>非常轻量级的网络服务器。
* [H2O](https://github.com/h2o/h2o) ⭐ 11,537 | 🐛 731 | 🌐 C | 📅 2026-08-04: 优化的HTTP服务器，支持HTTP / 1.x和HTTP / 2。它也可以用作库。
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,374 | 🐛 39 | 🌐 C++ | 📅 2026-08-22: Facebook的C++ HTTP库集合，包括易于使用的HTTP服务器。
* [C++ REST SDK](https://github.com/Microsoft/cpprestsdk) ⚠️ Archived: C++ REST SDK（以前称为Casablanca）。
* [WebSocket++](https://github.com/zaphoyd/websocketpp) ⭐ 7,713 | 🐛 483 | 🌐 C++ | 📅 2026-05-04: 基于C++/Boost Aiso的websocket 客户端/服务器库。
...
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,317 | 🐛 232 | 🌐 C | 📅 2026-08-22: 提供客户端和服务器库的轻量级纯C WebSocket实现。
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 5,044 | 🐛 46 | 🌐 C++ | 📅 2026-08-18: HTTP / 2 C库。
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,819 | 🐛 106 | 🌐 C++ | 📅 2026-08-12: 在C++ 11中基于Boost.Asio构建的HTTP和WebSocket。
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,389 | 🐛 24 | 🌐 C | 📅 2026-08-21: 用于快速打包处理的数据平面开发工具、库和驱动程序。
...
* [ENet](https://github.com/lsalzman/enet) ⭐ 3,258 | 🐛 98 | 🌐 C | 📅 2026-06-23: 可靠的UDP网络库。
* [libpcap](https://github.com/the-tcpdump-group/libpcap) ⭐ 3,160 | 🐛 178 | 🌐 C | 📅 2026-08-21: 用于网络流量捕获的可移植C / C++库。
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) ⭐ 3,131 | 🐛 58 | 🌐 C++ | 📅 2026-08-22: 跨平台的C++网络嗅探以及数据包解析和构建的框架。
* [Wangle](https://github.com/facebook/wangle) ⭐ 3,095 | 🐛 48 | 🌐 C++ | 📅 2026-08-22: 客户端/服务器应用程序框架，用于构建异步的、事件驱动的现代C++服务。
...
* [Bullet](https://github.com/bulletphysics/bullet3) ⭐ 14,686 | 🐛 423 | 🌐 C++ | 📅 2025-10-22: 3D的游戏物理引擎。
* [LiquidFun](https://github.com/google/liquidfun) ⚠️ Archived: 2D的游戏物理引擎。
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,987 | 🐛 19 | 🌐 C++ | 📅 2026-08-18: 开源的多物理场仿真引擎。
* [Simbody](https://github.com/simbody/simbody) ⭐ 2,545 | 🐛 160 | 🌐 C++ | 📅 2026-08-21: 高性能C++多体动力学/物理库，模拟关节生物力学和机械系统，像车辆，机器人和人体骨骼。
...
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,248 | 🐛 449 | 🌐 C++ | 📅 2026-08-18: SOFA是一个针对实时仿真的开源框架，其着重于医学仿真。
...
* [Nameof](https://github.com/Neargye/nameof) ⭐ 2,356 | 🐛 0 | 🌐 C++ | 📅 2026-08-05: 只包含头文件的的C++ 17库，提供名称宏和函数以获取变量、类型、函数、宏和枚举的简单名称。
...
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,473 | 🐛 200 | 🌐 C++ | 📅 2026-08-17: Hyperscan是Intel的高性能、多种正则表达式匹配库，提供大量正则表达式（多达数万个）的同时匹配，通常在DPI库堆栈中使用。
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 11,094 | 🐛 583 | 🌐 C++ | 📅 2026-08-18: 点云库是一个独立的，大规模的开放项目，用于2D/3D图像和点云处理。
...
* [Trilinos](https://github.com/trilinos/Trilinos) ⭐ 1,418 | 🐛 328 | 🌐 C++ | 📅 2026-08-22: 高性能的PDE解算器。
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,001 | 🐛 713 | 🌐 C++ | 📅 2026-08-19: C++ 11和Python之间的无缝可操作性。
* [Cython](https://github.com/cython/cython) ⭐ 10,830 | 🐛 1,499 | 🌐 Cython | 📅 2026-08-22: Cython是用于Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器。它使得为Python编写C扩展就像Python本身一样容易。
...
* [sol2](https://github.com/ThePhD/sol2) ⭐ 5,127 | 🐛 308 | 🌐 C++ | 📅 2025-03-07: 具有高级功能和一流性能的C++ <-> Lua API封装器。
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,705 | 🐛 113 | 🌐 Java | 📅 2026-08-10: Java和本机C++之间缺少的桥梁。
* [libffi](https://github.com/libffi/libffi) ⭐ 4,358 | 🐛 194 | 🌐 C | 📅 2026-08-19: 可移植的外部功能接口库。
...
* [ctypes.sh](https://github.com/taviso/ctypes.sh) ⭐ 2,176 | 🐛 20 | 🌐 C | 📅 2026-07-21: bash的外部函数接口。
...
* [cppimport](https://github.com/tbenthompson/cppimport) ⭐ 1,227 | 🐛 11 | 🌐 Python | 📅 2026-04-17: 直接从Python导入C++文件！
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 26,396 | 🐛 266 | 🌐 C++ | 📅 2026-08-11: 内存高效的序列化库。
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,533 | 🐛 79 | 🌐 C | 📅 2026-07-24: ANSI C中的小型代码大小的协议缓冲区实现。
* [cereal](https://github.com/USCiLab/cereal) ⭐ 4,701 | 🐛 343 | 🌐 C++ | 📅 2026-03-11: C++11 序列化库。
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,491 | 🐛 39 | 🌐 Java | 📅 2026-08-22: 用于低延迟应用程序的对二进制格式的应用程序信息的编码和解码。
* [MessagePack](https://github.com/msgpack/msgpack-c) ⭐ 3,341 | 🐛 104 | 📅 2026-06-09: C/C++的高效二进制序列化库，例如 JSON。
...
* [libde265](https://github.com/strukturag/libde265) ⭐ 1,907 | 🐛 34 | 🌐 C++ | 📅 2026-07-24: 开放的h.265视频编解码器的实现。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,007 | 🐛 1,538 | 🌐 C | 📅 2026-08-18: 旨在实现单片机上Python3.x的实现。
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 14,201 | 🐛 427 | 🌐 C++ | 📅 2026-08-20: 基于C++ 14/17的高性能HTTP应用程序框架。
...
* [lwan](https://github.com/lpereira/lwan) ⭐ 6,034 | 🐛 49 | 🌐 C | 📅 2026-08-22: 实验性、可扩展的高性能HTTP服务器。
* [Civetweb](https://github.com/bel2125/civetweb) ⭐ 3,439 | 🐛 237 | 🌐 C | 📅 2026-08-01: 提供易于使用，强大的，C/C++嵌入式Web服务器，带有可选的CGI，SSL和Lua支持。
...
* [stb](https://github.com/nothings/stb) ⭐ 34,470 | 🐛 417 | 🌐 C | 📅 2026-08-02: 一系列用于C / C++的单文件库。
* [ZXing](https://github.com/zxing/zxing/) ⭐ 34,074 | 🐛 2 | 🌐 Java | 📅 2026-08-21: 用Java实现的开源、多格式1D / 2D条码图像处理库，带有其他语言的端口。
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,754 | 🐛 11 | 🌐 C++ | 📅 2026-08-16: 小型、安全、快速的C++格式化库。
* [C++ Format](https://github.com/cppformat/cppformat) ⭐ 23,754 | 🐛 11 | 🌐 C++ | 📅 2026-08-16: C++的小型，安全和快速格式化库。
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,385 | 🐛 1,166 | 🌐 CMake | 📅 2026-08-22: Windows，Linux和MacOS的C++库管理器。
* [Buck](https://github.com/facebook/buck) ⚠️ Archived: 用Java编写的快速构建系统，可鼓励在多种平台和语言（包括在Facebook开发和使用的C++）上创建小型、可重用模块。
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,444 | 🐛 0 | 🌐 Rust | 📅 2026-08-20: 用于为clang工具生成编译数据库的工具。
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,685 | 🐛 297 | 🌐 OCaml | 📅 2026-08-21: 用于Java、C和Objective-C的静态分析器。
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,064 | 🐛 392 | 🌐 C++ | 📅 2026-08-09: 代码美化器。
